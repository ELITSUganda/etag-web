...
Route::group([
    ...
    $router->resource('events-sanitary', EventController::class);
    $router->resource('events-abortion', EventController::class);
    ...
    $router->resource('events-test-result', EventController::class);
    ...
    $router->resource('packaging-records', PackagingRecordController::class);
