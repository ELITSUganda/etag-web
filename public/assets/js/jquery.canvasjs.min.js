/* 
 CanvasJS Chart - v3.12.0 Beta 1 - https://canvasjs.com/ 
...
(function () {
  ...
  function Za(f, x, l) {
    "millisecond" === l
      ? f.setMilliseconds(f.getMilliseconds() + 1 * x)
      : "second" === l
      ? f.setSeconds(f.getSeconds() + 1 * x)
      : "minute" === l
      ? f.setMinutes(f.getMinutes() + 1 * x)
      : "hour" === l
      ? f.setHours(f.getHours() + 1 * x)
      : "day" === l
      ? f.setDate(f.getDate() + 1 * x)
      : "week" === l
      ? f.setDate(f.getDate() + 7 * x)
      : "month" === l
      ? f.setMonth(f.getMonth() + 1 * x)
      : "year" === l && f.setFullYear(f.getFullYear() + 1 * x);
    return f;
  }
  function aa(f, x) {
    var l = !1;
  ...
  function Ia(f) {
    if (!f) return f;
    f = f.replace(/^\s\s*/, "");
    for (var x = /\s/, l = f.length; x.test(f.charAt(--l)); );
    return f.slice(0, l + 1);
  }
  function Aa(f) {
    f.roundRect = function (f, l, r, U, pa, B, t, A) {
      t && (this.fillStyle = t);
      A && (this.strokeStyle = A);
      "undefined" === typeof pa && (pa = 5);
      pa = Math.min(pa, Math.min(r, U) / 2);
      this.lineWidth = B;
      this.beginPath();
      this.moveTo(f + pa, l);
      this.lineTo(f + r - pa, l);
      this.quadraticCurveTo(f + r, l, f + r, l + pa);
      this.lineTo(f + r, l + U - pa);
      this.quadraticCurveTo(f + r, l + U, f + r - pa, l + U);
      this.lineTo(f + pa, l + U);
      this.quadraticCurveTo(f, l + U, f, l + U - pa);
      this.lineTo(f, l + pa);
      this.quadraticCurveTo(f, l, f + pa, l);
      this.closePath();
      t && this.fill();
      A && 0 < B && this.stroke();
    };
  ...
  function V(f) {
    var x = ((f & 16711680) >> 16).toString(16),
  ...
  function gb(f, x) {
    ...
    for (0 > r && (r += l); r < l; r++)
      if (r in this && this[r] === f) return r;
    return -1;
  }
  function l(f) {
  ...
  function hb(f) {
    if (va.fSDec)
      f[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
        va._fTWm && va._fTWm(f);
      });
  }
  function $a(f, x, l) {
  ...
  function I(f, x) {
    ...
    if (
      ...
      for (var r = 0; r < l.length; r++) l[r] *= x;
    else l = [];
    return l;
  }
  function F(f, x, ya, r, U) {
    r = r || [];
    U = l(U) ? (ib ? { passive: !1, capture: !1 } : !1) : U;
    r.push([f, x, ya, U]);
    return f.addEventListener
      ? (f.addEventListener(x, ya, U), ya)
      : f.attachEvent
      ? ((r = function (x) {
          x = x || window.event;
          x.preventDefault =
  ...
  function jb(f) {
      ...
      f.exportEnabled
        ? (K(f._menuButton, {
          ...
          0 >= navigator.userAgent.search("MSIE") &&
            f._menuButton.childNodes[0] &&
            K(f._menuButton.childNodes[0], {
      ...
      F(
        ...
        function () {
          "none" !== f._dropdownMenu.style.display ||
            (f._dropDownCloseTime &&
              500 >= new Date().getTime() - f._dropDownCloseTime.getTime()) ||
            ((f._dropdownMenu.style.display = "block"),
            f._menuButton.blur(),
            f._dropdownMenu.focus());
        },
        f.allDOMEventHandlers,
        !0
      );
    ...
    if (f.exportEnabled && f._dropdownMenu) {
      ...
      for (
        var l = f._dropdownMenu.childNodes,
          N = [
            f._cultureInfo.printText,
            f._cultureInfo.saveJPGText,
            f._cultureInfo.savePNGText,
          ],
          U = 0;
        U < N.length;
        U++
      ...
      !f._dropdownMenu &&
          ...
          function () {
            x ||
              ((this.style.backgroundColor =
                f.toolbar.itemBackgroundColorOnHover),
        ...
        F(
          ...
          function () {
            x ||
              ((this.style.backgroundColor = f.toolbar.itemBackgroundColor),
  ...
  function ka(f, x, l) {
    return f in x ? x[f] : l[f];
  }
  function Oa(f, x, ya, N) {
    r && cb
      ? ((N =
          !l(N) && N
            ? f.getContext("2d", { willReadFrequently: !0 })
            : f.getContext("2d")),
        (Pa =
        ...
        Ua !== Pa &&
          ((f.style.width = x + "px"),
          (f.style.height = ya + "px"),
          N.scale(na, na)))
      : ((f.width = x), (f.height = ya));
  }
  function kb(f) {
    if (!lb) {
      var x = !1,
      ...
      "undefined" === typeof ra.Chart.creditHref
        ? ((f.creditHref = ja("iuuqr;..b`ow`rkr/bnl.")),
          (f.creditText = ja("B`ow`rKR/bnl")))
        : ((x = f.updateOption("creditText")),
          (l = f.updateOption("creditHref")));
      if (f.creditHref && f.creditText) {
        ...
        if (0 === f.renderCount || x || l)
          f._creditLink.setAttribute("href", f.creditHref),
            (f._creditLink.innerHTML = f.creditText);
        f._creditLink && f.creditHref && f.creditText
          ? (f._creditLink.parentElement ||
              f._canvasJSContainer.appendChild(f._creditLink),
            (f._creditLink.style.top = f.height - 14 + "px"))
          : f._creditLink.parentElement &&
            f._canvasJSContainer.removeChild(f._creditLink);
      }
    }
  }
  function ua(f, x, l) {
  ...
  function K(f, x) {
    for (var l in x) f.style[l] = x[l];
  }
  function db(f) {
    return f.currentStyle
      ? f.currentStyle
      : window && window.getComputedStyle
      ? window.getComputedStyle(f, null)
      : f.style;
  }
  function ta(f, x, l) {
    x.getAttribute("state") ||
      ((x.style.backgroundColor = f.toolbar.itemBackgroundColor),
      (x.style.color = f.toolbar.fontColor),
      (x.style.border = "none"),
      K(x, {
        WebkitUserSelect: "none",
        MozUserSelect: "none",
    ...
    x.getAttribute("state") !== l &&
      (x.setAttribute("state", l),
      ...
      (x.innerHTML =
        ...
        mb[l].image +
        "' alt='" +
        f._cultureInfo[l + "Text"] +
        "' />"),
      K(x.childNodes[0], { height: "95%", pointerEvents: "none" }));
    x.setAttribute("title", f._cultureInfo[l + "Text"]);
  }
  function Na() {
    for (var f = null, x = 0; x < arguments.length; x++)
      (f = arguments[x]), f.style && (f.style.display = "inline");
  }
  function wa() {
    for (var f = null, x = 0; x < arguments.length; x++)
      (f = arguments[x]) && f.style && (f.style.display = "none");
  }
  function Va(f, x, l, r, U) {
    if (null === f || "undefined" === typeof f)
      return "undefined" === typeof l ? x : l;
    f =
      parseFloat(f.toString()) * (0 <= f.toString().indexOf("%") ? x / 100 : 1);
    "undefined" !== typeof r &&
      ((f = Math.min(r, f)), "undefined" !== typeof U && (f = Math.max(U, f)));
    return !isNaN(f) && f <= x && 0 <= f ? f : "undefined" === typeof l ? x : l;
  }
  function Y(f, x, r, N, U) {
    this._defaultsKey = f;
    ...
    f = {};
    this.theme && l(this.parent) && l(x) && l(N)
      ? (f = l(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        this.parent.themeOptions[x] &&
        (null === N
          ? (f = this.parent.themeOptions[x])
          : 0 < this.parent.themeOptions[x].length &&
            ((N = Math.min(this.parent.themeOptions[x].length - 1, N)),
            (f = this.parent.themeOptions[x][N])));
    this.themeOptions = f;
    this.options = r ? r : { _isPlaceholder: !0 };
    this.setOptions(this.options, f);
  }
  function Ga(f, x, l, r, U) {
  ...
  function Ba(f, x) {
    ...
    if (l(this.options.margin) && f.options.subtitles)
      for (var r = f.options.subtitles, N = 0; N < r.length; N++)
        if (
          ((l(r[N].horizontalAlign) && "center" === this.horizontalAlign) ||
            r[N].horizontalAlign === this.horizontalAlign) &&
          ((l(r[N].verticalAlign) && "top" === this.verticalAlign) ||
            r[N].verticalAlign === this.verticalAlign) &&
          !r[N].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  function Ka(f, x, l) {
    Ka.base.constructor.call(this, "Subtitle", "subtitles", x, l, f);
    this.chart = f;
    this.canvas = f.canvas;
    this.ctx = this.chart.ctx;
  ...
  var Ja = !1,
    ...
    Ma = { en: {} },
    t = r ? "Trebuchet MS, Helvetica, sans-serif" : "Arial",
    ...
    va.fSDec = function (f) {
      for (var x = "", l = 0; l < f.length; l++)
        x += String.fromCharCode(
          Math.ceil(f.length / 57 / 5) ^ f.charCodeAt(l)
        );
      return x;
    };
    delete ra[va.fSDec("Bi`su")][va.fSDec("bsdehuIsdg")];
    va.pro = { sCH: ra[va.fSDec("Bi`su")][va.fSDec("bsdehuIsdg")] };
  })();
  var ib = (function () {
      var f = !1;
      try {
        ...
        window.addEventListener &&
          ...
          window.removeEventListener("test", null, x));
      } catch (l) {
        f = !1;
      }
      return f;
    ...
    ob = function (f, x, l) {
      ...
      return Math.max(
        "theme4" === this.theme ? 0 : 300 <= x ? 12 : 11,
        Math.round(x * (f / 400))
      );
    },
    Da = (function () {
      ...
      return function (A, I, O) {
        ...
        "UTC:" === I.slice(0, 4) && ((I = I.slice(4)), (K = !0));
        O = K ? "getUTC" : "get";
        var Y = A[O + "Date"](),
          R = A[O + "Day"](),
          ba = A[O + "Month"](),
          ...
          b = A[O + "Seconds"](),
          d = A[O + "Milliseconds"](),
          h = K ? 0 : A.getTimezoneOffset();
        return (O = I.replace(f, function (q) {
          switch (q) {
            case "D":
              return Y;
            case "DD":
            ...
            case "K":
              return K
                ? "UTC"
                : (String(A).match(t) || [""]).pop().replace(B, "");
            case "z":
    ...
    pb = function (f) {
      ...
      if (1 > Math.abs(f)) {
        ...
        l &&
          ((f = (x ? -1 * f : f) * Math.pow(10, l - 1)),
          (f = "0." + Array(l).join("0") + f.toString().substring(2)),
          (f = x ? "-" + f : f));
      } else
        (l = parseInt(f.toString().split("+")[1])),
          20 < l &&
            ((l -= 20),
            (f /= Math.pow(10, l)),
            (f = f.toString() + Array(l + 1).join("0")));
      return String(f);
    },
    ia = function (f, l, r) {
      if (null === f) return "";
        ...
        if (((l = A[R]), "." === l && 0 > I)) I = R;
          ...
          if ("%" === l) B *= 100;
            ...
            ("E" !== l[0] && "e" !== l[0]) ||
              ...
              (S = !0);
          0 > I
            ? (O.push(l), "#" === l || "0" === l ? V++ : "," === l && F++)
            : (Q.push(l), ("#" !== l && "0" !== l) || K++);
        }
      S &&
        ((l = Math.floor(f)),
        (A = -Math.floor(Math.log(f) / Math.LN10 + 1)),
        (Y = 0 === f ? 0 : 0 === l ? -(V + A) : pb(l).length - V),
        (B /= Math.pow(10, Y)));
      0 > I && (I = R);
      B = (f * B).toFixed(K);
      l = B.split(".");
        ...
        if (((l = O.pop()), "#" === l || "0" === l))
          if ((I++, I === V)) {
            var ba = B,
              B = [];
            if ("0" === l)
              for (l = V - K - (ba ? ba.length : 0); 0 < l; )
                ba.unshift("0"), l--;
            for (; 0 < ba.length; )
              (r = ba.pop() + r),
                S++,
                0 === S % A && R === F && 0 < ba.length && (r = t + r);
          } else
            0 < B.length
              ? ((r = B.pop() + r), K++, S++)
              : "0" === l && ((r = "0" + r), K++, S++),
              0 === S % A && R === F && 0 < B.length && (r = t + r);
        else
          ("E" !== l[0] && "e" !== l[0]) ||
          "0" !== l[l.length - 1] ||
          !/[eE][+-]*[0]+/.test(l)
            ? "," === l
              ? (R++, (A = S), (S = 0), 0 < B.length && (r = t + r))
              : (r =
                  1 < l.length &&
                  (('"' === l[0] && '"' === l[l.length - 1]) ||
                    ("'" === l[0] && "'" === l[l.length - 1]))
                    ? l.slice(1, l.length - 1) + r
                    : l + r)
            : ((l =
                0 > Y
                  ? l.replace("+", "").replace("-", "")
    ...
    Ra = function (f) {
      var l = 0,
        r = 0;
      f = f || window.event;
      f.offsetX || 0 === f.offsetX
        ? ((l = f.offsetX), (r = f.offsetY))
        : f.layerX || 0 == f.layerX
        ? ((l = f.layerX), (r = f.layerY))
        : ((l = f.pageX - f.target.offsetLeft),
          (r = f.pageY - f.target.offsetTop));
      return { x: l, y: r };
    },
    cb = !0,
    ...
    Pa = 1,
    na = cb ? Ua / Pa : 1,
    ea = function (f, l, r, N, t, A, B, I, S, O, V, Q, K) {
      "undefined" === typeof K && (K = 1);
      B = B || 0;
      I = I || "black";
      var F = 15 < N - l && 15 < t - r ? 8 : 0.35 * Math.min(N - l, t - r);
      f.beginPath();
      f.moveTo(l, r);
      f.save();
      f.fillStyle = A;
      f.globalAlpha = K;
      f.fillRect(l, r, N - l, t - r);
      f.globalAlpha = 1;
      0 < B &&
        ((K = 0 === B % 2 ? 0 : 0.5),
        f.beginPath(),
        ...
        (f.strokeStyle = I),
        f.moveTo(l, r),
        f.rect(l - K, r - K, N - l + 2 * K, t - r + 2 * K),
        f.stroke());
      f.restore();
      !0 === S &&
        (f.save(),
        ...
        f.lineTo(N, r),
        f.closePath(),
        (B = f.createLinearGradient((N + l) / 2, r + F, (N + l) / 2, r)),
        B.addColorStop(0, A),
      ...
      !0 === O &&
        ...
        f.lineTo(N, t),
        f.closePath(),
        (B = f.createLinearGradient((N + l) / 2, t - F, (N + l) / 2, t)),
        B.addColorStop(0, A),
        B.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (f.fillStyle = B),
        f.fill(),
      ...
      !0 === V &&
        ...
        f.lineTo(l, t),
        f.closePath(),
        (B = f.createLinearGradient(l + F, (t + r) / 2, l, (t + r) / 2)),
        B.addColorStop(0, A),
      ...
      !0 === Q &&
        ...
        f.lineTo(N - F, t - F),
        f.lineTo(N, t),
        (B = f.createLinearGradient(N - F, (t + r) / 2, N, (t + r) / 2)),
        B.addColorStop(0, A),
        B.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (f.fillStyle = B),
        B.addColorStop(0, A),
    ...
    ja = function (f) {
      for (var l = "", r = 0; r < f.length; r++)
        l += String.fromCharCode(
          Math.ceil(f.length / 57 / 5) ^ f.charCodeAt(r)
        );
      return l;
    },
    lb =
  ...
  Y.prototype.setOptions = function (f, l) {
    if (ra[this._defaultsKey]) {
      ...
      for (t in r)
        "publicProperties" !== t &&
          r.hasOwnProperty(t) &&
          (this[t] = f && t in f ? f[t] : l && t in l ? l[t] : r[t]);
  ...
  Y.prototype.get = function (f) {
    ...
    if (
      l.hasOwnProperty(f) ||
      (l.publicProperties && l.publicProperties.hasOwnProperty(f))
    )
      return this[f];
    window.console &&
      window.console.log(
        'Property "' + f + "\" doesn't exist. Please check for typo."
      );
  };
  Y.prototype.set = function (f, l, r) {
    ...
    if ("options" === f) this.createUserOptions(l);
      ...
      t.hasOwnProperty(f) ||
      (t.publicProperties &&
        t.publicProperties.hasOwnProperty(f) &&
        "readWrite" === t.publicProperties[f])
    )
  ...
  Y.prototype.addTo = function (f, l, r, t) {
    t = "undefined" === typeof t ? !0 : t;
    var A = ra[this._defaultsKey];
    A.hasOwnProperty(f) ||
    (A.publicProperties &&
      A.publicProperties.hasOwnProperty(f) &&
      "readWrite" === A.publicProperties[f])
      ? (this.options._isPlaceholder && this.createUserOptions(),
          ...
          this.parent &&
            ...
            this.optionsName
              ...
              ? ((r = l.charAt(0).toLowerCase()),
                1 < l.length && (r = r.concat(l.slice(1))),
                (l = r))
              : (l = void 0),
            (f[l] = this.options));
  };
  ...
  Y.prototype.updateOption = function (f) {
    ...
    var r = ra[this._defaultsKey],
      ...
      I = this._index;
    this.theme && l(this.parent) && l(U) && l(I)
      ? (t = l(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        (this.options.theme
          ? "Chart" === this._defaultsKey && Qa[this.options.theme]
            ? (t = Qa[this.options.theme])
            : stockThemes[this.options.theme] &&
              (t = stockThemes[this.options.theme][U])
          : this.parent.themeOptions[U] &&
            (null === I
              ? (t = this.parent.themeOptions[U])
              : 0 < this.parent.themeOptions[U].length &&
                ((t = Math.min(this.parent.themeOptions[U].length - 1, I)),
                (t = this.parent.themeOptions[U][t]))));
    this.themeOptions = t;
    f in r &&
      (A = f in this.options ? this.options[f] : t && f in t ? t[f] : r[f]);
  ...
  Y.prototype.addEventListener = function (f, l, r) {
    f &&
      ...
      this._eventListeners[f].push({ context: r || this, eventHandler: l }));
  };
  Y.prototype.removeEventListener = function (f, l) {
    if (f && l && this._eventListeners[f])
      for (var r = this._eventListeners[f], t = 0; t < r.length; t++)
        if (r[t].eventHandler === l) {
          r[t].splice(t, 1);
          break;
        }
  };
  ...
  Y.prototype.dispatchEvent = function (f, l, r) {
    if (f && this._eventListeners[f]) {
      l = l || {};
      for (var t = this._eventListeners[f], A = 0; A < t.length; A++)
        t[A].eventHandler.call(t[A].context, l);
    }
    "function" === typeof this[f] && this[f].call(r || this.chart, l);
  };
  Ga.prototype.registerSpace = function (l, r) {
    "top" === l
      ? (this._topOccupied += r.height)
      : "bottom" === l
      ? (this._bottomOccupied += r.height)
      : "left" === l
      ? (this._leftOccupied += r.width)
      : "right" === l && (this._rightOccupied += r.width);
  };
  Ga.prototype.unRegisterSpace = function (l, r) {
    "top" === l
      ? (this._topOccupied -= r.height)
      : "bottom" === l
      ? (this._bottomOccupied -= r.height)
  ...
  la.prototype._initialize = function () {
    l(this.padding) || "object" !== typeof this.padding
      ...
      : ((this.topPadding = l(this.padding.top)
          ? 0
          : Number(this.padding.top) | 0),
        (this.rightPadding = l(this.padding.right)
          ? 0
          : Number(this.padding.right) | 0),
        (this.bottomPadding = l(this.padding.bottom)
          ? 0
          : Number(this.padding.bottom) | 0),
        (this.leftPadding = l(this.padding.left)
          ? 0
          : Number(this.padding.left) | 0));
  };
  la.prototype.render = function (l) {
    if (0 !== this.fontSize) {
      l && this.ctx.save();
      var r = this.ctx.font;
      ...
      for (t = 0; t < this._wrappedText.lines.length; t++)
        (I = this._wrappedText.lines[t]),
          "right" === this.textAlign
            ? (A = this.width - I.width - this.rightPadding)
            : "left" === this.textAlign
            ? (A = this.leftPadding)
            : "center" === this.textAlign &&
              (A =
                ...
                I.width / 2 +
                this.leftPadding),
          this.ctx.fillText(I.text, A, U),
          (U += I.height);
      this.ctx.font = r;
      l && this.ctx.restore();
    }
  };
  la.prototype.setText = function (l) {
    this.text = l;
    this._isDirty = !0;
    this._wrappedText = null;
  };
  ...
  la.prototype._getLineWithWidth = function (l, r, t) {
    l = String(l);
    if (!l) return { text: "", width: 0 };
    var A = (t = 0),
      I = l.length - 1,
      F = Infinity;
    for (this.ctx.font = this._getFontString(); A <= I; ) {
    ...
    r = !0;
    if (B.length === l.length || " " === l[B.length]) r = !1;
    r &&
      ((l = B.split(" ")),
      1 < l.length && l.pop(),
      (B = l.join(" ")),
  ...
  la.prototype._wrapText = function () {
    var l = new String(Ia(String(this.text))),
      r = [],
      t = this.ctx.font,
      A = 0,
      I = 0;
    this.ctx.font = this._getFontString();
    if (0 === this.frontSize) I = A = 0;
    else
      for (; 0 < l.length; ) {
        ...
        r.push(B);
        var K = I,
          I = Math.max(I, B.width),
          A = A + B.height,
          l = Ia(l.slice(B.text.length, l.length));
        F && A > F && ((B = r.pop()), (A -= B.height), (I = K));
      }
    this._wrappedText = { lines: r, width: I, height: A };
  ...
  Ba.prototype.setLayout = function () {
    if (this.text) {
      var f = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        K,
        S;
      this.textAlign = l(this.options.textAlign)
        ? this.horizontalAlign
        : this.textAlign;
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              r.width - 4 - B * ("center" === this.horizontalAlign ? 2 : 1)),
          (F = 0.5 * r.height - this.margin - 2),
          (I = 0))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign || "right" === this.horizontalAlign
            ? (null === this.maxWidth && (this.maxWidth = r.height - 4),
              (F = 0.5 * r.width - this.margin - 2))
            : "center" === this.horizontalAlign &&
              (null === this.maxWidth && (this.maxWidth = r.width - 4),
              (F = 0.5 * r.height - 4)));
      var O;
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ? ((A = r.y1 + 2 + this.fontSize / 2 + 4), (S = "top"))
            : "bottom" === this.verticalAlign &&
              ((A = r.y2 - 2 - O.height + this.fontSize / 2 + 4),
              (S = "bottom")),
          "left" === this.horizontalAlign
            ? (t = r.x1 + 2)
            : "center" === this.horizontalAlign
            ? (t = r.x1 + r.width / 2 - O.width / 2)
            : "right" === this.horizontalAlign && (t = r.x2 - 2 - O.width - B),
          (K = this.horizontalAlign),
          (this.width = O.width),
          (this.height = O.height))
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((t = r.x1 + 2 + (this.fontSize / 2 + 4)),
              (A = r.y2 - 2 - (this.maxWidth / 2 - O.width / 2)),
              (I = -90),
              (S = "left"),
              (this.width = O.height),
              (this.height = O.width))
            : "right" === this.horizontalAlign
            ? ((t = r.x2 - 2 - (this.fontSize / 2 + 4)),
              (A = r.y1 + 2 + (this.maxWidth / 2 - O.width / 2)),
              (I = 90),
              (S = "right"),
              (this.width = O.height),
              (this.height = O.width))
            : "center" === this.horizontalAlign &&
              ((A =
                f.y1 + (f.height / 2 - O.height / 2) + this.fontSize / 2 + 4),
              (t = f.x1 + (f.width / 2 - O.width / 2)),
              (S = "center"),
              (this.width = O.width),
              (this.height = O.height)),
          (K = "center"));
      ...
      F.horizontalAlign = K;
      this._textBlock = F;
      f.layoutManager.registerSpace(S, {
        width:
          this.width + ("left" === S || "right" === S ? this.margin + 2 : 0),
        height:
          this.height + ("top" === S || "bottom" === S ? this.margin + 2 : 0),
      });
      this.bounds = { x1: t, y1: A, x2: t + this.width, y2: A + this.height };
  ...
  Xa.prototype.get = function (l, r) {
    var t = null;
    0 < this.pool.length
      ? ((t = this.pool.pop()), Oa(t, l, r))
      : (t = ua(l, r));
    return t;
  };
  Xa.prototype.release = function (l) {
    this.pool.push(l);
  };
  qa(La, Y);
  var Sa = {
    ...
    formatNumber: function (l, r, t) {
      t = t || "en";
      if (Ma[t]) return ia(l, r || "#,##0.##", new La(t));
      throw "Unknown Culture Name";
    },
    formatDate: function (l, r, t) {
      t = t || "en";
      if (Ma[t]) return Da(l, r || "DD MMM YYYY", new La(t));
      throw "Unknown Culture Name";
    },
  };
  "undefined" !== typeof module && "undefined" !== typeof module.exports
    ...
    : (window.CanvasJS &&
      ...
      (window.CanvasJS = window.CanvasJS ? window.CanvasJS : Sa));
  t = Sa.Chart = (function () {
    function f(a, e) {
      return a.x - e.x;
    }
    function x(a, e, c) {
      ...
      this.theme =
        l(e.theme) || l(this.predefinedThemes[e.theme]) ? "light1" : e.theme;
      x.base.constructor.call(
        this,
        "Chart",
        this.optionsName,
        e,
      ...
      for (var c = [], b, d = 0; d < a.length; d++)
        if (0 == d) c.push(a[0]);
          ...
          b =
            (Math.abs(
              (a[q].x - a[h].x) /
                (0 === a[q].x - a[u].x ? 0.01 : a[q].x - a[u].x)
            ) *
              (e - 1)) /
              2 +
            1;
          ...
          b = (a[q].y - a[h].y) / b;
          c[c.length] =
            (a[u].x > a[h].x && 0 < E) || (a[u].x < a[h].x && 0 > E)
              ? { x: a[u].x + E / 3, y: a[u].y + b / 3 }
              : { x: a[u].x, y: a[u].y + (1 === c.length ? 0 : b / 9) };
          u = d;
          h = 0 === u ? 0 : u - 1;
          q = u === a.length - 1 ? u : u + 1;
          b =
            (Math.abs(
              (a[q].x - a[h].x) /
                (0 === a[u].x - a[h].x ? 0.01 : a[u].x - a[h].x)
            ) *
              (e - 1)) /
              2 +
            1;
    ...
    function A(a, e, c, b, d, h, q, u, E, k) {
      var m = 0;
      k ? ((q.color = h), (u.color = h)) : (k = 1);
      m = E ? Math.abs(d - c) : Math.abs(b - e);
      m =
        0 < q.trimLength
          ? Math.abs((m * q.trimLength) / 100)
          : Math.abs(m - q.length);
      ...
      a.beginPath();
      E && 0 < u.thickness
        ? (a.moveTo(b - q.thickness / 2, Math.round((c + d) / 2) - n),
          a.lineTo(e + q.thickness / 2, Math.round((c + d) / 2) - n))
        : 0 < u.thickness &&
          (a.moveTo(Math.round((e + b) / 2) - n, c + q.thickness / 2),
          a.lineTo(Math.round((e + b) / 2) - n, d - q.thickness / 2));
      a.stroke();
    ...
    function B(a, e, c, b, d, h) {
      ...
      this.options.crosshair &&
        ((this.crosshair = new $(this.chart, this.options.crosshair, this)),
        (this.crosshair._updatedValue = l(this.sessionVariables.crosshairValue)
          ? null
    ...
    function W(a, e, c, b) {
      W.base.constructor.call(this, "ScaleBreaks", "scaleBreaks", e, null, b);
      this.id = c;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = b;
    ...
    function ga(a, e, c, b, d, h) {
      ga.base.constructor.call(this, "Break", e, c, b, h);
      this.id = d;
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.scaleBreaks = h;
      ...
      this.lineThickness = l(c.lineThickness)
        ? h.lineThickness
        : this.lineThickness;
    ...
    function $(a, e, c) {
      $.base.constructor.call(this, "Crosshair", "crosshair", e, null, c);
      this.chart = a;
      this.ctx = this.chart.ctx;
      this.axis = c;
    ...
    x.prototype.destroy = function () {
      ...
      for (var e = 0; e < a.length; e++) {
        ...
        c.removeEventListener
          ? c.removeEventListener(b, d, h)
          : c.detachEvent && c.detachEvent("on" + b, d);
      }
      this.allDOMEventHandlers = [];
      for (
    ...
    x.prototype._updateOptions = function () {
      ...
      l(this.options.theme)
        ? (this.theme = this.stockChart.theme)
        : l(this.stockChart) && l(this.theme) && (this.theme = "light1");
      ...
      if (
        ...
        for (var e in this.stockChart.options.toolbar)
          this.toolbar[e] = this.stockChart.options.toolbar[e];
        ...
        if (this._zoomButton)
          K(this._zoomButton, {
            ...
            0 >= navigator.userAgent.search("MSIE") &&
              ...
              K(this._zoomButton.childNodes[0], {
                WebkitFilter: "invert(0%)",
                filter: "invert(0%)",
              });
        else {
        ...
        this._resetButton
          ? (K(this._resetButton, {
            ...
            0 >= navigator.userAgent.search("MSIE") &&
              ...
              K(this._resetButton.childNodes[0], {
                WebkitFilter: "invert(0%)",
                filter: "invert(0%)",
              }),
              ...
              function () {
                ...
                a.syncCharts &&
                  ...
                  ((a.stockChart.rangeUpdatedBy =
                    ...
                    (l(a.stockChart.navigator.slider.options.minimum) &&
                      l(a.stockChart.navigator.slider.options.maximum))
                      ? !a.stockChart.rangeSelector.enabled ||
                        ...
                        : "inputFields"
                      : "navigator"),
                  l(a.stockChart._selectedRangeButtonIndex) ||
        ...
        this.zoomEnabled ||
          ...
          (this._zoomButton
            ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText
              ...
              Na(a._zoomButton, a._resetButton))
            : ((this.zoomEnabled = !0), (this.panEnabled = !1)));
      ...
      this.options.toolTip &&
        ...
        (this.toolTip.options = this.options.toolTip);
      for (e in this.toolTip.options)
        this.toolTip.options.hasOwnProperty(e) && this.toolTip.updateOption(e);
    };
        ...
        for (var c = 0; c < this.options.data.length; c++)
          if (
            ...
            !this.options.data[c].type ||
              0 <= x._supportedChartTypes.indexOf(this.options.data[c].type))
          ) {
            var b = new Q(
              this,
              this.options.data[c],
            ...
            if (!l(b) && b.dataPoints)
              for (var d = 0; d < b.dataPoints.length; d++)
                if (b.dataPoints[d].x && b.dataPoints[d].x.getTime) {
                  b.xValueType = "dateTime";
                  break;
                }
            "error" === b.type &&
              ((b.linkedDataSeriesIndex = l(
    ...
    x.prototype.setLayout = function () {
        ...
        if (
          ...
          if (!this.data[e].axisYType || "primary" === this.data[e].axisYType)
            if (this.options.axisY && 0 < this.options.axisY.length) {
              ...
              this.data[e].axisY =
                this.axisY[
                  0 <= this.data[e].axisYIndex &&
                  this.data[e].axisYIndex < this.axisY.length
                    ? this.data[e].axisYIndex
                    : 0
                ];
              this.axisY[
                0 <= this.data[e].axisYIndex &&
              ...
              this.axisY.length ||
                ...
                (this.data[e].axisY = this.axisY[0]),
                this.axisY[0].dataSeries.push(this.data[e]);
          if ("secondary" === this.data[e].axisYType)
            if (this.options.axisY2 && 0 < this.options.axisY2.length) {
              ...
              this.data[e].axisY =
                this.axisY2[
                  0 <= this.data[e].axisYIndex &&
                  this.data[e].axisYIndex < this.axisY2.length
                    ? this.data[e].axisYIndex
                    : 0
                ];
              this.axisY2[
              ...
              this.axisY2.length ||
                ...
                (this.data[e].axisY = this.axisY2[0]),
          ...
          if (!this.data[e].axisXType || "primary" === this.data[e].axisXType)
            if (this.options.axisX && 0 < this.options.axisX.length) {
              ...
              this.data[e].axisX =
                this.axisX[
                  0 <= this.data[e].axisXIndex &&
                  this.data[e].axisXIndex < this.axisX.length
                    ? this.data[e].axisXIndex
                    : 0
                ];
              this.axisX[
                0 <= this.data[e].axisXIndex &&
              ...
              this.axisX.length ||
                ...
                (this.data[e].axisX = this.axisX[0]),
                this.axisX[0].dataSeries.push(this.data[e]);
          if ("secondary" === this.data[e].axisXType)
            if (this.options.axisX2 && 0 < this.options.axisX2.length) {
              ...
              this.data[e].axisX =
                this.axisX2[
                  0 <= this.data[e].axisXIndex &&
                  this.data[e].axisXIndex < this.axisX2.length
                    ? this.data[e].axisXIndex
                    : 0
                ];
              this.axisX2[
              ...
              this.axisX2.length ||
                ...
                (this.data[e].axisX = this.axisX2[0]),
                this.axisX2[0].dataSeries.push(this.data[e]);
        }
      if (this.axisY) {
      ...
      if (
        ...
        for (e = 0; e < this._axes.length; e++)
          if (
            !l(this._axes[e].viewportMinimum) ||
            !l(this._axes[e].viewportMaximum)
          ) {
            c = !0;
            break;
          }
      c
        ? (Na(this._zoomButton, this._resetButton),
      ...
      if (this.options.subtitles)
        for (e = 0; e < this.options.subtitles.length; e++)
          (c = new Ka(this, this.options.subtitles[e], e)),
            this.subtitles.push(c),
            c.dockInsidePlotArea ? a.push(c) : c.setLayout();
      this.legend = new U(this, this.options.legend);
      for (e = 0; e < this.data.length; e++)
        (this.data[e].showInLegend ||
          "pie" === this.data[e].type ||
          "doughnut" === this.data[e].type ||
          "funnel" === this.data[e].type ||
          "pyramid" === this.data[e].type) &&
          this.legend.dataSeries.push(this.data[e]);
      this.legend.dockInsidePlotArea
        ? a.push(this.legend)
        : this.legend.setLayout();
      for (e = 0; e < this._axes.length; e++)
        if (
          this._axes[e].scaleBreaks &&
          this._axes[e].scaleBreaks._appliedBreaks.length
        ) {
          r
    ...
    x.prototype.renderElements = function () {
      if (this.height && this.width) {
        ...
        for (e = 0; e < this.plotInfo.plotTypes.length; e++)
          for (
            var h = this.plotInfo.plotTypes[e], q = 0;
            ...
            u.targetCanvas = null;
            this.animatedRender &&
              ((u.targetCanvas = ua(this.width, this.height)),
              (u.targetCanvasCtx = u.targetCanvas.getContext("2d")),
              (d = u.targetCanvasCtx.miterLimit),
            ...
            this.animatedRender &&
              ((u.targetCanvasCtx.miterLimit = d), E && c.push(E));
          }
        ...
        this.animatedRender &&
          ...
          ((d = ua(this.width, this.height).getContext("2d")),
          Aa(d),
          c.push(this.renderIndexLabels(d)));
        var m = this;
        if (0 < c.length)
          (m.disableToolTip = !0),
            m._animator.animate(
              ...
              function (a) {
                ...
                m.ctx.drawImage(
                  ...
                  0,
                  0,
                  Math.floor(m.width * na),
                  Math.floor(m.height * na),
                  0,
                  0,
                  m.width,
                  m.height
                ...
                for (var d = 0; d < c.length; d++)
                  (E = c[d]),
                    1 > a && "undefined" !== typeof E.startTimePercent
                      ? a >= E.startTimePercent &&
                        E.animationCallback(
                          E.easingFunction(
                            a - E.startTimePercent,
                            0,
                            1,
                            1 - E.startTimePercent
                          ),
                          E
                        )
              ...
              function () {
                ...
                for (var a = 0; a < m.plotInfo.plotTypes.length; a++)
                  for (
                    var d = m.plotInfo.plotTypes[a], g = 0;
                    g < d.plotUnits.length;
                    g++
                  ) {
                    var e = d.plotUnits[g];
        ...
        this.zoomEnabled ||
          ...
          wa(this._zoomButton, this._resetButton);
        l(this.toolTip._xValue) ||
          l(this.toolTip._dataSeriesIndex) ||
    ...
    x.prototype.categoriseDataSeries = function () {
      for (var a = "", e = 0; e < this.data.length; e++)
        if (
          ...
          a.dataPoints &&
            ...
            a.visible &&
            0 <= x._supportedChartTypes.indexOf(a.type))
        ) {
          for (
            var c = null, b = !1, d = null, h = !1, q = 0;
      ...
      for (e = 0; e < this.plotInfo.plotTypes.length; e++)
        for (
          c = this.plotInfo.plotTypes[e], q = a = 0;
    ...
    x.prototype._processData = function () {
      ...
      for (var a = 0; a < this.plotInfo.plotTypes.length; a++)
        for (
          var e = this.plotInfo.plotTypes[a], c = 0;
          c < e.plotUnits.length;
          c++
        ) {
          var b = e.plotUnits[c];
          "line" === b.type ||
    ...
    x.prototype._processMultiseriesPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          var e = a.axisY.dataInfo, c = a.axisX.dataInfo, b, d, h = !1, q = 0;
          ...
          if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement)
            var p = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (u.dataPoints[E].x && u.dataPoints[E].x.getTime) ||
            "dateTime" === u.xValueType
          )
            h = !0;
          for (E = 0; E < u.dataPoints.length; E++) {
            "undefined" === typeof u.dataPoints[E].x &&
              (u.dataPoints[E].x = E + (a.axisX.logarithmic ? 1 : 0));
            u.dataPoints[E].x.getTime
              ? ((h = !0), (b = u.dataPoints[E].x.getTime()))
              : (b = u.dataPoints[E].x);
            d = u.dataPoints[E].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < E) {
              if (a.axisX.logarithmic) {
                ...
                (l = b - u.dataPoints[E - 1].x),
                  0 > l && (l *= -1),
                  c.minDiff > l && 0 !== l && (c.minDiff = l);
              null !== d &&
                null !== u.dataPoints[E - 1].y &&
                (a.axisY.logarithmic
                  ? ((l = d / u.dataPoints[E - 1].y),
                    1 > l && (l = 1 / l),
                    e.minDiff > l && 1 !== l && (e.minDiff = l))
                  : ((l = d - u.dataPoints[E - 1].y),
                    0 > l && (l *= -1),
                    e.minDiff > l && 0 !== l && (e.minDiff = l)));
            }
            if (b < p && !k) null !== d && (n = b);
            else {
              if (!k && ((k = !0), 0 < E)) {
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
            var s = a.axisX.sessionVariables.newViewportMinimum
              ...
              r = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (p.dataPoints[g].x && p.dataPoints[g].x.getTime) ||
            "dateTime" === p.xValueType
          )
            h = !0;
          for (g = 0; g < p.dataPoints.length; g++) {
            "undefined" === typeof p.dataPoints[g].x &&
              (p.dataPoints[g].x = g + (a.axisX.logarithmic ? 1 : 0));
            p.dataPoints[g].x.getTime
              ? ((h = !0), (b = p.dataPoints[g].x.getTime()))
              : (b = p.dataPoints[g].x);
            ...
            if (0 < g) {
              ...
              null !== d &&
                ...
                (a.axisY.logarithmic
                  ? 0 < d &&
                    ((v = d / p.dataPoints[g - 1].y),
                    1 > v && (v = 1 / v),
                    e.minDiff > v && 1 !== v && (e.minDiff = v))
                  : ((v = d - p.dataPoints[g - 1].y),
                    0 > v && (v *= -1),
                    e.minDiff > v && 0 !== v && (e.minDiff = v)));
            }
            if (b < s && !f) null !== p.dataPoints[g].y && (y = b);
            else {
              if (!f && ((f = !0), 0 < g)) {
                g -= 2;
                continue;
              ...
              if (b > r && !w) w = !0;
              else if (b > r && w) continue;
              p.dataPoints[g].label &&
                (a.axisX.labels[b] = p.dataPoints[g].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === p.dataPoints[g].y
                ...
                : ((m[b] = (m[b] || 0) + p.dataPoints[g].y),
                  ...
                  (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + d),
                  (a.yAbsTotals[b] =
                    (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(d)),
                  0 <= d
                    ? q[b]
                      ? (q[b] += d)
                      : ((q[b] = d), (E = Math.min(d, E)))
                    : u[b]
                    ? (u[b] += d)
                    : ((u[b] = d), (k = Math.max(d, k))));
            }
          }
          a.axisY.scaleBreaks &&
            ...
            (e.dataPointYPositiveSums
              ? (e.dataPointYPositiveSums.push.apply(
                  e.dataPointYPositiveSums,
                  q
                ),
                e.dataPointYNegativeSums.push.apply(
                  e.dataPointYPositiveSums,
                  u
                ))
              : ((e.dataPointYPositiveSums = q),
                (e.dataPointYNegativeSums = u)));
        ...
        for (g in q)
          q.hasOwnProperty(g) &&
            !isNaN(g) &&
            ((a = q[g]),
            a < e.min && (e.min = Math.min(a, E)),
            a > e.max && (e.max = a),
            g < c.viewPortMin ||
              g > c.viewPortMax ||
              (a < e.viewPortMin && (e.viewPortMin = Math.min(a, E)),
        ...
        for (g in u)
          u.hasOwnProperty(g) &&
            ...
            ((a = u[g]),
            a < e.min && (e.min = a),
            a > e.max && (e.max = Math.max(a, k)),
            g < c.viewPortMin ||
              g > c.viewPortMax ||
              (a < e.viewPortMin && (e.viewPortMin = a),
    ...
    x.prototype._processStacked100PlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          for (p = 0; p < n.dataPoints.length; p++) {
            ...
            if (0 < p) {
              ...
              l(d) ||
                ...
                (a.axisY.logarithmic
                  ? 0 < d &&
                    ((r = d / n.dataPoints[p - 1].y),
                    1 > r && (r = 1 / r),
                    e.minDiff > r && 1 !== r && (e.minDiff = r))
                  : ((r = d - n.dataPoints[p - 1].y),
                    0 > r && (r *= -1),
                    e.minDiff > r && 0 !== r && (e.minDiff = r)));
            }
            if (b < y && !g) null !== d && (w = b);
            else {
              if (!g && ((g = !0), 0 < p)) {
        ...
        a.axisY.logarithmic
          ? ((e.max = l(e.viewPortMax)
              ? 99 * Math.pow(a.axisY.logarithmBase, -0.05)
              : Math.max(
                  e.viewPortMax,
                  99 * Math.pow(a.axisY.logarithmBase, -0.05)
                )),
            (e.min = l(e.viewPortMin) ? 1 : Math.min(e.viewPortMin, 1)))
          : q && !u
          ? ((e.max = l(e.viewPortMax) ? 99 : Math.max(e.viewPortMax, 99)),
            (e.min = l(e.viewPortMin) ? 1 : Math.min(e.viewPortMin, 1)))
          : q && u
          ? ((e.max = l(e.viewPortMax) ? 99 : Math.max(e.viewPortMax, 99)),
          ...
          : !q &&
            u &&
            ((e.max = l(e.viewPortMax) ? -1 : Math.max(e.viewPortMax, -1)),
            (e.min = l(e.viewPortMin) ? -99 : Math.min(e.viewPortMin, -99)));
        e.viewPortMin = e.min;
        e.viewPortMax = e.max;
        a.dataPointYSums = k;
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (
          ...
          for (m = 0; m < k.dataPoints.length; m++) {
            ...
            0 < m &&
              (a.axisX.logarithmic
                ? ((f = b / k.dataPoints[m - 1].x),
                  1 > f && (f = 1 / f),
                  c.minDiff > f && 1 !== f && (c.minDiff = f))
                : ((f = b - k.dataPoints[m - 1].x),
                  0 > f && (f *= -1),
                  c.minDiff > f && 0 !== f && (c.minDiff = f)),
              d &&
                null !== d[0] &&
                k.dataPoints[m - 1].y &&
                null !== k.dataPoints[m - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((f = d[0] / k.dataPoints[m - 1].y[0]),
                    1 > f && (f = 1 / f),
                    e.minDiff > f && 1 !== f && (e.minDiff = f))
                  : ((f = d[0] - k.dataPoints[m - 1].y[0]),
                    0 > f && (f *= -1),
                    e.minDiff > f && 0 !== f && (e.minDiff = f))));
            if (!(b < r) || n) {
              if (!n && ((n = !0), 0 < m)) {
                m -= 2;
                g = w;
              ...
              null === d
                ...
                : (h < e.viewPortMin && (e.viewPortMin = h),
                  q > e.viewPortMax && (e.viewPortMax = q));
            }
          }
          ...
          if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement)
            var p = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (u.dataPoints[l].x && u.dataPoints[l].x.getTime) ||
            "dateTime" === u.xValueType
          )
            h = !0;
          for (l = 0; l < u.dataPoints.length; l++)
            "undefined" !== typeof u.dataPoints[l].isCumulativeSum &&
            !0 === u.dataPoints[l].isCumulativeSum
              ? ((u.dataPointEOs[l].cumulativeSumYStartValue = 0),
                (u.dataPointEOs[l].cumulativeSum =
                  0 === l ? 0 : u.dataPointEOs[l - 1].cumulativeSum),
                (u.dataPoints[l].y =
                  0 === l ? 0 : u.dataPointEOs[l - 1].cumulativeSum))
              : "undefined" !== typeof u.dataPoints[l].isIntermediateSum &&
                !0 === u.dataPoints[l].isIntermediateSum
              ? ((u.dataPointEOs[l].cumulativeSumYStartValue = n),
                ...
                (b = 0))
              : ((d =
                  "number" !== typeof u.dataPoints[l].y
                    ? 0
                    : u.dataPoints[l].y),
                (u.dataPointEOs[l].cumulativeSumYStartValue =
                  0 === l ? 0 : u.dataPointEOs[l - 1].cumulativeSum),
                (u.dataPointEOs[l].cumulativeSum =
                  0 === l ? d : u.dataPointEOs[l - 1].cumulativeSum + d),
                (b += d));
          for (l = 0; l < u.dataPoints.length; l++)
            if (
              ("undefined" === typeof u.dataPoints[l].x &&
                (u.dataPoints[l].x = l + (a.axisX.logarithmic ? 1 : 0)),
              u.dataPoints[l].x.getTime
                ? ((h = !0), (b = u.dataPoints[l].x.getTime()))
                : (b = u.dataPoints[l].x),
              (d = u.dataPoints[l].y),
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              u.dataPointEOs[l].cumulativeSum < e.min &&
                (e.min = u.dataPointEOs[l].cumulativeSum),
              u.dataPointEOs[l].cumulativeSum > e.max &&
                (e.max = u.dataPointEOs[l].cumulativeSum),
              0 < l &&
                (a.axisX.logarithmic
                  ? ((n = b / u.dataPoints[l - 1].x),
                    1 > n && (n = 1 / n),
                ...
                null !== d &&
                  ...
                  (a.axisY.logarithmic
                    ? ((d =
                        u.dataPointEOs[l].cumulativeSum /
                        u.dataPointEOs[l - 1].cumulativeSum),
                      1 > d && (d = 1 / d),
                      e.minDiff > d && 1 !== d && (e.minDiff = d))
                    : ((d =
                        u.dataPointEOs[l].cumulativeSum -
                        u.dataPointEOs[l - 1].cumulativeSum),
                      0 > d && (d *= -1),
                      e.minDiff > d && 0 !== d && (e.minDiff = d)))),
              !(b < p) || k)
            ) {
              if (!k && ((k = !0), 0 < l)) {
                l -= 2;
              ...
              u.dataPoints[l].label &&
                (a.axisX.labels[b] = u.dataPoints[l].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < l &&
                (u.dataPointEOs[l - 1].cumulativeSum < e.viewPortMin &&
                  (e.viewPortMin = u.dataPointEOs[l - 1].cumulativeSum),
                u.dataPointEOs[l - 1].cumulativeSum > e.viewPortMax &&
                  (e.viewPortMax = u.dataPointEOs[l - 1].cumulativeSum));
              u.dataPointEOs[l].cumulativeSum < e.viewPortMin &&
                (e.viewPortMin = u.dataPointEOs[l].cumulativeSum);
              u.dataPointEOs[l].cumulativeSum > e.viewPortMax &&
                (e.viewPortMax = u.dataPointEOs[l].cumulativeSum);
            }
          u.axisX.valueType = u.xValueType = h ? "dateTime" : "number";
        }
    };
    x.prototype.calculateAutoBreaks = function () {
          ...
          if (b || c)
            for (
              var g = a.axisY.dataInfo,
                ...
                u = 0,
                E = 0;
              E < a.dataSeriesIndexes.length;
              E++
            ) {
              var f = d.data[a.dataSeriesIndexes[E]];
                  ...
                  if (
                    (b &&
                      ((p =
                        ...
                        100),
                      (h = f.dataPoints[u].x.getTime
                        ? f.dataPoints[u].x.getTime()
                        : f.dataPoints[u].x),
                      (p = Math.floor((h - q) / p)),
                      h < e[p].min && (e[p].min = h),
                      h > e[p].max && (e[p].max = h)),
                    ...
                    if (
                      (h =
                        "waterfall" === a.type
                          ? f.dataPointEOs[u].cumulativeSum
                          : f.dataPoints[u].y) &&
                      h.length
                    )
                      for (var fa = 0; fa < h.length; fa++)
                        (p = Math.floor((h[fa] - m) / r)),
                          h[fa] < g[p].min && (g[p].min = h[fa]),
                          h[fa] > g[p].max && (g[p].max = h[fa]);
                    else
                      l(h) ||
                        ((p = Math.floor((h - m) / r)),
                        h < g[p].min && (g[p].min = h),
      ...
      function c(a) {
        if (
          ...
          for (
            ...
            var m = d.data[a.dataSeriesIndexes[k]];
            if (!(4 > m.dataPoints.length))
              for (q = 0; q < m.dataPoints.length; q++)
                (h =
                  ...
                  100),
                  (b = m.dataPoints[q].x.getTime
                    ? m.dataPoints[q].x.getTime()
                    : m.dataPoints[q].x),
                  (h = Math.floor((b - c) / h)),
                  b < e[h].min && (e[h].min = b),
                  b > e[h].max && (e[h].max = b);
      ...
      for (var b, d = this, h = !1, q = 0; q < this._axes.length; q++)
        if (
      ...
      if (h) {
        for (q = 0; q < this.plotInfo.plotTypes.length; q++)
          for (
            h = this.plotInfo.plotTypes[q], u = 0;
            u < h.plotUnits.length;
            u++
          )
            (b = h.plotUnits[u]),
              "line" === b.type ||
        ...
        for (q = 0; q < this._axes.length; q++)
          if (this._axes[q].dataInfo._dataRanges) {
            ...
            if (this._axes[q].scaleBreaks.customBreaks)
              for (
                u = 0;
                u < this._axes[q].scaleBreaks.customBreaks.length;
                u++
              )
                for (b = 0; b < h.length; b++)
                  if (
                    (this._axes[q].scaleBreaks.customBreaks[u].startValue <=
                      h[b].start &&
                      h[b].start <=
                        this._axes[q].scaleBreaks.customBreaks[u].endValue) ||
                    (this._axes[q].scaleBreaks.customBreaks[u].startValue <=
                      h[b].start &&
                      h[b].start <=
                        this._axes[q].scaleBreaks.customBreaks[u].endValue) ||
    ...
    x.prototype.getDataPointAtXY = function (a, e, c) {
      ...
      for (var b = [], d = this._dataInRenderedOrder.length - 1; 0 <= d; d--) {
        var h = null;
        (h = this._dataInRenderedOrder[d].getDataPointAtXY(a, e, c)) &&
          b.push(h);
      }
      a = null;
      e = !1;
      for (c = 0; c < b.length; c++)
        if (
          ...
          if (
            ((d = ka("markerSize", b[c].dataPoint, b[c].dataSeries) || 8),
            b[c].distance <= d / 2)
          ) {
            e = !0;
            break;
    ...
    x.prototype.getObjectAtXY = function (a, e, c) {
      var b = null;
      if ((c = this.getDataPointAtXY(a, e, c || !1)))
    ...
    x.prototype._touchEventHandler = function (a) {
      if (a.changedTouches && this.interactivityEnabled) {
        ...
        if (!(c && 1 < c.length)) {
          ...
          d.time = new Date();
          try {
            var q = d.y - this._lastTouchData.y,
              h = d.time - this._lastTouchData.time;
            if (
    ...
    x.prototype._dispatchRangeEvent = function (a, e) {
      ...
      for (var d = 0; d < b.length; d++)
        if ((l(c[b[d]]) && (c[b[d]] = []), "axisY" === b[d]))
          for (var h = 0; h < this.axisY.length; h++)
            c[b[d]].push({
              viewportMinimum:
                this[b[d]][h].sessionVariables.newViewportMinimum,
              viewportMaximum:
    ...
    x.prototype._mouseEventHandler = function (a) {
      function e() {
        x.capturedEventParam &&
          ((d = x.capturedEventParam),
          (q = d.bounds),
          "mouseup" === b &&
            ((x.capturedEventParam = null),
            d.chart.overlaidCanvas.releaseCapture
              ? d.chart.overlaidCanvas.releaseCapture()
          ...
          d.hasOwnProperty(b) &&
            ("mouseup" !== b || d.chart.overlaidCanvas.releaseCapture
              ? (a.target !== d.chart.overlaidCanvas && r) ||
                d[b].call(d.context, c.x, c.y)
              : a.target !== d.chart.overlaidCanvas && (d.chart.isDrag = !1)));
      }
      ...
      if (this._ignoreNextEvent) e(), (this._ignoreNextEvent = !1);
            ...
            for (h = 0; h < this._events.length; h++)
              if (this._events[h].hasOwnProperty(b))
                if (
                  ...
                  d[b].call(d.context, c.x, c.y);
                  "mousedown" === b && !0 === d.capture
                    ? ((x.capturedEventParam = d),
    ...
    x.prototype._plotAreaMouseUp = function (a, e) {
      if (
        ...
        if (this.panEnabled || this.zoomEnabled) {
          if (this.panEnabled)
            for (d = h = 0; d < this._axes.length; d++)
              (c = this._axes[d]),
                c.logarithmic
            ...
            2 < Math.abs(c - d) &&
              2 < Math.abs(b - h) &&
              this._zoomPanToSelectedRegion(c, b, d, h) &&
              (q = !0);
          }
          q &&
    ...
    x.prototype._plotAreaMouseMove = function (a, e) {
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        if (
          ...
          this.panEnabled ||
            this.zoomEnabled ||
            this.toolTip.mouseMoveHandler(a, e);
        if (
          (!d || 2 < Math.abs(c) || !h || 2 < Math.abs(b)) &&
          (this.panEnabled || this.zoomEnabled)
        )
          if (this.panEnabled)
            (d = {
              ...
              (q._panTimerId = setTimeout(
                (function (b, c, d, g) {
                  return function () {
                    q._zoomPanToSelectedRegion(b, c, d, g, !0) &&
            ...
            var b = d ? this.dragStartPoint.x : this.plotArea.x1,
            ...
            this.validateRegion(
              b,
              u,
              d ? a : this.plotArea.x2 - this.plotArea.x1,
              h ? e : this.plotArea.y2 - this.plotArea.y1,
              "xy" !== this.zoomType
            ).isValid &&
              (this.resetOverlayedCanvas(),
        ...
        if (this.axisX && 0 < this.axisX.length)
          for (d = 0; d < this.axisX.length; d++)
            this.axisX[d].crosshair &&
              this.axisX[d].crosshair.enabled &&
              this.axisX[d].crosshair.renderLabel();
        if (this.axisX2 && 0 < this.axisX2.length)
          for (d = 0; d < this.axisX2.length; d++)
            this.axisX2[d].crosshair &&
              this.axisX2[d].crosshair.enabled &&
              this.axisX2[d].crosshair.renderLabel();
        if (this.axisY && 0 < this.axisY.length)
          for (d = 0; d < this.axisY.length; d++)
            this.axisY[d].crosshair &&
              this.axisY[d].crosshair.enabled &&
              this.axisY[d].crosshair.renderLabel();
        if (this.axisY2 && 0 < this.axisY2.length)
          for (d = 0; d < this.axisY2.length; d++)
            this.axisY2[d].crosshair &&
              this.axisY2[d].crosshair.enabled &&
              this.axisY2[d].crosshair.renderLabel();
      }
    };
    x.prototype._zoomPanToSelectedRegion = function (a, e, c, b, d) {
      ...
      if (a.isValid)
        for (b = 0; b < e.length; b++)
          (d = c[b]),
            e[b].setViewPortRange(d.val1, d.val2),
            this.syncCharts &&
              "y" != this.zoomType &&
              this.syncCharts(d.val1, d.val2),
            this.stockChart &&
              (this.stockChart._rangeEventParameter = {
                stockChart: this.stockChart,
                source: "chart",
    ...
    x.prototype.validateRegion = function (a, e, c, b, d) {
      ...
      for (
        ...
        (("axisX" === this._axes[n].type && h) ||
          ("axisY" === this._axes[n].type && q)) &&
          k.push(this._axes[n]);
      for (q = 0; q < k.length; q++) {
        var n = k[q],
          h = !1,
          p = n.convertPixelToValue({ x: a, y: e }),
        ...
        if (p > g)
          var f = g,
            ...
            p = f;
        if (n.scaleBreaks)
          for (f = 0; !h && f < n.scaleBreaks._appliedBreaks.length; f++)
            h =
              n.scaleBreaks._appliedBreaks[f].startValue <= p &&
              n.scaleBreaks._appliedBreaks[f].endValue >= g;
          ...
          if (
            ...
            !(
              ...
              (!(
                ...
                ((n.logarithmic && f < Math.pow(n.dataInfo.minDiff, 3)) ||
                  (!n.logarithmic && f < 3 * Math.abs(n.dataInfo.minDiff)))) ||
              p < n.minimum ||
              g > n.maximum
            ))
          )
    ...
    x.prototype.preparePlotArea = function () {
      ...
      if (
        ...
        this.axisY2 &&
          ...
          (a.y1 = e.y1 < c.lineCoordinates.y1 ? e.y1 : c.lineCoordinates.y1),
          (a.x2 = e.x2 > c.lineCoordinates.x2 ? e.x2 : c.lineCoordinates.x2),
          (a.y2 = e.y2 > c.lineCoordinates.y2 ? e.y2 : c.lineCoordinates.y2),
          (a.width = a.x2 - a.x1),
          (a.height = a.y2 - a.y1));
      } else
    ...
    x.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var m = this._indexLabels[a],
          ...
          p,
          g,
          u = ka("indexLabelFontColor", m.dataPoint, m.dataSeries),
          C = ka("indexLabelFontSize", m.dataPoint, m.dataSeries),
          f = ka("indexLabelFontFamily", m.dataPoint, m.dataSeries),
          k = ka("indexLabelFontStyle", m.dataPoint, m.dataSeries);
        ...
        var h = ka("indexLabelBorderThickness", m.dataPoint, m.dataSeries),
          d = ka("indexLabelMaxWidth", m.dataPoint, m.dataSeries),
          q = ka("indexLabelWrap", m.dataPoint, m.dataSeries),
          y = ka("indexLabelLineDashType", m.dataPoint, m.dataSeries),
          s = ka("indexLabelLineColor", m.dataPoint, m.dataSeries),
          z = l(m.dataPoint.indexLabelLineThickness)
            ? l(m.dataSeries.options.indexLabelLineThickness)
              ? 0
          ...
          b =
            0 < z
              ...
              : 0,
          v = ka("indexLabelPadding", m.dataPoint, m.dataSeries),
          J = { percent: null, total: null },
          G = null;
        if (
          ...
          J = this.getPercentAndTotal(m.dataSeries, m.dataPoint);
        ...
        var Z = m.dataPoint.indexLabelFormatter
          ? m.dataPoint.indexLabelFormatter(G)
          ...
          ? m.dataSeries.indexLabelFormatter(G)
          ...
          : null;
        if (null !== Z && "" !== Z) {
          var J = ka("indexLabelPlacement", m.dataPoint, m.dataSeries),
            G = ka("indexLabelOrientation", m.dataPoint, m.dataSeries),
            x = ka("indexLabelTextAlign", m.dataPoint, m.dataSeries),
            t = m.direction,
            L = m.dataSeries.axisX,
            M = m.dataSeries.axisY,
            ca = !1,
            w = new la(e, {
              x: 0,
              y: 0,
          ...
          if ("stackedarea100" === n) {
            ...
            if (
              m.dataPoint.x < L.viewportMinimum ||
              m.dataPoint.x > L.viewportMaximum ||
              Math.max.apply(null, m.dataPoint.y) < M.viewportMinimum ||
            ...
            if (
              m.dataPoint.x < L.viewportMinimum ||
              m.dataPoint.x > L.viewportMaximum ||
              m.dataPoint.y < M.viewportMinimum ||
              m.dataPoint.y > M.viewportMaximum
            )
              continue;
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            p =
              m.point.x - f / 2 + ("horizontal" === G ? 0 : w._lineHeight / 2);
            if ("inside" !== J)
              (d = c.y1),
                (h = c.y2),
                0 < t
                  ? ((g = m.point.y + w._lineHeight / 2 - k - u - b),
                    g < d &&
                      ((g =
                        "auto" === J
                          ? Math.max(m.point.y, d) + w._lineHeight / 2 + u + b
                          : d + w._lineHeight / 2 + u + b),
                      (ca =
                        g + ("horizontal" === G ? k - w._lineHeight / 2 : 0) >
                        m.point.y),
                      !ca ||
                        0 <= n.indexOf("line") ||
                        0 <= n.indexOf("area") ||
                        (g -= b)))
                  : ((g = m.point.y + w._lineHeight / 2 + u + b),
                    g > h - k + w._lineHeight / 2 - u &&
                      ((g =
                        "auto" === J
                          ? Math.min(m.point.y, h) +
                            ...
                            u -
                            b
                          : h + w._lineHeight / 2 - k - u - b),
                      (ca =
                        g - ("horizontal" === G ? w._lineHeight / 2 : k) <
                        m.point.y),
                      !ca ||
                        0 <= n.indexOf("line") ||
                        0 <= n.indexOf("area") ||
              ...
              b =
                0 <= n.indexOf("range") || "error" === n
                  ? 0 < t
                    ? Math.max(m.bounds.y1, c.y1) + w._lineHeight / 2 + u
                    : Math.min(m.bounds.y2, c.y2) + w._lineHeight / 2 - k - u
                  : (Math.max(m.bounds.y1, c.y1) +
              ...
              if (0 < t) {
                if (((g = b), "bubble" === n || "scatter" === n))
                  (g = m.point.y - k / 2 + w._lineHeight / 2),
                    k > m.bounds.y2 - m.bounds.y1 && (g -= k / 2 + u),
                    0 > g - w._lineHeight / 2 &&
                      (g +=
                        Math.abs(g - w._lineHeight / 2) <=
                        (m.bounds.y2 - m.bounds.y1) / 2 + u
                          ? Math.abs(g - w._lineHeight / 2)
                          : (m.bounds.y2 - m.bounds.y1) / 2 + u);
              } else
                (g = Math.min(m.point.y, b)),
                  g > h - k - u &&
                    ("bubble" === n || "scatter" === n) &&
                    (g = Math.min(m.point.y + u, c.y2 - k - u));
              g = Math.min(g, h);
            }
          } else
            0 <= n.indexOf("line") ||
            ...
            0 <= n.indexOf("scatter")
              ...
              ? "auto" === J && (J = "inside")
              : "bubble" === n && (J = "inside"),
              (g = m.point.y + w._lineHeight / 2 - k / 2),
              "inside" !== J
                ? ((h = c.x1),
                  (d = c.x2),
                  0 > t
                    ? ((p =
                        m.point.x -
                        f +
                        ("horizontal" === G ? 0 : w._lineHeight / 2) -
                        q -
                        b),
                      ("horizontal" === G ? p : p - w._lineHeight / 2) < h &&
                        ((p =
                          "auto" === J
                            ...
                            : h +
                              ...
                              q),
                        (ca =
                          p + f - ("horizontal" === G ? 0 : w._lineHeight / 2) >
                          m.point.x) && (p -= b)))
                    : ((p =
                        m.point.x +
                        ("horizontal" === G ? 0 : w._lineHeight / 2) +
                        q +
                        b),
                      ("horizontal" === G ? p : p - w._lineHeight / 2) >
                        d - f - q - b &&
                        ((p =
                          "auto" === J
                            ? Math.min(m.point.x, d) -
                              ("horizontal" === G ? f : f - w._lineHeight / 2) -
                              q -
                              b
                            : d -
                              f -
                              ...
                              ("horizontal" === G ? 0 : w._lineHeight / 2)),
                        (ca =
                          p - ("horizontal" === G ? 0 : w._lineHeight / 2) <
                          m.point.x) && (p += b))))
                  ...
                  (b =
                    0 <= n.indexOf("range") || "error" === n
                      ...
                      : (Math.max(m.bounds.x1, c.x1) +
                        ...
                        f / 2 +
                        ("horizontal" === G ? 0 : w._lineHeight / 2)),
                  (p = 0 > t ? b : Math.min(m.point.x, b)),
                  (p = Math.max(
                    p,
                    h + ("horizontal" === G ? 0 : w._lineHeight / 2 + u)
                  )));
          "vertical" === G &&
            ((g += k - w._lineHeight / 2),
            0 <=
          ...
          z &&
            ...
            ((-1 ===
              ...
              !ca) &&
            ((e.lineWidth = z),
            (e.strokeStyle = s ? s : "gray"),
            e.setLineDash && e.setLineDash(I(y, z)),
            e.beginPath(),
            e.moveTo(m.point.x, m.point.y),
            0 <= n.indexOf("bar") || ("error" === n && m.axisSwapped)
              ? e.lineTo(
                  p +
                    (0 < m.direction ? 0 : f) +
                    ("vertical" === G ? -w._lineHeight / 2 : 0),
                  g + ("vertical" === G ? -k / 2 : k / 2 - w._lineHeight / 2)
                )
              : 0 <= n.indexOf("column") || ("error" === n && !m.axisSwapped)
              ? e.lineTo(
                  p + f / 2 - ("horizontal" === G ? 0 : w._lineHeight / 2),
                  g +
                    ("vertical" === G
                      ? g - k < m.point.y
                        ? 0
                        : -k
                      : (g - w._lineHeight / 2 < m.point.y ? k : 0) -
                        w._lineHeight / 2)
                )
              ...
              ? e.lineTo(
                  ...
                  "vertical" === G
                    ? 0 < t && g < m.point.y
                      ...
                      ? g - k
                      : m.point.y
                    : 0 < t && g + k - w._lineHeight / 2 < m.point.y
                    ? g + k - w._lineHeight / 2
                    : 0 > t && g - w._lineHeight / 2 > m.point.y
                    ? g - w._lineHeight / 2
                    : m.point.y
                )
              : e.lineTo(
                  ...
                  g +
                    ("vertical" === G
                      ? g - k < m.point.y
                        ? 0
                        : -k
                      : (g + k - w._lineHeight / 2 < m.point.y ? k : 0) -
                        w._lineHeight / 2)
                ),
            e.stroke());
        }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (m = this._indexLabels[a]),
          (w = ka("indexLabelBackgroundColor", m.dataPoint, m.dataSeries)),
          (m.dataSeries.indexLabelBackgroundColor = l(w)
            ? r
              ? "transparent"
              : null
            : w);
        ...
        for (var h = [], q, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          var f = k._colorSet,
            w =
              (f =
              k.lineColor =
                k.options.lineColor ? k.options.lineColor : f[0]);
          c.strokeStyle = f;
          var y = !0,
            s = 0,
            z,
                  ...
                  y || J
                    ...
                    : (c.lineTo(z, v),
                      ...
                      0 == s % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(z, v),
                        r && (b.stroke(), b.beginPath(), b.moveTo(z, v))));
                  q = { x: z, y: v };
                  s < m.length - 1 &&
                    (w !== (m[s].lineColor || f) ||
                    ...
                    c.setLineDash &&
                      (m[s].lineDashType
                        ...
                        : ((n = k.lineDashType), c.setLineDash(g))));
                  if (
                    0 !== m[s].markerSize &&
            ...
            for (var J = !1, s = 0; s < m.length; s++)
              if (
                ...
                if ("number" !== typeof m[s].y)
                  ...
                  0 !== m[s].markerSize &&
                    (0 < m[s].markerSize || 0 < k.markerSize) &&
                    ((G = k.getMarkerProperties(s, z, v, c)),
                    h.push(G),
                    (Z = V(Z)),
                    r &&
                      h.push({
    ...
    x.prototype.renderSpline = function (a) {
          ...
          for (var c = 0; c < a.length - 3; c += 3)
            if (
              ...
              b.stroke(),
                ...
                r &&
                  (d.stroke(), d.beginPath(), d.moveTo(a[c + 3].x, a[c + 3].y));
          b.stroke();
          r && d.stroke();
        }
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          b.beginPath();
          if (0 < m.length)
            for (z = !1, y = 0; y < m.length; y++)
              if (
                ((s = m[y].getTime ? m[y].x.getTime() : m[y].x),
                !(
                ...
                if ("number" !== typeof m[y].y)
                  0 < y &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[y - 1].lineDashType) &&
                        ((v[v.length - 1].newLineDashArray = p),
                        (n = k.nullDataLineDashType))
                      : (e(v), (v = []))),
                    (z = !0);
                else {
                  ...
                  y < m.length - 1 &&
                    (w !== (m[y].lineColor || f) ||
                      n !== (m[y].lineDashType || k.lineDashType)) &&
                    ((w = m[y].lineColor || f),
                    ...
                    b.setLineDash &&
                      (m[y].lineDashType
                        ...
                        : ((n = k.lineDashType),
                          (v[v.length - 1].newLineDashArray = g))));
                  if (
                    0 !== m[y].markerSize &&
                    (0 < m[y].markerSize || 0 < k.markerSize)
                  ) {
    ...
    x.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < f.length)
            for (
              var w = 5 < n && g.bevelEnabled ? !0 : !1, h = 0;
              h < f.length;
              h++
            )
              if (
                (f[h].getTime ? (l = f[h].x.getTime()) : (l = f[h].x),
                !(
                ...
                b = f[h].color
                  ? f[h].color
                  : g._colorSet[h % g._colorSet.length];
                ea(
                  c,
                  a.axisX.reversed ? y : q,
                  u,
                  a.axisX.reversed ? q : y,
                  s,
                  b,
                  0,
                  null,
                  w && (a.axisY.reversed ? 0 > f[h].y : 0 <= f[h].y),
                  (a.axisY.reversed ? 0 <= f[h].y : 0 > f[h].y) && w,
                  !1,
                  !1,
                  g.fillOpacity
                );
                ...
                (f[h].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    point: {
                      x: q + (y - q) / 2,
                      y: 0 > f[h].y === a.axisY.reversed ? u : s,
                    },
          ...
          if (0 < s.length) {
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                m =
                  (m - (a.plotType.plotUnits.length * f) / 2 + a.index * f) <<
                  0;
                var v = (m + f) << 0,
                  J;
                if (
                  ...
                  (l[b] = s[k].y + (l[b] ? l[b] : 0)),
                    (J = a.axisY.convertValueToPixel(l[b])),
                    (n = "undefined" !== typeof q[b] ? q[b] : p),
                    (q[b] = J);
                else if (
                ...
                b = s[k].color
                  ? s[k].color
                  : y._colorSet[k % y._colorSet.length];
                ea(
                  c,
                  m,
                  a.axisY.reversed ? J : n,
                  v,
                  a.axisY.reversed ? n : J,
                  b,
                  0,
                  null,
    ...
    x.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < s.length)
            for (
              var z = 5 < f && y.bevelEnabled ? !0 : !1, k = 0;
              k < s.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  (l[b] = n + ("undefined" !== typeof l[b] ? l[b] : 0)),
                    (J = a.axisY.convertValueToPixel(l[b])),
                    (n = q[b] ? q[b] : p),
                    (q[b] = J);
            ...
            for (h = 0; h < f.length; h++)
              if (
                ...
                ea(
                  ...
                  a.axisX.reversed ? y : u,
                  a.axisY.reversed ? s : q,
                  a.axisX.reversed ? u : y,
                  b,
                  0,
                  null,
                  w,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        C = this.options.dataPointWidth
          ...
          : (0.9 *
              ((d.height *
                (a.axisX.logarithmic
                  ? Math.log(C) / Math.log(a.axisX.range)
                  : Math.abs(C) / Math.abs(a.axisX.range))) /
                a.plotType.plotUnits.length)) <<
            0;
        this.dataPointMaxWidth &&
          k > g &&
          ...
          if (0 < s.length) {
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                n =
                  (n - (a.plotType.plotUnits.length * C) / 2 + a.index * C) <<
                  0;
                var v = (n + C) << 0,
                  J;
                if (
                  ...
                  (f[b] = s[k].y + (f[b] ? f[b] : 0)),
                    (m = q[b] ? q[b] : p),
                    (q[b] = J = a.axisY.convertValueToPixel(f[b]));
                else if (
                ...
                ea(
                  c,
                  a.axisY.reversed ? m : J,
                  n,
                  a.axisY.reversed ? J : m,
                  v,
                  b,
                  0,
                  null,
            ...
            for (k = 0; k < s.length; k++)
              if (
                ...
                if (
                  ...
                  (f[b] = v + (f[b] ? f[b] : 0)),
                    (m = q[b] ? q[b] : p),
                    (q[b] = v = a.axisY.convertValueToPixel(f[b]));
    ...
    x.prototype.renderArea = function (a) {
      ...
      function b() {
        G &&
          ...
          h.fill(),
          (h.globalAlpha = 1),
          r && (q.lineTo(y, J), q.lineTo(G.x, J), q.closePath(), q.fill()),
          h.beginPath(),
          h.moveTo(y, s),
          q.beginPath(),
          q.moveTo(y, s),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          var w = 0,
            ...
            G = null;
          if (0 < C.length) {
            var x = g._colorSet[w % g._colorSet.length],
              t = (g.lineColor = g.options.lineColor || x),
              A = t;
            h.fillStyle = x;
            h.strokeStyle = t;
            ...
            for (var ca = !0; w < C.length; w++)
              if (
                ((z = C[w].x.getTime ? C[w].x.getTime() : C[w].x),
                !(
                  z < a.axisX.dataInfo.viewPortMin ||
                  (z > a.axisX.dataInfo.viewPortMax &&
                ...
                if ("number" !== typeof C[w].y)
                  g.connectNullData || ca || e || b(), (ca = !0);
                else {
                  ...
                  w < C.length - 1 &&
                    (A !== (C[w].lineColor || t) ||
                      c !== (C[w].lineDashType || g.lineDashType)) &&
                    (b(),
                    (A = C[w].lineColor || t),
                    (h.strokeStyle = A),
                    h.setLineDash &&
                      (C[w].lineDashType
                        ? ((c = C[w].lineDashType),
                          h.setLineDash(I(c, g.lineThickness)))
                        : ((c = g.lineDashType), h.setLineDash(M))));
                  ...
                  0 !== C[w].markerSize &&
                    (0 < C[w].markerSize || 0 < g.markerSize) &&
                    ((z = g.getMarkerProperties(w, y, s, h)),
                    f.push(z),
                    (da = V(da)),
                    r &&
                      f.push({
    ...
    x.prototype.renderSplineArea = function (a) {
          ...
          if (0 < m.lineThickness) {
            ...
            for (var g = 0; g < c.length - 3; g += 3)
              if (
                ...
                b.stroke(),
                  b.beginPath(),
                  b.moveTo(c[g + 3].x, c[g + 3].y),
                  c[g + 3].newStrokeStyle &&
                    (b.strokeStyle = c[g + 3].newStrokeStyle),
                  c[g + 3].newLineDashArray &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip();
        r && (d.beginPath(), d.rect(l.x1, l.y1, l.width, l.height), d.clip());
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < n.length) {
            var v = m._colorSet[p % m._colorSet.length],
              J = (m.lineColor = m.options.lineColor || v),
              G = J;
            b.fillStyle = v;
            b.strokeStyle = J;
            ...
            if (b.setLineDash) {
              var A = I(m.nullDataLineDashType, m.lineThickness),
                x = m.lineDashType,
                B = I(x, m.lineThickness);
              b.setLineDash(B);
            }
            for (C = !1; p < n.length; p++)
              if (
                ((g = n[p].x.getTime ? n[p].x.getTime() : n[p].x),
                !(
                ...
                if ("number" !== typeof n[p].y)
                  ...
                  p < n.length - 1 &&
                    (G !== (n[p].lineColor || J) ||
                      x !== (n[p].lineDashType || m.lineDashType)) &&
                    ((G = n[p].lineColor || J),
                    (z[z.length - 1].newStrokeStyle = G),
                    b.setLineDash &&
                      (n[p].lineDashType
                        ? ((x = n[p].lineDashType),
    ...
    x.prototype.renderStepArea = function (a) {
      ...
      function b() {
        G &&
          ...
          h.fill(),
          (h.globalAlpha = 1),
          r && (q.lineTo(y, x), q.lineTo(G.x, x), q.closePath(), q.fill()),
          h.beginPath(),
          h.moveTo(y, s),
          q.beginPath(),
          q.moveTo(y, s),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          c = !1;
          if (0 < C.length) {
            var t = g._colorSet[w % g._colorSet.length],
              A = (g.lineColor = g.options.lineColor || t),
              B = A;
            h.fillStyle = t;
            h.strokeStyle = A;
            h.lineWidth = g.lineThickness;
              ...
              if (
                ...
                "number" !== typeof C[w].y
                  ...
                  : ((y = a.axisX.convertValueToPixel(z)),
                    ...
                    w < C.length - 1 &&
                      (B !== (C[w].lineColor || A) ||
                        L !== (C[w].lineDashType || g.lineDashType)) &&
                      (b(),
                      (B = C[w].lineColor || A),
                      (h.strokeStyle = B),
                      h.setLineDash &&
                        (C[w].lineDashType
                          ? ((L = C[w].lineDashType),
                            h.setLineDash(I(L, g.lineThickness)))
                          : ((L = g.lineDashType), h.setLineDash(ca)))),
                    (z = g.dataPointIds[w]),
                    (this._eventManager.objectMap[z] = {
                      id: z,
                      objectType: "dataPoint",
                    ...
                    0 !== C[w].markerSize &&
                      (0 < C[w].markerSize || 0 < g.markerSize) &&
                      ((da = g.getMarkerProperties(w, y, s, h)),
                      f.push(da),
                      (z = V(z)),
                      r &&
                        f.push({
    ...
    x.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var d = [], x = 0; x < a.dataSeriesIndexes.length; x++) {
          var G = a.dataSeriesIndexes[x],
            t = this.data[G],
            A = t.dataPoints;
          t.dataPointIndexes = [];
          for (p = 0; p < A.length; p++)
            (G = A[p].x.getTime ? A[p].x.getTime() : A[p].x),
              (t.dataPointIndexes[G] = p),
              d[G] || (m.push(G), (d[G] = !0));
          m.sort(Ta);
        }
        for (x = 0; x < a.dataSeriesIndexes.length; x++) {
          G = a.dataSeriesIndexes[x];
          t = this.data[G];
          A = t.dataPoints;
          z = !0;
          k = [];
          ...
          if (0 < m.length) {
            var d = t._colorSet[0],
              B = (t.lineColor = t.options.lineColor || d),
              L = B;
            b.fillStyle = d;
            b.strokeStyle = B;
            ...
            v = "solid";
            if (b.setLineDash) {
              var M = I(t.nullDataLineDashType, t.lineThickness);
              v = t.lineDashType;
              var ca = I(v, t.lineThickness);
              b.setLineDash(ca);
            }
            for (var da = !0, p = 0; p < m.length; p++) {
              var h = m[p],
                fa = null,
                fa =
                  0 <= t.dataPointIndexes[h]
                    ? A[t.dataPointIndexes[h]]
                    : { x: h, y: null };
              if (
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                  (h > a.axisX.dataInfo.viewPortMax &&
                    (!t.connectNullData || !da))
                )
              )
                if ("number" !== typeof fa.y)
                  t.connectNullData || da || z || e(), (da = !0);
                else {
                  ...
                  z || da
                    ? (!z && t.connectNullData
                        ? (b.setLineDash &&
                            (t.options.nullDataLineDashType ||
                              (v === t.lineDashType &&
                                t.lineDashType !== t.nullDataLineDashType)) &&
                            ((z = k.pop()),
                            (v = k[k.length - 1]),
                            e(),
                            b.moveTo(s.x, s.y),
                            k.push(v),
                            k.push(z),
                            (v = t.nullDataLineDashType),
                            b.setLineDash(M)),
                          b.lineTo(g, C),
                          r && y.lineTo(g, C))
                        : (b.beginPath(),
                          b.moveTo(g, C),
                          r && (y.beginPath(), y.moveTo(g, C))),
                      (da = z = !1))
                    : (b.lineTo(g, C),
                      r && y.lineTo(g, C),
                      0 == p % 250 &&
                  ...
                  p < A.length - 1 &&
                    (L !== (A[p].lineColor || B) ||
                      v !== (A[p].lineDashType || t.lineDashType)) &&
                    (e(),
                    b.beginPath(),
                    b.moveTo(g, C),
                    k.push({ x: g, y: w - oa }),
                    ...
                    b.setLineDash &&
                      (A[p].lineDashType
                        ? ((v = A[p].lineDashType),
                          b.setLineDash(I(v, t.lineThickness)))
                        : ((v = t.lineDashType), b.setLineDash(ca))));
                  if (0 <= t.dataPointIndexes[h]) {
                    var ma = t.dataPointIds[t.dataPointIndexes[h]];
                    this._eventManager.objectMap[ma] = {
                      id: ma,
                      objectType: "dataPoint",
                      dataSeriesIndex: G,
                      dataPointIndex: t.dataPointIndexes[h],
                      x1: g,
                      y1: C,
                    };
                  }
                  0 <= t.dataPointIndexes[h] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < t.markerSize) &&
                    ((oa = t.getMarkerProperties(
                      t.dataPointIndexes[h],
                      g,
                      C,
                      b
                    )),
    ...
    x.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var d = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          var x = a.dataSeriesIndexes[t],
            Z = this.data[x],
            A = Z.dataPoints;
          Z.dataPointIndexes = [];
          for (p = 0; p < A.length; p++)
            (x = A[p].x.getTime ? A[p].x.getTime() : A[p].x),
              (Z.dataPointIndexes[x] = p),
              d[x] || (m.push(x), (d[x] = !0));
          m.sort(Ta);
        }
        for (t = 0; t < a.dataSeriesIndexes.length; t++) {
          x = a.dataSeriesIndexes[t];
          Z = this.data[x];
          A = Z.dataPoints;
          y = !0;
          d = Z.id;
          ...
          k = [];
          if (0 < m.length) {
            var d = Z._colorSet[p % Z._colorSet.length],
              B = (Z.lineColor = Z.options.lineColor || d),
              L = B;
            b.fillStyle = d;
            b.strokeStyle = B;
              ...
              var h = m[p],
                ...
                fa =
                  0 <= Z.dataPointIndexes[h]
                    ? A[Z.dataPointIndexes[h]]
                    : { x: h, y: null };
              if (
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                  (h > a.axisX.dataInfo.viewPortMax &&
                    (!Z.connectNullData || !da))
                )
              )
                if ("number" !== typeof fa.y)
                  Z.connectNullData || da || y || e(), (da = !0);
                else {
                  var oa;
                  oa =
                    0 !== a.dataPointYSums[h]
                      ? 100 * (fa.y / a.dataPointYSums[h])
                      : 0;
                  g = a.axisX.convertValueToPixel(h);
                  var ma = f[h] ? f[h] : 0;
                  if (
                  ...
                  y || da
                    ? (!y && Z.connectNullData
                        ? (b.setLineDash &&
                            ...
                            k.push(s),
                            k.push(y),
                            (s = Z.nullDataLineDashType),
                            b.setLineDash(M)),
                          b.lineTo(g, C),
                          r && v.lineTo(g, C))
                        : (b.beginPath(),
                          b.moveTo(g, C),
                          r && (v.beginPath(), v.moveTo(g, C))),
                      (da = y = !1))
                    : (b.lineTo(g, C),
                      r && v.lineTo(g, C),
                      0 == p % 250 &&
                  ...
                  p < A.length - 1 &&
                    (L !== (A[p].lineColor || B) ||
                      s !== (A[p].lineDashType || Z.lineDashType)) &&
                    (e(),
                    b.beginPath(),
                    b.moveTo(g, C),
                    k.push({ x: g, y: z - ma }),
                    ...
                    b.setLineDash &&
                      (A[p].lineDashType
                        ? ((s = A[p].lineDashType),
                          b.setLineDash(I(s, Z.lineThickness)))
                        : ((s = Z.lineDashType), b.setLineDash(ca))));
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          ...
          for (
            ...
            (h = p[d].getTime ? (h = p[d].x.getTime()) : (h = p[d].x)),
              h < a.axisX.dataInfo.viewPortMin ||
                h > a.axisX.dataInfo.viewPortMax ||
                "undefined" === typeof p[d].z ||
                ((g = p[d].z), g > l && (l = g), g < f && (f = g));
        for (
          var C = 25 * Math.PI,
            w = Math.max(
          ...
          if (
            ...
            for (c.strokeStyle = "#4572A7 ", d = 0; d < p.length; d++)
              if (
                ((h = p[d].getTime ? (h = p[d].x.getTime()) : (h = p[d].x)),
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                ...
                var g = p[d].z,
                  y =
                    ...
                    Math.max(
                      Math.sqrt(
                        (l === f ? w / 2 : C + ((w - C) / (l - f)) * (g - f)) /
                          Math.PI
                      ) << 0,
                      1
                    ),
                  g = n.getMarkerProperties(d, c);
                g.size = y;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (0 < m.length) {
            ...
            for (var n = 0, p = 0, d = 0; d < m.length; d++)
              if (
                ((h = m[d].getTime ? (h = m[d].x.getTime()) : (h = m[d].x)),
                !(
                  h < a.axisX.dataInfo.viewPortMin ||
                  h > a.axisX.dataInfo.viewPortMax
                ) && "number" === typeof m[d].y)
    ...
    x.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
          var y = a.dataSeriesIndexes[w],
            s = this.data[y],
            z = s.dataPoints;
          if (0 < z.length)
            for (
              var v = 5 < C && s.bevelEnabled ? !0 : !1, f = 0;
              f < z.length;
              f++
            )
              if (
                (z[f].getTime ? (g = z[f].x.getTime()) : (g = z[f].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  !l(z[f].y) &&
                  z[f].y.length &&
                  "number" === typeof z[f].y[0] &&
                  "number" === typeof z[f].y[1] &&
                  "number" === typeof z[f].y[2] &&
                  "number" === typeof z[f].y[3])
              ) {
                E = a.axisX.convertValueToPixel(g);
                k = a.axisY.convertValueToPixel(z[f].y[0]);
                m = a.axisY.convertValueToPixel(z[f].y[1]);
                n = a.axisY.convertValueToPixel(z[f].y[2]);
                p = a.axisY.convertValueToPixel(z[f].y[3]);
                var t = (E - C / 2) << 0,
                  x = (t + C) << 0,
                  h = s.options.fallingColor ? s.fallingColor : s._colorSet[0],
                  d = z[f].color ? z[f].color : s._colorSet[0],
                  A = Math.round(Math.max(1, 0.15 * C)),
                  B = 0 === A % 2 ? 0 : 0.5,
                  I = s.dataPointIds[f];
                ...
                "candlestick" === s.type
                  ? (c.moveTo(E - B, m),
                    c.lineTo(E - B, Math.min(k, p)),
                    c.stroke(),
                    c.moveTo(E - B, Math.max(k, p)),
                    c.lineTo(E - B, n),
                    c.stroke(),
                    ea(
                      c,
                      ...
                      x,
                      Math.max(k, p),
                      z[f].y[0] <= z[f].y[3] ? s.risingColor : h,
                      A,
                      d,
                      v,
                      v,
                    ...
                    r &&
                      ...
                      (b.strokeStyle = d),
                      b.moveTo(E - B, m),
                      b.lineTo(E - B, Math.min(k, p)),
                      b.stroke(),
                      b.moveTo(E - B, Math.max(k, p)),
                      b.lineTo(E - B, n),
                      b.stroke(),
                      ea(
                        b,
                ...
                (z[f].indexLabel ||
                  s.indexLabel ||
                  z[f].indexLabelFormatter ||
                  s.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: s.type,
                    dataPoint: z[f],
                    dataSeries: s,
                    point: { x: t + (x - t) / 2, y: a.axisY.reversed ? n : m },
                    direction: 1,
                    bounds: {
                      x1: t,
                      y1: Math.min(m, n),
    ...
    x.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var w = !1, w = !!a.axisY.reversed, y = 0;
          y < a.dataSeriesIndexes.length;
          y++
        ) {
          ...
          if (0 < v.length)
            for (
              var t = 5 < C && z.bevelEnabled ? !0 : !1, q = 0;
              q < v.length;
              q++
            )
              if (
                ...
                var x = (f - C / 2) << 0,
                  A = (f + C / 2) << 0,
                  d = v[q].color ? v[q].color : z._colorSet[0],
                  ...
                  L = v[q].whiskerColor
                    ...
                    : d,
                  M =
                    "number" === typeof v[q].whiskerThickness
                      ? v[q].whiskerThickness
                      : "number" === typeof z.options.whiskerThickness
                      ? z.whiskerThickness
                      : B,
                  ca = v[q].whiskerDashType
                    ? v[q].whiskerDashType
                    : z.whiskerDashType,
                  da = l(v[q].whiskerLength)
                    ? l(z.options.whiskerLength)
                      ? C
                      : z.whiskerLength
                    : v[q].whiskerLength,
                  da =
                  ...
                  oa = v[q].stemColor
                    ...
                    : d,
                  ma =
                    "number" === typeof v[q].stemThickness
                      ? v[q].stemThickness
                      : "number" === typeof z.options.stemThickness
                      ? z.stemThickness
                      : B,
                  D = 1 === Math.round(ma) % 2 ? 0.5 : 0,
                  S = v[q].stemDashType ? v[q].stemDashType : z.stemDashType,
                  Q = v[q].lineColor
                    ? v[q].lineColor
                    : v[q].color
                    ? z.lineColor
                    ...
                    : d,
                  K =
                    "number" === typeof v[q].lineThickness
                      ? v[q].lineThickness
                      : "number" === typeof z.options.lineThickness
                      ? z.lineThickness
                      : B,
                  U = v[q].lineDashType ? v[q].lineDashType : z.lineDashType,
                  T = 1 === Math.round(K) % 2 ? 0.5 : 0,
                  O = z.upperBoxColor,
                  N = z.lowerBoxColor,
                  sa = l(z.options.fillOpacity) ? 1 : z.fillOpacity,
                  P = z.dataPointIds[q];
                this._eventManager.objectMap[P] = {
                  id: P,
                  objectType: "dataPoint",
                ...
                0 < ma &&
                  ...
                  (c.strokeStyle = oa),
                  (c.lineWidth = ma),
                  c.setLineDash && c.setLineDash(I(S, ma)),
                  c.moveTo(f - D, k),
                  c.lineTo(f - D, E),
                  c.stroke(),
                  c.moveTo(f - D, n),
                ...
                0 < K &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(I(U, K)),
                  (c.strokeStyle = Q),
                  (c.lineWidth = K),
                  c.moveTo(x, p - T),
                  c.lineTo(A, p - T),
                ...
                0 < M &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(I(ca, M)),
                  (c.strokeStyle = L),
                  (c.lineWidth = M),
                  c.moveTo((f - da / 2) << 0, n - fa),
                  c.lineTo((f + da / 2) << 0, n - fa),
                  c.stroke(),
                  c.moveTo((f - da / 2) << 0, E + fa),
                  c.lineTo((f + da / 2) << 0, E + fa),
                  c.stroke());
                c.restore();
                r &&
                  ((d = V(P)),
                  ...
                  0 < ma &&
                    (b.moveTo(f - F - D, k),
                    b.lineTo(f - F - D, Math.max(E, n)),
                    b.stroke(),
                    b.moveTo(f - F - D, Math.min(E, n)),
                    b.lineTo(f - F - D, m),
                    b.stroke()),
                  ea(
                    b,
                  ...
                  0 < M &&
                    (b.beginPath(),
                    (b.lineWidth = M),
                    b.moveTo(f + da / 2, n - fa),
                    b.lineTo(f - da / 2, n - fa),
                    b.stroke(),
                    b.moveTo(f + da / 2, E + fa),
                    b.lineTo(f - da / 2, E + fa),
                    b.stroke()));
                (v[q].indexLabel ||
                  z.indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: v[q],
                    dataSeries: z,
                    point: { x: x + (A - x) / 2, y: a.axisY.reversed ? E : n },
                    direction: 1,
                    bounds: {
                      x1: x,
                      y1: Math.min(E, n),
    ...
    x.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < g.length)
            for (
              var C = 5 < k && p.bevelEnabled ? !0 : !1, h = 0;
              h < g.length;
              h++
            )
              if (
                ...
                var w = a.axisX.reversed
                    ...
                    : (b -
                        ...
                        (a.previousDataSeriesCount + m) * k) <<
                      0,
                  y = a.axisX.reversed ? (w - k) << 0 : (w + k) << 0,
                  b = g[h].color
                    ? g[h].color
                ...
                ea(
                  c,
                  a.axisX.reversed ? y : w,
                  q,
                  a.axisX.reversed ? w : y,
                  f,
                  b,
                  0,
                  b,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0, s = 0; s < this.data.length; s++)
          !this.data[s].type.match(/(bar|column)/gi) ||
            !this.data[s].visible ||
            (this.data[s].type.match(/(stacked)/gi) && y) ||
            y++;
        for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
          var v = a.dataSeriesIndexes[z],
            ...
            B = l(t._linkedSeries)
              ? !1
              : t._linkedSeries.type.match(/(bar|column)/gi) &&
                t._linkedSeries.visible
              ? !0
              : !1,
            I = 0;
          if (B)
            for (d = t._linkedSeries.id, s = 0; s < d; s++)
              !this.data[s].type.match(/(bar|column)/gi) ||
                !this.data[s].visible ||
                (this.data[s].type.match(/(stacked)/gi) && I) ||
                (this.data[s].type.match(/(range)/gi) && (h = !0), I++);
          d = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          f = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (B ? y : 1))
              ) << 0
            : 0.3 * this.width;
          h &&
            (f = this.options.dataPointMaxWidth
          ...
          s > f && (s = f);
          if (0 < x.length)
            for (var F = t._colorSet, f = 0; f < x.length; f++) {
              var d = (t.lineColor = t.options.color ? t.options.color : F[0]),
                L = {
                  color: x[f].whiskerColor
                    ? x[f].whiskerColor
                    : x[f].color
                    ? t.whiskerColor
                      ? t.whiskerColor
                    ...
                    ? t.whiskerColor
                    : d,
                  thickness: l(x[f].whiskerThickness)
                    ? t.whiskerThickness
                    : x[f].whiskerThickness,
                  dashType: x[f].whiskerDashType
                    ? x[f].whiskerDashType
                    : t.whiskerDashType,
                  length: l(x[f].whiskerLength)
                    ? l(t.options.whiskerLength)
                      ? s
                      : t.options.whiskerLength
                    : x[f].whiskerLength,
                  trimLength: l(x[f].whiskerLength)
                    ? l(t.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              var M = {
                color: x[f].stemColor
                  ...
                  ? t.stemColor
                  : d,
                thickness: x[f].stemThickness
                  ? x[f].stemThickness
                  : t.stemThickness,
                dashType: x[f].stemDashType
                  ? x[f].stemDashType
                  : t.stemDashType,
              };
              M.thickness =
                "number" === typeof M.thickness
                  ...
                  : 2;
              x[f].getTime ? (C = x[f].x.getTime()) : (C = x[f].x);
              if (
                !(
                ...
                !l(x[f].y) &&
                x[f].y.length &&
                "number" === typeof x[f].y[0] &&
                "number" === typeof x[f].y[1]
              ) {
                var ca = a.axisX.convertValueToPixel(C);
                b ? (k = ca) : (E = ca);
                ca = a.axisY.convertValueToPixel(x[f].y[0]);
                b ? (m = ca) : (p = ca);
                ca = a.axisY.convertValueToPixel(x[f].y[1]);
                b ? (n = ca) : (g = ca);
                b
                  ? ((p = a.axisX.reversed
                      ? (k + ((B ? y : 1) * s) / 2 - (B ? I - 1 : 0) * s) << 0
                      : (k - ((B ? y : 1) * s) / 2 + (B ? I - 1 : 0) * s) << 0),
                    (g = a.axisX.reversed ? (p - s) << 0 : (p + s) << 0))
                  : ((m = a.axisX.reversed
                      ? (E + ((B ? y : 1) * s) / 2 - (B ? I - 1 : 0) * s) << 0
                      : (E - ((B ? y : 1) * s) / 2 + (B ? I - 1 : 0) * s) << 0),
                ...
                r && A(this._eventManager.ghostCtx, m, p, n, g, d, L, M, b);
                if (
                  x[f].indexLabel ||
                  t.indexLabel ||
                  x[f].indexLabelFormatter ||
                  t.indexLabelFormatter
                )
                  this._indexLabels.push({
                    chartType: "error",
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (x[f].y[1] >= x[f].y[0] ? m : n) : m + (n - m) / 2,
                      y: b ? p + (g - p) / 2 : x[f].y[1] >= x[f].y[0] ? g : p,
                    },
                    direction: x[f].y[1] >= x[f].y[0] ? -1 : 1,
                    bounds: {
                      x1: b ? Math.min(m, n) : m,
                      y1: b ? p : Math.min(p, g),
                      x2: b ? Math.max(m, n) : n,
                      ...
                      point: {
                        x: b
                          ? x[f].y[1] >= x[f].y[0]
                            ...
                            : m
                          : m + (n - m) / 2,
                        y: b ? p + (g - p) / 2 : x[f].y[1] >= x[f].y[0] ? p : g,
                      },
                      direction: x[f].y[1] >= x[f].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(m, n) : m,
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < C.length) {
            ...
            for (h = 0; h < C.length; h++)
              if (
                (C[h].getTime ? (k = C[h].x.getTime()) : (k = C[h].x),
                !(
                  ...
                  !l(C[h].y) &&
                  C[h].y.length &&
                  "number" === typeof C[h].y[0] &&
                  "number" === typeof C[h].y[1])
              ) {
                q = a.axisY.convertValueToPixel(C[h].y[0]);
                f = a.axisY.convertValueToPixel(C[h].y[1]);
                ...
                ea(
                  c,
                  q,
                  a.axisX.reversed ? y : E,
                  f,
                  a.axisX.reversed ? E : y,
                  b,
                  0,
                  null,
                  w,
    ...
    x.prototype.renderRangeArea = function (a) {
      function e() {
        if (z) {
          for (var a = null, c = l.length - 1; 0 <= c; c--)
            (a = l[c]), b.lineTo(a.x, a.y2), d.lineTo(a.x, a.y2);
          b.closePath();
          b.globalAlpha = m.fillOpacity;
          b.fill();
          b.globalAlpha = 1;
        ...
        for (var f = 0; f < a.dataSeriesIndexes.length; f++) {
          ...
          if (0 < n.length) {
            var v = m._colorSet[g % m._colorSet.length],
              x = (m.lineColor = m.options.lineColor || v),
              t = x;
            b.fillStyle = v;
            b.strokeStyle = x;
            b.lineWidth = m.lineThickness;
            var A = "solid";
            if (b.setLineDash) {
              var B = I(m.nullDataLineDashType, m.lineThickness),
                A = m.lineDashType,
                F = I(A, m.lineThickness);
              b.setLineDash(F);
            }
            for (var L = !0; g < n.length; g++)
              if (
                ((s = n[g].x.getTime ? n[g].x.getTime() : n[g].x),
                !(
                  s < a.axisX.dataInfo.viewPortMin ||
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!m.connectNullData || !L))
                ...
                if (
                  ...
                  p || L
                    ? (m.connectNullData && !p
                        ? (b.setLineDash &&
                            ...
                            ((l[l.length - 1].newLineDashArray = F),
                            (A = m.nullDataLineDashType),
                            b.setLineDash(B)),
                          b.lineTo(C, w),
                          r && d.lineTo(C, w),
                          l.push({ x: C, y1: w, y2: y }))
                  ...
                  g < n.length - 1 &&
                    (t !== (n[g].lineColor || x) ||
                      A !== (n[g].lineDashType || m.lineDashType)) &&
                    (e(),
                    (t = n[g].lineColor || x),
                    (l[l.length - 1].newStrokeStyle = t),
                    (b.strokeStyle = t),
                    b.setLineDash &&
                      (n[g].lineDashType
                        ? ((A = n[g].lineDashType),
                          (l[l.length - 1].newLineDashArray = I(
                            A,
                            m.lineThickness
                          )),
                          b.setLineDash(l[l.length - 1].newLineDashArray))
                        : ((A = m.lineDashType),
                          (l[l.length - 1].newLineDashArray = F),
                          b.setLineDash(F))));
                  if (
                    0 !== n[g].markerSize &&
                    (0 < n[g].markerSize || 0 < m.markerSize)
                  ) {
        ...
        if (0 < g.length) {
          if (0 < k.lineThickness) {
            ...
            for (var e = 0; e < g.length - 3; e += 3) {
              if (g[e].newStrokeStyle || g[e].newLineDashArray)
                b.stroke(),
                  b.beginPath(),
                  b.moveTo(g[e].x, g[e].y),
                  g[e].newStrokeStyle && (b.strokeStyle = g[e].newStrokeStyle),
                  g[e].newLineDashArray && b.setLineDash(g[e].newLineDashArray);
              b.bezierCurveTo(
                g[e + 1].x,
                g[e + 1].y,
                g[e + 2].x,
          ...
          if (0 < m.length) {
            ...
            if (b.setLineDash) {
              var B = I(k.nullDataLineDashType, k.lineThickness),
                x = k.lineDashType;
              A = I(x, k.lineThickness);
            }
            for (g = !1; n < m.length; n++)
              if (
                ((p = m[n].x.getTime ? m[n].x.getTime() : m[n].x),
                !(
                ...
                if (
                  ...
                  n < m.length - 1 &&
                    (v !== (m[n].lineColor || z) ||
                      x !== (m[n].lineDashType || k.lineDashType)) &&
                    ((v = m[n].lineColor || z),
                    ...
                    b.setLineDash &&
                      (m[n].lineDashType
                        ...
                        : ((x = k.lineDashType),
                          (w[w.length - 1].newLineDashArray = A))));
                  if (
                    0 !== m[n].markerSize &&
                    (0 < m[n].markerSize || 0 < k.markerSize)
                  ) {
                    var K = k.getMarkerProperties(n, p, g, b);
                    h.push(K);
                    var L = V(F);
                    r &&
                      h.push({
                    ...
                    K = k.getMarkerProperties(n, p, C, b);
                    h.push(K);
                    L = V(F);
                    r &&
                      h.push({
                  ...
                  0 < n &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[n - 1].lineDashType) &&
                        ((w[w.length - 1].newLineDashArray = B),
                        (x = k.nullDataLineDashType))
                      : (e(A, z), (w = []), (y = []))),
                    (g = !0);
            e(A, z);
            ba.drawMarkers(h);
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < y.length)
            for (
              ...
              if (
                (y[q].getTime ? (m = y[q].x.getTime()) : (m = y[q].x),
                "number" !== typeof y[q].y)
              ) {
                if (0 < q && !x && w.connectNullData)
                  var B =
                    w.options.nullDataLineDashType || !y[q - 1].lineDashType
                ...
                f = a.axisX.reversed
                  ...
                  : (f -
                      ...
                      (a.previousDataSeriesCount + g) * p) <<
                    0;
                var F = a.axisX.reversed ? (f - p) << 0 : (f + p) << 0;
                l > k && ((d = l), (l = k), (k = d));
                a.axisY.reversed && ((d = l), (l = k), (k = d));
                d = w.dataPointIds[q];
                this._eventManager.objectMap[d] = {
                  id: d,
                  objectType: "dataPoint",
                ...
                var M,
                  L = f;
                M =
                  ("undefined" !== typeof y[q].isIntermediateSum &&
                    !0 === y[q].isIntermediateSum) ||
                  ("undefined" !== typeof y[q].isCumulativeSum &&
                    !0 === y[q].isCumulativeSum)
                    ? 0 < y[q].y
                      ? l
                      : k
                    : 0 < y[q].y
                ...
                0 < q &&
                  t &&
                  (!x || w.connectNullData) &&
                  (x && c.setLineDash && c.setLineDash(I(B, s)),
                  c.beginPath(),
                  c.moveTo(t, A - z),
                  c.lineTo(L, M - z),
                  0 < s && c.stroke(),
                ...
                (y[q].indexLabel ||
                  w.indexLabel ||
                  y[q].indexLabelFormatter ||
                  w.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "waterfall",
                    dataPoint: y[q],
                    dataSeries: w,
                    point: { x: f + (F - f) / 2, y: 0 <= y[q].y ? l : k },
    ...
    var ja = function (a, e, c, b, d, h, q, f, l) {
      if (!(0 > c)) {
    ...
    x.prototype.renderPie = function (a) {
      function e() {
        if (k && m) {
          var a = 0,
            ...
            c = 0,
            d = 0;
          l(k.options.indexLabelMaxWidth) &&
            (k.indexLabelMaxWidth = 0.33 * p.width);
          for (var e = 0; e < m.length; e++) {
            ...
            n = h.indexLabelFormatter
              ...
              : h.indexLabel
              ? r.replaceKeywordsWithValue(h.indexLabel, h, k, e)
              : k.indexLabelFormatter
              ? k.indexLabelFormatter(u)
              : k.indexLabel
              ? r.replaceKeywordsWithValue(k.indexLabel, h, k, e)
              : h.label
              ? h.label
              : "";
            r._eventManager.objectMap[q] = f;
            f.center = { x: v.x, y: v.y };
            f.y = h.y;
            f.radius = B;
            f.percentInnerRadius = K;
            f.indexLabelText = n;
            f.indexLabelPlacement = k.indexLabelPlacement;
            f.indexLabelLineColor = h.indexLabelLineColor
            ...
            f.indexLabelLineThickness = l(h.indexLabelLineThickness)
              ? k.indexLabelLineThickness
              : h.indexLabelLineThickness;
            f.indexLabelLineDashType = h.indexLabelLineDashType
              ? h.indexLabelLineDashType
              : k.indexLabelLineDashType;
            f.indexLabelFontColor = h.indexLabelFontColor
              ? h.indexLabelFontColor
              : k.indexLabelFontColor;
            f.indexLabelFontStyle = h.indexLabelFontStyle
              ? h.indexLabelFontStyle
              : k.indexLabelFontStyle;
            f.indexLabelFontWeight = h.indexLabelFontWeight
              ? h.indexLabelFontWeight
              : k.indexLabelFontWeight;
            f.indexLabelFontSize = l(h.indexLabelFontSize)
            ...
            f.indexLabelBackgroundColor = h.indexLabelBackgroundColor
              ? h.indexLabelBackgroundColor
              : k.options.indexLabelBackgroundColor
              ? k.options.indexLabelBackgroundColor
              : k.indexLabelBackgroundColor;
            f.indexLabelBorderColor = h.indexLabelBorderColor
              ? h.indexLabelBorderColor
              : k.options.indexLabelBorderColor
              ? k.options.indexLabelBorderColor
              : k.indexLabelBorderColor;
            f.indexLabelBorderThickness = h.indexLabelBorderThickness
              ? h.indexLabelBorderThickness
              : k.options.indexLabelBorderThickness
              ? k.options.indexLabelBorderThickness
              : k.indexLabelBorderThickness;
            f.indexLabelPadding = h.indexLabelPadding
              ? h.indexLabelPadding
              : k.options.indexLabelPadding
              ? k.options.indexLabelPadding
              : k.indexLabelPadding;
            f.indexLabelMaxWidth = h.indexLabelMaxWidth
            ...
            f.indexLabelWrap =
              "undefined" !== typeof h.indexLabelWrap
                ? h.indexLabelWrap
                : k.indexLabelWrap;
            f.indexLabelTextAlign = h.indexLabelTextAlign
            ...
            f.endAngle = f.startAngle + ((2 * Math.PI) / t) * Math.abs(h.y);
            h = (f.endAngle + f.startAngle) / 2;
            h = (h + 2 * Math.PI) % (2 * Math.PI);
            f.midAngle = h;
            if (f.midAngle > Math.PI / 2 - s && f.midAngle < Math.PI / 2 + s) {
              if (0 === a || g[c].midAngle > f.midAngle) c = e;
              a++;
            } else if (
              f.midAngle > (3 * Math.PI) / 2 - s &&
              f.midAngle < (3 * Math.PI) / 2 + s
            ) {
              if (0 === b || g[d].midAngle > f.midAngle) d = e;
              b++;
            }
            f.hemisphere =
              h > Math.PI / 2 && h <= (3 * Math.PI) / 2 ? "left" : "right";
            f.indexLabelTextBlock = new la(r.plotArea.ctx, {
              ...
              maxHeight: f.indexLabelWrap
                ? 5 * f.indexLabelFontSize
                : 1.5 * f.indexLabelFontSize,
              text: f.indexLabelText,
              padding: f.indexLabelPadding,
              textBaseline: "middle",
            });
          ...
          for (e = 0; e < m.length; e++)
            (f = g[(c + e) % m.length]),
              1 < a &&
                f.midAngle > Math.PI / 2 - s &&
                f.midAngle < Math.PI / 2 + s &&
                (h <= a / 2 && !n
                  ? ((f.hemisphere = "right"), h++)
                  : ((f.hemisphere = "left"), (n = !0)));
          n = !1;
          for (e = 0; e < m.length; e++)
            (f = g[(d + e) % m.length]),
              1 < b &&
      ...
      function c(a, b) {
        ...
        for (c = 0; c < m.length; c++) {
          ...
          if (d > e) {
            ...
            if (m[c].exploded) {
              if (
                1e-9 < Math.abs(g[c].center.x - (v.x + h)) ||
                1e-9 < Math.abs(g[c].center.y - (v.y + q))
              )
                (g[c].center.x = v.x + h * a),
                  (g[c].center.y = v.y + q * a),
                  (f = !0);
            } else if (
              0 < Math.abs(g[c].center.x - v.x) ||
              0 < Math.abs(g[c].center.y - v.y)
            )
              (g[c].center.x = v.x + h * (1 - a)),
                (g[c].center.y = v.y + q * (1 - a)),
                (f = !0);
            f &&
              b &&
              ((h = {}),
        ...
        c.lineJoin = "round";
        for (e = e = 0; e < m.length; e++)
          (d = g[e]),
            d.indexLabelText &&
              ((d.indexLabelTextBlock.y -=
                d.indexLabelTextBlock.height / 2 -
                d.indexLabelTextBlock.fontSize / 2),
              (h = 0),
              (h =
                "left" === d.hemisphere
                  ? "inside" !== k.indexLabelPlacement
                    ? -(d.indexLabelTextBlock.width + n)
                    : -d.indexLabelTextBlock.width / 2
                  : "inside" !== k.indexLabelPlacement
                  ? n
                  : -d.indexLabelTextBlock.width / 2),
              (d.indexLabelTextBlock.x += h),
              d.indexLabelTextBlock.render(!0),
              (d.indexLabelTextBlock.x -= h),
              (d.indexLabelTextBlock.y +=
                d.indexLabelTextBlock.height / 2 -
                d.indexLabelTextBlock.fontSize / 2),
              "inside" !== d.indexLabelPlacement &&
                0 < d.indexLabelLineThickness &&
                ((h = d.center.x + B * Math.cos(d.midAngle)),
                (q = d.center.y + B * Math.sin(d.midAngle)),
                (c.strokeStyle = d.indexLabelLineColor),
                (c.lineWidth = d.indexLabelLineThickness),
                c.setLineDash &&
                  c.setLineDash(
                    I(d.indexLabelLineDashType, d.indexLabelLineThickness)
                  ),
                c.beginPath(),
                c.moveTo(h, q),
                c.lineTo(d.indexLabelTextBlock.x, d.indexLabelTextBlock.y),
                c.lineTo(
                  d.indexLabelTextBlock.x + ("left" === d.hemisphere ? -n : n),
                  d.indexLabelTextBlock.y
                ),
                c.stroke()),
              (c.lineJoin = "miter"));
      ...
      function b(a, b) {
        ...
        return (c =
          b.indexLabelTextBlock.y > a.indexLabelTextBlock.y ? d - g : c - e);
      }
      function d(a) {
      ...
      function h(a, c, e) {
        ...
        if (0 <= a && a < m.length) {
          var l = g[a];
          if (
            (0 > c && l.indexLabelTextBlock.y < k) ||
            (0 < c && l.indexLabelTextBlock.y > f)
          )
            return 0;
          var n = 0,
            p = 0,
            p = (n = n = 0);
          0 > c
            ? l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 > k &&
              l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + c <
                k &&
              (c = -(
                k -
                (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + c)
            ...
            ? ((f = "right" === l.hemisphere ? p : n),
              ...
              null !== f &&
                ...
                (c =
                  l.indexLabelTextBlock.y -
                  l.indexLabelTextBlock.height / 2 -
                  (g[f].indexLabelTextBlock.y +
                    g[f].indexLabelTextBlock.height / 2)),
                c - p < x &&
                  ((k = -p),
                  (f = h(f, k, e + 1)),
                  +f.toFixed(z) > +k.toFixed(z) &&
                    (q = c > x ? -(c - x) : -(p - (f - k))))))
            : 0 < c &&
              ...
              null !== f &&
                ...
                c - p < x &&
                  ...
                  +f.toFixed(z) < +k.toFixed(z) &&
                    (q = c > x ? c - x : p - (k - f)))));
          q &&
            ((e = l.indexLabelTextBlock.y + q),
            (c = 0),
            (c =
              "right" === l.hemisphere
                ? v.x + Math.sqrt(Math.pow(w, 2) - Math.pow(e - v.y, 2))
                : v.x - Math.sqrt(Math.pow(w, 2) - Math.pow(e - v.y, 2))),
      ...
      function q() {
        var a = r.plotArea.ctx;
        a.fillStyle = "grey";
        a.strokeStyle = "grey";
        a.font = "16px Arial";
        a.textBaseline = "middle";
        for (
          var c = (a = 0), e = 0, q = !0, c = 0;
          10 > c && (1 > c || 0 < e);
          c++
        ) {
          if (
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (a = 0; a < m.length; a++) {
              var f = g[a];
              f.indexLabelTextBlock.x = v.x + w * Math.cos(f.midAngle);
              f.indexLabelTextBlock.y = v.y + w * Math.sin(f.midAngle);
            ...
            for (var l, s, a = 0; a < m.length; a++) {
              ...
              if (null !== u) {
                ...
                var t = 0,
                  t = b(l, s) - x;
                if (0 > t) {
                  for (var A = (s = 0), G = 0; G < m.length; G++)
                    G !== a &&
                      g[G].hemisphere === f.hemisphere &&
                      (g[G].indexLabelTextBlock.y < f.indexLabelTextBlock.y
                        ? s++
                        : A++);
                  s = (t / (s + A || 1)) * A;
                  var A = -1 * (t - s),
            ...
            for (a = 0; a < m.length; a++)
              (f = g[a]),
                (w = "pie" === k.type ? 0.7 * B : 0.85 * B),
                (u = v.x + w * Math.cos(f.midAngle)),
                (s = v.y + w * Math.sin(f.midAngle)),
                (f.indexLabelTextBlock.x = u),
                (f.indexLabelTextBlock.y = s);
          for (a = 0; a < m.length; a++)
            if (
              ((f = g[a]),
              (u = f.indexLabelTextBlock.measureText()),
              ...
              (u = u = 0),
                "right" === f.hemisphere
                  ? ((u =
                      p.x2 -
                      (f.indexLabelTextBlock.x +
                        f.indexLabelTextBlock.width +
                        n)),
                    (u *= -1))
                  : (u =
                      p.x1 -
                ...
                0 < u &&
                  (!q &&
                    ...
                    ((s =
                      "right" === f.hemisphere
                        ? p.x2 - f.indexLabelTextBlock.x
                        : f.indexLabelTextBlock.x - p.x1),
                    0.3 * f.indexLabelTextBlock.maxWidth > s
                      ? (f.indexLabelText = "")
                      : (f.indexLabelTextBlock.maxWidth = 0.85 * s),
                    0.3 * f.indexLabelTextBlock.maxWidth < s &&
                      (f.indexLabelTextBlock.x -=
                        "right" === f.hemisphere ? 2 : -2)),
                  Math.abs(
                    f.indexLabelTextBlock.y -
                      f.indexLabelTextBlock.height / 2 -
                      v.y
                  ) < B ||
                    Math.abs(
                      f.indexLabelTextBlock.y +
                  ...
                  ((u /= Math.abs(Math.cos(f.indexLabelAngle))),
                  9 < u && (u *= 0.3),
                  u > e && (e = u)),
                (u = u = 0),
                  ...
                  (!q &&
                    ...
                    ((s =
                      0 < f.indexLabelAngle && f.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === h(a, u * s) && h(a, 2 * s)),
                  Math.abs(f.indexLabelTextBlock.x - v.x) < B &&
                    ((u /= Math.abs(Math.sin(f.indexLabelAngle))),
                    9 < u && (u *= 0.3),
                    u > e && (e = u)));
          ...
          (function () {
            for (var a = -1, c = -1, e = 0, h = !1, f = 0; f < m.length; f++)
              if (((h = !1), (l = g[f]), l.indexLabelText)) {
                var q = d(f);
                if (null !== q) {
                  var k = g[q];
                  t = 0;
                  ...
                  p
                    ? (0 > a && (a = f),
                      q !== a && ((c = q), (e += -t)),
                      0 === f % Math.max(m.length / 10, 3) && (h = !0))
                    : (h = !0);
                  h &&
                    0 < e &&
                    0 <= a &&
      ...
      function f() {
        ...
        r.title &&
          (r.title.dockInsidePlotArea ||
            ("center" === r.title.horizontalAlign &&
              "center" === r.title.verticalAlign)) &&
          r.title.render();
        if (r.subtitles)
          for (var a = 0; a < r.subtitles.length; a++) {
            var b = r.subtitles[a];
        ...
        r.legend &&
          (r.legend.dockInsidePlotArea ||
            ("center" === r.legend.horizontalAlign &&
              "center" === r.legend.verticalAlign)) &&
          (r.legend.setLayout(), r.legend.render());
      }
      var r = this;
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 !== t) {
          ...
          this.pieDoughnutClickHandler = function (a) {
            r.isAnimating ||
              ...
              1 < this.dataPoints.length &&
                r._animator.animate(0, 500, function (a) {
                  c(a, !0);
                  f();
          ...
          this._animator.animate(
            ...
            function (a) {
              ...
              f();
              r.dispatchEvent("dataAnimationIterationEnd", { chart: r });
              1 <= a && r.dispatchEvent("dataAnimationEnd", { chart: r });
            },
            function () {
              r.disableToolTip = !1;
              r._animator.animate(0, r.animatedRender ? 500 : 0, function (a) {
                c(a, !1);
                f();
                r.dispatchEvent("dataAnimationIterationEnd", { chart: r });
              });
          ...
          k.radius = B;
          "doughnut" === k.type && (k.innerRadius = F);
        }
      }
    };
    var ra = function (a, e, c, b) {
      "undefined" === typeof c && (c = 1);
      0 >= Math.round(e.y4 - e.y1) ||
        (a.save(),
        (a.globalAlpha = c),
        a.beginPath(),
        a.moveTo(Math.round(e.x1), Math.round(e.y1)),
        a.lineTo(Math.round(e.x2), Math.round(e.y2)),
        a.lineTo(Math.round(e.x3), Math.round(e.y3)),
        a.lineTo(Math.round(e.x4), Math.round(e.y4)),
        "undefined" !== e.x5 &&
          (a.lineTo(Math.round(e.x5), Math.round(e.y5)),
          a.lineTo(Math.round(e.x6), Math.round(e.y6))),
        a.closePath(),
        (a.fillStyle = b ? b : e.color),
        a.fill(),
        (a.globalAplha = 1),
        a.restore());
    };
    x.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        e = S;
        g = U - N;
        d = Math.abs(((g - e) * (b - a + (d - c))) / 2);
        c = ba - T;
        e = g - e;
        g = c * (g - U);
        g = Math.abs(g);
        g = d + g;
        for (var d = [], h = 0, f = 0; f < z.length; f++) {
          if ("undefined" === typeof z[f].y) return -1;
          z[f].y = "number" === typeof z[f].y ? z[f].y : 0;
          h += Math.abs(z[f].y);
        }
        if (0 === h) return -1;
        for (
          var q = (d[0] = 0), k = 0, l, m, b = b - a, q = !1, f = 0;
          f < z.length;
          f++
        )
          (a = (Math.abs(z[f].y) * g) / h),
            q
              ? (l = 0 == Number(c.toFixed(3)) ? 0 : a / c)
              : ((m = ea * ea * b * b - 4 * Math.abs(ea) * a),
                0 > m
                  ? ((m = c),
                    (q = ((b + m) * (e - k)) / 2),
                    (a -= q),
        ...
        if (s && z) {
          for (
            ...
            (x = P[D]),
              ...
              (C[D] = Q - (isNaN(x) ? 0 : x) - V);
          x = 0.5 * V;
          for (var D = 0, J = z.length - 1; D < z.length || 0 <= J; D++, J--) {
            b = s.reversed ? z[J] : z[D];
            a = b.color
              ? b.color
              : s.reversed
            ...
            t = b.indexLabelTextAlign || s.indexLabelTextAlign || "left";
            e =
            ...
            d =
              ...
              (r ? "transparent" : null);
            h = l(b.indexLabelBorderThickness)
              ? s.indexLabelBorderThickness
              : b.indexLabelBorderThickness;
            f = l(b.indexLabelPadding)
              ? s.indexLabelPadding
                ? s.indexLabelPadding
                : ha
              : b.indexLabelPadding;
            k = b.indexLabelFontColor || s.indexLabelFontColor || "#979797";
            q = l(b.indexLabelFontSize)
              ? s.indexLabelFontSize
              : b.indexLabelFontSize;
            m = b.indexLabelFontStyle || s.indexLabelFontStyle || "normal";
            n = b.indexLabelFontFamily || s.indexLabelFontFamily || "arial";
            ...
            u =
              "number" === typeof b.indexLabelLineThickness
                ...
                : 2;
            v = b.indexLabelLineDashType || s.indexLabelLineDashType || "solid";
            w =
            ...
            A[D] =
              "inside" === s.indexLabelPlacement
                ? w
                  ? Math.max(P[D].height, q)
                  : 1.5 * q
                : !1;
            B = y.getPercentAndTotal(s, b);
            ...
            b = b.indexLabelFormatter
              ? b.indexLabelFormatter(G)
              : b.indexLabel
              ? y.replaceKeywordsWithValue(b.indexLabel, b, s, D)
              : s.indexLabelFormatter
              ? s.indexLabelFormatter(G)
              : s.indexLabel
              ? y.replaceKeywordsWithValue(s.indexLabel, b, s, D)
              : b.label
              ? b.label
              : "";
            0 >= u && (u = 0);
            1e3 > E && 1e3 - E < x && (E += 1e3 - E);
            l(s.options.indexLabelMaxWidth) &&
              (s.indexLabelMaxWidth = l(s.indexLabelMaxWidth)
                ? E
                : Math.max(E, s.indexLabelMaxWidth));
            O.roundRect || Aa(O);
            c = new la(O, {
              fontSize: q,
              fontFamily: n,
              ...
              borderThickness: h,
              maxWidth: E,
              maxHeight: !1 === A[D] ? (w ? 4.28571429 * q : 1.5 * q) : A[D],
              text: b,
              padding: f,
              textBaseline: "middle",
            });
      ...
      function d() {
        ...
        for (
          var h,
            f = Q - aa - V / 2,
            f = s.options.indexLabelMaxWidth
              ? s.indexLabelMaxWidth > f
                ? f
                : s.indexLabelMaxWidth
              : f,
            q = H.length - 1;
          ...
          c = H[q];
          e = c.textBlock;
          b = (a = p(q) < P.length ? H[p(q)] : null) ? a.textBlock : null;
          c = c.height;
          a && e.y + c + ha > b.y && (d = !0);
          c = h.indexLabelMaxWidth || f;
          if (c > f || 0 > c) c = f;
          g.push(c);
        }
        if (d)
          for (q = H.length - 1; 0 <= q; q--)
            (a = P[q]),
              (H[q].textBlock.maxWidth = g[g.length - (q + 1)]),
              H[q].textBlock.measureText(),
              (H[q].textBlock.height =
                H[q].textBlock.height === 2 * H[q].textBlock.padding
                  ? 0
                  : H[q].textBlock.height),
              (H[q].textBlock.width =
                H[q].textBlock.width === 2 * H[q].textBlock.padding
                  ? 0
                  : H[q].textBlock.width),
              (H[q].textBlock.x = Q - f),
              (c =
                H[q].textBlock.height < H[q].textBlock.maxHeight
                  ? H[q].textBlock.height
                  : H[q].textBlock.maxHeight),
              (d =
                H[q].textBlock.width < H[q].textBlock.maxWidth
                  ? H[q].textBlock.width
                  : H[q].textBlock.maxWidth),
              (H[q].height = c),
              (H[q].width = d),
              (c =
                "undefined" !== typeof a.x5
                  ? (a.y2 + a.y4) / 2
                  : (a.y2 + a.y3) / 2),
              (H[q].textBlock.y = c - H[q].height / 2),
              s.reversed
                ? (H[q].textBlock.y + H[q].height > W + t &&
                    (H[q].textBlock.y = W + t - H[q].height),
                  H[q].textBlock.y < sa - t && (H[q].textBlock.y = sa - t))
                : (H[q].textBlock.y < W - t && (H[q].textBlock.y = W - t),
                  H[q].textBlock.y + H[q].height > sa + t &&
                    (H[q].textBlock.y = sa + t - H[q].height));
      }
      function h() {
        var a, b, c, e;
          ...
          for (var d = 0; d < P.length; d++)
            0 == H[d].textBlock.text.length
              ...
              : ((a = P[d]),
                ...
                s.reversed
                  ? (H[d].textBlock.y + H[d].height > W + t &&
                      (H[d].textBlock.y = W + t - H[d].height),
                    H[d].textBlock.y < sa - t && (H[d].textBlock.y = sa - t))
                  : (H[d].textBlock.y < W - t && (H[d].textBlock.y = W - t),
                    H[d].textBlock.y + H[d].height > sa + t &&
                      (H[d].textBlock.y = sa + t - H[d].height)));
        else
      ...
      function f() {
        function a(b, c) {
          ...
          d = u(b, e);
          if (d >= c) return (g.y += c), c;
          if (b == P.length - 1) return 0 < d && (g.y += d), d;
          d += a(e, c - d);
          0 < d && (g.y += d);
          return d;
        }
        function b() {
          ...
          for (var f, k = 1; k < q; k++) {
            ...
            for (var m = H.length - 1; 0 <= m; m--)
              !H[m].isDirty &&
                ...
                ((f = p(m)),
                !(f >= H.length - 1) &&
                  H[m].textBlock.y + H[m].height + ha > H[f].textBlock.y &&
                  (H[m].textBlock.y =
                    H[m].textBlock.y + H[m].height - e > e - H[m].textBlock.y
                      ? e + 1
                      : e - H[m].height - 1));
          }
          for (f = P.length - 1; 0 < f; f--)
            if (!H[f].isDirty) {
              ...
              if (H[f].textBlock.y < H[e].textBlock.y + H[e].height) {
                d = d || f;
                g = f;
                for (
                  q = 0;
                  H[g].textBlock.y < H[e].textBlock.y + H[e].height + ha;
        ...
        for (var d, e, g, h, q, k, l = 1, m = 0; m < 2 * l; m++) {
          for (
            var s = H.length - 1;
            0 <= s &&
            !(0 <= n(s) && n(s),
            (g = H[s]),
            (h = g.textBlock),
            (k = (q = p(s) < P.length ? H[p(s)] : null) ? q.textBlock : null),
            (d = +g.height.toFixed(6)),
            (e = +h.y.toFixed(6)),
            !g.isDirty &&
              q &&
              e + d + ha > +k.y.toFixed(6) &&
              ((d = h.y + d + ha - k.y),
              (e = a(s, -d)),
              e < d && (0 < e && (d -= e), (e = a(p(s), d)), e != d)));
            s--
          );
          b();
        }
      ...
      function u(a, b) {
        return (
          (b < P.length ? H[b].textBlock.y : s.reversed ? W + t : sa + t) -
          (0 > a
            ? s.reversed
              ? sa - t
              : W - t
            : H[a].textBlock.y + H[a].height + ha)
        );
      }
      function E(a, b, c) {
        var d,
        ...
        if (0 === X.length) q = ja;
          ...
          e =
            (t *
              (1 != X.length || (0 != X[0] && X[0] != P.length - 1) ? 2 : 1)) /
            k();
          for (var n = 0; n < P.length; n++) {
            ...
            q.push(ja[n] + d);
            if (0 <= X.indexOf(n) || (n < P.length && 0 <= X.indexOf(n + 1)))
              d += e;
          }
        }
        g = (function () {
          for (var a = [], b = 0; b < P.length; b++) a.push(q[b] - P[b].y1);
          return a;
        })();
        var p = {
        ...
        a._animator.animate(
          ...
          function (c) {
            ...
            var e = {};
            e.dataSeries = s;
            e.dataPoint = s.reversed
              ? s.dataPoints[z.length - 1 - b]
              : s.dataPoints[b];
            e.index = s.reversed ? z.length - 1 - b : b;
            a.toolTip.highlightObjects([e]);
            for (e = 0; e < P.length; e++) ra(d, P[e], s.fillOpacity);
            w(d);
            L && ("inside" !== s.indexLabelPlacement ? m(d) : h(), x(d));
            1 <= c && (ka = !1);
          },
          null,
          R.easing.easeOutQuart
        );
      }
      function k() {
      ...
      function m(a) {
        for (var b, c, d, e, h = 0; h < P.length; h++)
          (e = 1 === H[h].lineThickness % 2 ? 0.5 : 0),
            (c = (((P[h].y2 + P[h].y4) / 2) << 0) + e),
            (b = g(c).x2 - 1),
            isNaN(b) &&
              Math.round(P[h].x1) === Math.round(P[h].x4) &&
              Math.round(P[h].x2) === Math.round(P[h].x3) &&
              (b = P[h].x2),
            (d = H[h].textBlock.x),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var s = this.data[a.dataSeriesIndexes[0]],
            ...
            B = 0,
            F = v.height - 2 * t - 4,
            K = Math.min(v.width - 2 * A, 2.8 * v.height),
            L = !1,
            M = 0;
          M < z.length;
          M++
          ...
          if (
            (!L &&
              "undefined" !== typeof z[M].indexLabel &&
              null !== z[M].indexLabel &&
              0 < z[M].indexLabel.toString().length &&
              (L = !0),
            !L &&
              "undefined" !== typeof z[M].label &&
              null !== z[M].label &&
              0 < z[M].label.toString().length &&
              (L = !0),
            (!L && "function" === typeof s.indexLabelFormatter) ||
              "function" === typeof z[M].indexLabelFormatter)
          )
            L = !0;
        L =
          L ||
        ...
        ("inside" !== s.indexLabelPlacement && L) ||
          (A = (v.width - 0.75 * K) / 2);
        var M = v.x1 + A,
          Q = v.x2 - A,
          S = v.y1 + t + 2,
        ...
        if (0 != s.length && s.dataPoints && s.visible && 0 !== z.length) {
          ...
          var V = (30 * (Q - a)) / 100;
          "funnel" === s.type
            ? ((N = l(s.options.neckHeight) ? 0.35 * F : s.neckHeight),
              (D = l(s.options.neckWidth) ? 0.25 * a : s.neckWidth),
              ...
              D > a ? (D = a - 0.5) : 0 >= D && (D = 0))
            : "pyramid" === s.type &&
              ((D = N = 0), (s.reversed = s.reversed ? !1 : !0));
          var A = M + a / 2,
            Y = M,
            aa = M + a,
            W = s.reversed ? U : S,
            T = A - D / 2,
            ba = A + D / 2,
            Ea = s.reversed ? S + N : U - N,
            sa = s.reversed ? S : U;
          D = s.valueRepresents = s.valueRepresents
            ? s.valueRepresents
            : "height";
          M = [];
          a = [];
          ...
          if (-1 !== K) {
            if (s.reversed)
              for (A.push($), D = K.length - 1; 0 < D; D--)
                ($ += K[D]), A.push(Math.round($));
            else
              for (D = 0; D < K.length; D++) ($ += K[D]), A.push(Math.round($));
            if (s.reversed)
              for (D = 0; D < K.length; D++)
                A[D] < Ea
                  ? (M.push(T), a.push(ba), (ga = D))
                  : (M.push((A[D] - W + ea * Y) / ea),
                    a.push((A[D] - W + ia * aa) / ia));
            else
              for (D = 0; D < K.length; D++)
                A[D] < Ea
                  ? (M.push((A[D] - W + ea * Y) / ea),
            ...
            for (D = 0; D < K.length - 1; D++)
              ($ = s.reversed
                ...
                s.dataPointEOs[D] &&
                  P[D] &&
                  (s.dataPointEOs[D].sectionsofFunnel = P[D]);
            var ha = 2,
              H = [],
              ka = !1,
              X = [],
            ...
            for (D = 0; D < z.length; D++)
              z[D].exploded &&
                ((M = !0), s.reversed ? X.push(z.length - 1 - D) : X.push(D));
            O.clearRect(v.x1, v.y1, v.width, v.height);
            O.fillStyle = y.backgroundColor;
            O.fillRect(v.x1, v.y1, v.width, v.height);
            if (
              L &&
              s.visible &&
              ...
              for (D = 0; D < P.length; D++)
                (P[D].x1 += B),
                  ...
                  (P[D].x3 += B),
                  (P[D].x4 += B),
                  P[D].x5 && ((P[D].x5 += B), (P[D].x6 += B)),
                  (H[D].textBlock.x += B);
            }
            for (D = 0; D < P.length; D++)
              (B = P[D]), ra(O, B, s.fillOpacity), ja.push(B.y1);
            w(O);
            L &&
              s.visible &&
              ("inside" === s.indexLabelPlacement || y.animationEnabled || m(O),
              y.animationEnabled || x());
            if (!L)
              for (D = 0; D < z.length; D++)
                (B = s.dataPointIds[D]),
                  (a = {
            ...
            !y.animationEnabled && M
              ? E(y, -1, 0)
              : y.animationEnabled && !y.animatedRender && E(y, -1, 0);
            this.funnelPyramidClickHandler = function (a) {
              var b = -1;
              if (
                !ka &&
                !y.isAnimating &&
                (l(a.dataSeries.explodeOnClick) ||
            ...
            return {
              ...
              animationCallback: function (a, b) {
                R.fadeInAnimation(a, b);
                1 <= a && (E(y, -1, 500), w(y.plotArea.ctx || y.ctx));
              },
              easingFunction: R.easing.easeInQuad,
              animationBase: 0,
            };
    ...
    x.prototype.cancelRequestAnimFrame =
    ...
    x.prototype.set = function (a, e, c) {
      ...
      "options" === a
        ? ((this.options = e), c && this.render())
        : x.base.set.call(this, a, e, c);
    };
    x.prototype.exportChart = function (a) {
      ...
      if (b && e && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (
            var q = b.replace(/^data:[a-z\/]*;base64,/, ""),
              q = atob(q),
              f = new ArrayBuffer(q.length),
              f = new Uint8Array(f),
              l = 0;
            l < q.length;
            l++
            ...
            f[l] = q.charCodeAt(l);
          e = new Blob([f.buffer], { type: "image/" + e });
          try {
            window.navigator.msSaveBlob(e, c), (d = !0);
          } catch (k) {
            (h.dataset.downloadurl = [a, h.download, h.href].join(":")),
              (h.href = window.URL.createObjectURL(e));
          }
        }
        if (!d)
          try {
    ...
    x.prototype.replaceKeywordsWithValue = function (a, e, c, b, d) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace("#percent", ia(q, l, h._cultureInfo));
          a = a.replace(
            "#total",
            ia(
              f,
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        try {
          var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
          g && 0 < g.length && ((q = Ia(g[2])), (a = Ia(g[1])));
        } catch (f) {}
        g = null;
        if ("color" === a)
          return "waterfall" === c.type
            ...
            ? c.color
              ? c.color
              : c._colorSet[q % c._colorSet.length]
            : e.color
            ? e.color
            : c.color
            ? c.color
            : c._colorSet[b % c._colorSet.length];
        if (e.hasOwnProperty(a)) g = e;
    ...
    U.prototype.setLayout = function () {
      var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
        ...
        f = (this.markerMargin =
          ...
          !l(this.chart.options.legend.markerMargin)
      ...
      for (var m = 0; m < this.dataSeries.length; m++) {
        ...
        if (n.dataPoints && n.dataPoints.length) {
          if (
            ...
            var p = (n.legendMarkerType = n.legendMarkerType
                ...
                ? "error" === n.type && n._linkedSeries
                  ? n._linkedSeries.legendMarkerType
                    ? n._linkedSeries.legendMarkerType
                    : Q.getDefaultLegendMarker(n._linkedSeries.type)
                  : Q.getDefaultLegendMarker(n.type)
                : n.markerType),
              g = n.legendText
                ? n.legendText
            ...
            g = n.legendText = this.chart.replaceKeywordsWithValue(
              g,
              n.dataPoints[0],
              n,
              m
            ...
            for (var x = 0; x < n.dataPoints.length; x++) {
              var v = n.dataPoints[x],
                p = v.legendMarkerType
                  ? v.legendMarkerType
                  : n.legendMarkerType
                  ? n.legendMarkerType
                  : Q.getDefaultLegendMarker(n.type),
                ...
                s = v.legendMarkerBorderThickness
                  ...
                  ? Math.max(1, Math.round(0.2 * w))
                  : 0,
                g = this.chart.replaceKeywordsWithValue(g, v, n, x),
                p = {
                  markerType: p,
                  markerColor: t,
                  text: g,
      ...
      if (0 < r.length) {
        ...
        v = (this.itemMaxWidth ? this.itemMaxWidth : v) - (w + f);
        for (m = 0; m < r.length; m++) {
          ...
          if (
            ...
            if ("horizontal" === this.orientation) {
              ...
              g = Math.max(
                g,
                p.textBlock.height ? p.textBlock.height : this.lineHeight
              );
                  ...
                  (p.textBlock.width =
                    ...
                    (w +
                      ...
                      "stepLine" === p.chartType
                        ? 2 * 0.1 * this.lineHeight
                        : 0))),
                this.height < q - this.lineHeight
                  ? ((n = { items: [], width: 0 }), k.push(n))
                  : ((n = k[x]), (x = (x + 1) % k.length)),
                n &&
      ...
      "top" === this.verticalAlign
        ...
        ? ((d =
            "left" === this.horizontalAlign
              ...
              ? e.x2 - this.width
              : e.x1 + e.width / 2 - this.width / 2),
          (b = e.y1 + e.height / 2 - this.height / 2))
        : "bottom" === this.verticalAlign &&
          ((d =
            "left" === this.horizontalAlign
              ? e.x1
    ...
    U.prototype.render = function () {
      ...
      for (var f = 0, l = 0; l < q.length; l++) {
        for (var k = q[l], m = 0, n = 0; n < k.items.length; n++) {
          var p = k.items[n],
            g =
              p.textBlock.x + a + (0 === n ? 0.2 * h : this.horizontalSpacing),
            r = e + f,
            w = g;
          ...
          if ("error" === p.chartType) {
            ...
            var y = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
              ...
              t = 0.7 * this.lineHeight,
              v = t + 0.02 * this.lineHeight;
            this.ctx.moveTo(y, s);
            this.ctx.lineTo(y + t, s);
            this.ctx.stroke();
            this.ctx.beginPath();
            this.ctx.moveTo(y + t / 2, s);
            this.ctx.lineTo(y + t / 2, s + v);
            this.ctx.stroke();
            this.ctx.beginPath();
            this.ctx.moveTo(y, s + v);
            this.ctx.lineTo(y + t, s + v);
            this.ctx.stroke();
          ...
          p.textBlock.y = Math.round(r + this.lineHeight / 2);
          ...
          this.ghostCtx.fillRect(
            ...
            p.textBlock.x + p.textBlock.width - w,
            p.textBlock.height ? p.textBlock.height : this.lineHeight
          );
    ...
    Q.prototype.getDataPointAtX = function (a, e, c) {
      ...
      for (;;) {
        ...
        if (0 <= q && q < this.dataPoints.length) {
          ...
          p < b.distance &&
            (l(c) || (c && !l(d.y))) &&
            ((b.dataPoint = d), (b.distance = p), (b.index = q));
          d = p;
          d <= r ? (r = d) : 0 < f ? k++ : m++;
      ...
      return e ||
        (b.dataPoint.x.getTime ? b.dataPoint.x.getTime() : b.dataPoint.x) !==
        ...
        if (0 <= h && h < this.dataPoints.length) {
          ...
          if (p) {
            switch (this.type) {
              ...
              case "splineArea":
              case "scatter":
                var w = ka("markerSize", g, this) || 4,
                  y = c ? 20 : w,
                  t = Math.sqrt(Math.pow(p.x1 - a, 2) + Math.pow(p.y1 - e, 2));
                t <= y &&
                  b.push({
                    dataPoint: g,
                    dataPointIndex: h,
              ...
              case "rangeSplineArea":
                ...
                y = c ? 20 : w;
                t = Math.min(
                  Math.sqrt(Math.pow(p.x1 - a, 2) + Math.pow(p.y1 - e, 2)),
                  Math.sqrt(Math.pow(p.x1 - a, 2) + Math.pow(p.y2 - e, 2))
                );
                t <= y &&
                  b.push({
                    dataPoint: g,
              ...
              case "pyramid":
                ...
                e > t.y1 &&
                  ...
                  (t.y6
                    ? e > t.y6
                      ? ((h =
                          t.x6 + ((t.x5 - t.x6) / (t.y5 - t.y6)) * (e - t.y6)),
                        (t =
                          t.x3 + ((t.x4 - t.x3) / (t.y4 - t.y3)) * (e - t.y3)))
                      : ((h =
                          t.x1 + ((t.x6 - t.x1) / (t.y6 - t.y1)) * (e - t.y1)),
                        (t =
                          t.x2 + ((t.x3 - t.x2) / (t.y3 - t.y2)) * (e - t.y2)))
                    : ((h =
                        t.x1 + ((t.x4 - t.x1) / (t.y4 - t.y1)) * (e - t.y1)),
                      (t =
                        t.x2 + ((t.x3 - t.x2) / (t.y3 - t.y2)) * (e - t.y2))),
                  a > h &&
                    a < t &&
    ...
    Q.prototype.getMarkerProperties = function (a, e, c, b) {
      var d = this.dataPoints,
        ...
        q = d[a].markerBorderColor
          ? d[a].markerBorderColor
          : this.markerBorderColor
          ? this.markerBorderColor
          : null,
        f = l(d[a].markerBorderThickness)
          ? this.markerBorderThickness
            ? this.markerBorderThickness
            : null
          : d[a].markerBorderThickness,
        r = d[a].markerType ? d[a].markerType : this.markerType;
    ...
    B.prototype.createLabels = function () {
            ...
            if (((c = this.logLabelValues[b]), c < this.viewportMinimum)) b++;
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[m]
                  : ia(m, this.valueFormatString, this.chart._cultureInfo)),
                (a = new la(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: h,
                      ...
                      if (!l(this.options.labelMaxWidth))
                        ...
                        if (
                          ...
                          b - 2 * h > n &&
                            ...
                            b >= 2 * h && b < 2.2 * h
                              ? ((this.sessionVariables.labelMaxWidth = h),
                                l(this.options.labelFontSize) &&
                                  12 < g &&
                                  ((g = Math.floor((12 / 13) * g)),
                                  a.measureText()),
                                (this.sessionVariables.labelFontSize = l(
            ...
            for (c = 0; c < this._labels.length; c++)
              (a = this._labels[c].textBlock),
                ...
                (a.angle = this.labelAngle =
                  l(this.options.labelAngle)
                    ? l(this.sessionVariables.labelAngle)
                      ? (this.sessionVariables.labelAngle = this.labelAngle)
                      : this.sessionVariables.labelAngle
                    : this.labelAngle),
                (a.wrap = this.labelWrap =
                  l(this.options.labelWrap)
                    ? l(this.sessionVariables.labelWrap)
                      ? (this.sessionVariables.labelWrap = this.labelWrap)
                      : this.sessionVariables.labelWrap
                    : this.options.labelWrap),
                (a.maxHeight = l(this.sessionVariables.labelMaxHeight)
                  ? (this.sessionVariables.labelMaxHeight = q)
                  : this.sessionVariables.labelMaxHeight),
                a.measureText();
        else if ("left" === this._position || "right" === this._position)
          if (
            ((h = l(this.options.labelMaxWidth)
              ? (0.3 * this.chart.width) >> 0
              : this.options.labelMaxWidth),
            (q =
              "undefined" === typeof this.options.labelWrap || this.labelWrap
            ...
            this.sessionVariables.labelMaxWidth = h;
            this.sessionVariables.labelMaxHeight = q;
            this.sessionVariables.labelAngle = l(
              this.sessionVariables.labelAngle
            )
              ? 0
              : this.sessionVariables.labelAngle;
      ...
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        if ("outside" === h.labelPlacement) {
          ...
          if ("bottom" === this._position || "top" === this._position)
            l(h.options.labelWrap) &&
            !l(this.sessionVariables.stripLineLabelMaxHeight)
              ? (y = this.sessionVariables.stripLineLabelMaxHeight)
              : (this.sessionVariables.stripLineLabelMaxHeight = y =
                  h.labelWrap
                    ? (0.8 * this.chart.height) >> 0
                    : 1.5 * this.labelFontSize);
          ...
          (q =
            ...
            (y =
              l(h.options.labelWrap) || h.labelWrap
                ? "bottom" === this._position || "top" === this._position
                  ? (0.8 * this.chart.width) >> 0
                  : (0.8 * this.chart.height) >> 0
                : 1.5 * this.labelFontSize),
            l(h.labelBackgroundColor) &&
              (l(h.startValue) && 0 !== h.startValue
                ? (h.labelBackgroundColor = r ? "transparent" : null)
                : (h.labelBackgroundColor = "#EEEEEE"));
        h.labelFontSize =
          "outside" === h.labelPlacement && l(h.options.labelFontSize)
            ? this.labelFontSize
            : h.labelFontSize;
        h.labelFontFamily =
          "outside" === h.labelPlacement && l(h.options.labelFontFamily)
            ? this.labelFontFamily
            : h.labelFontFamily;
        h.labelFontWeight =
          "outside" === h.labelPlacement && l(h.options.labelFontWeight)
            ? this.labelFontWeight
            : h.labelFontWeight;
        h.labelFontStyle =
          "outside" === h.labelPlacement && l(h.options.labelFontStyle)
            ? this.labelFontStyle
            : h.labelFontStyle;
        a = new la(this.ctx, {
          x: 0,
    ...
    B.prototype.createLabelsAndCalculateWidth = function () {
      ...
      if ("left" === this._position || "right" === this._position) {
        ...
        for (e = 0; e < this._stripLineLabels.length; e++)
          "outside" === this._stripLineLabels[e].stripLine.labelPlacement &&
            this._stripLineLabels[e].stripLine.value >= this.viewportMinimum &&
            this._stripLineLabels[e].stripLine.value <= this.viewportMaximum &&
            ((b = this._stripLineLabels[e].textBlock),
            (b = b.measureText()),
            (d =
              0 === this.labelAngle
                ? b.width
            ...
            "inside" === this.labelPlacement && (a += 0 < this._index ? d : 0),
            a < d && (a = d),
      ...
      if ("bottom" === this._position || "top" === this._position) {
        ...
        for (c = 0; c < this._stripLineLabels.length; c++)
          "outside" === this._stripLineLabels[c].stripLine.labelPlacement &&
            ...
            ((e = this._stripLineLabels[c].textBlock),
            (e = e.measureText()),
            (d =
              0 === this.labelAngle
                ? e.height
    ...
    B.setLayout = function (a, e, c, b, d, h) {
      ...
      if (e && 0 < e.length)
        for (g = 0; g < e.length; g++) e[g].calculateAxisParameters();
      if (c && 0 < c.length)
      ...
      for (g = 0; g < p.length; g++)
        if (p[g] && p[g].scaleBreaks && p[g].scaleBreaks._appliedBreaks.length)
          for (
            var t = p[g].scaleBreaks._appliedBreaks, w = 0;
            w < t.length && !(t[w].startValue > p[g].viewportMaximum);
            w++
          )
            t[w].endValue < p[g].viewportMinimum ||
              (l(p[g].scaleBreaks.firstBreakIndex) &&
                (p[g].scaleBreaks.firstBreakIndex = w),
              t[w].startValue >= p[g].viewPortMinimum &&
                (p[g].scaleBreaks.lastBreakIndex = w));
      for (
        var x = (w = 0),
          s = 0,
          z = 0,
        ...
        p[g] &&
          p[g].title &&
          (p[g]._titleTextBlock = new la(p[g].ctx, {
            text: p[g].title,
        ...
        if (p[g].title)
          switch (p[g]._position) {
            ...
            case "right":
              ...
              break;
            default:
              (p[g]._titleTextBlock.maxWidth = p[g].titleMaxWidth || h.width),
                (p[g]._titleTextBlock.maxHeight = p[g].titleWrap
                  ? 0.8 * h.height
                  : 1.5 * p[g].titleFontSize),
      ...
      if ("normal" === d) {
        for (
          ...
          if (c && 0 < c.length)
            for (A = [], g = P = 0; g < c.length; g++)
              A.push(
                ...
                (P += A[g]),
                (T += c[g] && !m.isNavigator ? c[g].margin : 0);
          else
          ...
          Q.push(B);
          f = Math.round(h.x1 + P + T);
          r = Math.round(
            h.x2 - ba - aa > m.width - n ? m.width - n : h.x2 - ba - aa
          );
          if (a && 0 < a.length)
            for (z = [], g = X = 0; g < a.length; g++)
          ...
          R.push(z);
          if (e && 0 < e.length)
            for (v = [], g = $ = 0; g < e.length; g++)
              e[g] && (e[g].lineCoordinates = {}),
                (e[g].lineCoordinates.width = Math.abs(r - f)),
                e[g].title &&
                  (e[g]._titleTextBlock.maxWidth =
                    0 < e[g].titleMaxWidth &&
                    e[g].titleMaxWidth < e[g].lineCoordinates.width
                      ? e[g].titleMaxWidth
                      : e[g].lineCoordinates.width),
                v.push(
                  Math.ceil(e[g] ? e[g].createLabelsAndCalculateHeight() : 0)
                ),
                ($ += v[g]),
                (Y += e[g] && !m.isNavigator ? e[g].margin : 0);
          else
            v.push(Math.ceil(e[0] ? e[0].createLabelsAndCalculateHeight() : 0));
          S.push(v);
          if (a && 0 < a.length)
              ...
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (x =
                    ...
                    (k.textBlock.height - u.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                  (s =
                    u.textBlock.width *
                      Math.cos((Math.PI / 180) * Math.abs(u.textBlock.angle)) +
                    (u.textBlock.height - u.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(u.textBlock.angle)))),
                !a[g] ||
                  !a[g].labelAutoFit ||
                  l(F) ||
                  l(I) ||
                  ...
                  0 < a[g].labelAngle
                    ? I + s > r &&
                      a[g].convertPixelToValue(I) >= a[g].viewportMinimum &&
                      a[g].convertPixelToValue(I) <= a[g].viewportMaximum &&
                      (u += 0 < a[g].labelAngle ? I + s - r - ba : 0)
                    : 0 > a[g].labelAngle
                    ? F - x < f &&
                      F - x < a[g].viewportMinimum &&
                      (K =
                        f -
                        (T +
                          a[g].tickLength +
                ...
                m.panEnabled
                  ? (X =
                      l(m.sessionVariables.axisX.height) || m.stockChart
                        ? (m.sessionVariables.axisX.height = X)
                        : m.sessionVariables.axisX.height)
                  : (m.sessionVariables.axisX.height = X),
                (u = Math.round(h.y2 - X - d + D)),
                (k = Math.round(h.y2)),
          ...
          if (e && 0 < e.length)
            for (g = 0; g < e.length; g++)
              (e[g].lineCoordinates.x1 = Math.round(h.x1 + P + T)),
                (e[g].lineCoordinates.x2 = r
                  ? r
                  : Math.round(
                      h.x2 - ba - aa > m.width - n
                        ? m.width - n
                        : h.x2 - ba - aa
                    )),
                (e[g].lineCoordinates.width = Math.abs(r - f)),
                e[g]._labels &&
                  1 < e[g]._labels.length &&
                  ((k = e[g]._labels[1]),
                  (u =
                    "dateTime" === e[g].valueType
                      ? e[g]._labels[e[g]._labels.length - 2]
                      : e[g]._labels[e[g]._labels.length - 1]),
                  (x =
                    k.textBlock.width *
                      Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) +
                    (k.textBlock.height - u.textBlock.fontSize / 2) *
                ...
                m.panEnabled
                  ? ($ =
                      l(m.sessionVariables.axisX2.height) || m.stockChart
                        ? (m.sessionVariables.axisX2.height = $)
                        : m.sessionVariables.axisX2.height)
                  : (m.sessionVariables.axisX2.height = $),
                (u = Math.round(h.y1)),
                (k = e[g].lineCoordinates.y1 = u + $ + Y - U),
                (e[g].lineCoordinates.y2 = u),
                "inside" === e[g].labelPlacement &&
                  0 < g &&
                  (e[g].lineCoordinates.y1 =
                    e[0].lineCoordinates.y1 -
                    U -
                    (e[g].labelEffectiveHeight || 0) -
                    5),
                "inside" === e[g].tickPlacement &&
                  0 < g &&
                  (e[g].lineCoordinates.y1 -= e[g].tickLength),
                (e[g].bounds = {
                  x1: f,
                  y1:
                    u +
                ...
                (e[g].bounds.height = e[g].bounds.y2 - e[g].bounds.y1),
                (U +=
                  ("inside" === e[g].labelPlacement && 0 === g
                    ? v[g] - 5
                    : v[g]) + e[g].margin);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (T = m.isNavigator ? 0 : 10),
                c[g] &&
                  ((f = Math.round(
                    a[0] ? a[0].lineCoordinates.x1 : e[0].lineCoordinates.x1
                  )),
                  (T =
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              b[g] &&
                ((f = Math.round(
                  a[0] ? a[0].lineCoordinates.x2 : e[0].lineCoordinates.x2
                )),
                (r = Math.round(f)),
                (T =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (u = Math.round(
                  h.y1 + $ + Y < Math.max(T, n) ? Math.max(T, n) : h.y1 + $ + Y
                )),
                (T =
                  0 < a.length
                    ? 0
              ...
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (I = a[g].logarithmic
                    ...
                    : (0 < f
                        ? f * Math.abs(a[g].conversionParameters.pixelPerUnit)
                        : 0) + a[g].lineCoordinates.x1)));
          if (e && 0 < e.length)
            for (g = 0; g < e.length; g++)
              e[g].calculateValueToPixelConversionParameters(),
                ...
                e[g]._labels &&
                  ...
                  ((F =
                    (e[g].logarithmic
                      ? Math.log(
                          e[g]._labels[1].position / e[g].viewportMinimum
                        ) / e[g].conversionParameters.lnLogarithmBase
                      : e[g]._labels[1].position - e[g].viewportMinimum) *
                      Math.abs(e[g].conversionParameters.pixelPerUnit) +
                    e[g].lineCoordinates.x1),
                  (f =
                    e[g]._labels[
                      e[g]._labels.length -
                        ("dateTime" === e[g].valueType ? 2 : 1)
                    ].position),
                  (f = e[g].getApparentDifference(e[g].viewportMinimum, f)),
                  (I = e[g].logarithmic
                    ? (1 < f
                        ? (Math.log(f) /
                            e[g].conversionParameters.lnLogarithmBase) *
                          Math.abs(e[g].conversionParameters.pixelPerUnit)
                        : 0) + e[g].lineCoordinates.x1
                    : (0 < f
                        ? f * Math.abs(e[g].conversionParameters.pixelPerUnit)
                        : 0) + e[g].lineCoordinates.x1));
          for (g = 0; g < p.length; g++)
            "axisY" === p[g].type &&
        ...
        if (e && 0 < e.length)
          for (g = 0; g < e.length; g++)
            e[g].calculateStripLinesThicknessInValues(),
        ...
        R = [];
        for (S = []; 4 > w; ) {
          X = W = V = aa = T = Y = d = Q = O = D = $ = 0;
          if (a && 0 < a.length)
            for (K = [], g = W = 0; g < a.length; g++)
              K.push(
            ...
            K.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          R.push(K);
          if (e && 0 < e.length)
            for (x = [], g = X = 0; g < e.length; g++)
              x.push(
                Math.ceil(e[g] ? e[g].createLabelsAndCalculateWidth() : 0)
              ),
                (X += x[g]),
                (Y += e[g] ? e[g].margin : 0);
          else
            x.push(Math.ceil(e[0] ? e[0].createLabelsAndCalculateWidth() : 0));
          S.push(x);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                (f = Math.round(h.x1 + W + d)),
                (r = Math.round(
                  h.x2 - X - Y > m.width - 10 ? m.width - 10 : h.x2 - X - Y
                )),
                c[g].labelAutoFit &&
                  !l(z) &&
                  (0 < !a.length &&
          ...
          if (b && 0 < b.length)
            ...
            F.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
          s.push(F);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
          ...
          if (m.panEnabled)
            for (g = 0; g < c.length; g++)
              n[g] = l(m.sessionVariables.axisY[g].height)
                ? (m.sessionVariables.axisY[g].height = n[g])
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (u = Math.round(h.y2)),
                (k = Math.round(
                  h.y2 > c[g].chart.height ? c[g].chart.height : h.y2
                )),
                (c[g].lineCoordinates.y1 = u - (n[g] + c[g].margin + $)),
                (c[g].lineCoordinates.y2 = u - (n[g] + c[g].margin + $)),
                "inside" === c[g].labelPlacement &&
                  0 < g &&
          ...
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((u = Math.round(h.y1)),
                (k = Math.round(h.y1 + (F[g] + b[g].margin + D))),
            ...
            for (g = 0; g < a.length; g++) {
              ...
              u =
                b && 0 < b.length
                  ...
                  ? Math.max(T, 10)
                  : h.y1;
              r = Math.round(h.x1 + W + d);
              k =
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ? c[0].lineCoordinates.y1
                        : h.y2 - V > m.height - Math.max(T, 10)
                        ? m.height - Math.max(T, 10)
                        : h.y2 - V
                    )
                  : h.y2 > m.height - Math.max(T, 10)
                  ? m.height - Math.max(T, 10)
                  : h.y2;
              if (c && 0 < c.length)
              ...
              if (b && 0 < b.length)
                for (T = 0; T < b.length; T++)
                  b[T] &&
                    b[T].labelAutoFit &&
                    ((r = b[T].lineCoordinates.x1), (f = r - W));
              a[g].lineCoordinates = {
                x1: r - O,
                y1: u,
                x2: r - O,
          ...
          if (e && 0 < e.length)
            for (g = 0; g < e.length; g++) {
              T =
                e[g]._labels && 0 < e[g]._labels.length
                  ? e[g]._labels[0].textBlock.fontSize / 2
                  : 0;
              f = Math.round(h.x1 - d);
              u =
                b && 0 < b.length
              ...
              if (b && 0 < b.length)
                for (T = 0; T < b.length; T++)
                  b[T] &&
                    b[T].labelAutoFit &&
                    ((r = b[T].lineCoordinates.x2), (f = r - X));
              e[g].lineCoordinates = {
                x1: r + Q,
                y1: u,
                x2: r + Q,
              ...
              "inside" === e[g].labelPlacement &&
                ...
                ((e[g].lineCoordinates.x1 =
                  e[g].lineCoordinates.x1 +
                  (x[g] -
                    (e[g]._titleTextBlock ? e[g]._titleTextBlock.height : 0) -
                    2) -
                  e[g].tickLength -
                  (e[g].stripLineLabelEffectiveWidth || 0)),
                (e[g].lineCoordinates.x2 =
                  e[g].lineCoordinates.x1 + e[g].lineThickness / 2));
              "inside" === e[g].tickPlacement &&
                0 < g &&
                ((e[g].lineCoordinates.x1 += e[g].tickLength),
                (e[g].lineCoordinates.x2 =
                  e[g].lineCoordinates.x1 + e[g].lineThickness / 2));
              e[g].bounds = {
              ...
              e[g].title &&
                (e[g]._titleTextBlock.maxWidth =
                  0 < e[g].titleMaxWidth &&
                  e[g].titleMaxWidth < e[g].lineCoordinates.height
                    ? e[g].titleMaxWidth
                    : e[g].lineCoordinates.height);
              e[g].calculateValueToPixelConversionParameters();
              e[g].calculateBreaksSizeInValues();
              Q += x[g] + e[g].margin;
            }
    ...
    B.render = function (a, e, c, b, d) {
      ...
      h.clip();
      if (a && 0 < a.length)
        for (var f = 0; f < a.length; f++) a[f].renderLabelsTicksAndTitle();
      if (e && 0 < e.length)
        for (f = 0; f < e.length; f++) e[f].renderLabelsTicksAndTitle();
      h.restore();
      if (c && 0 < c.length)
        for (f = 0; f < c.length; f++) c[f].renderLabelsTicksAndTitle();
      if (b && 0 < b.length)
        for (f = 0; f < b.length; f++) b[f].renderLabelsTicksAndTitle();
      d.preparePlotArea();
      f = d.plotArea;
      h.save();
      h.beginPath();
      ...
      if (a && 0 < a.length)
        for (f = 0; f < a.length; f++)
          a[f].renderStripLinesOfThicknessType("value");
      if (e && 0 < e.length)
        for (f = 0; f < e.length; f++)
          e[f].renderStripLinesOfThicknessType("value");
      if (c && 0 < c.length)
        for (f = 0; f < c.length; f++)
          c[f].renderStripLinesOfThicknessType("value");
      if (b && 0 < b.length)
        for (f = 0; f < b.length; f++)
          b[f].renderStripLinesOfThicknessType("value");
      if (a && 0 < a.length)
        for (f = 0; f < a.length; f++) a[f].renderInterlacedColors();
      if (e && 0 < e.length)
        for (f = 0; f < e.length; f++) e[f].renderInterlacedColors();
      if (c && 0 < c.length)
        for (f = 0; f < c.length; f++) c[f].renderInterlacedColors();
      if (b && 0 < b.length)
        for (f = 0; f < b.length; f++) b[f].renderInterlacedColors();
      h.restore();
      if (a && 0 < a.length)
        for (f = 0; f < a.length; f++)
          a[f].renderGrid(),
      ...
      if (e && 0 < e.length)
        for (f = 0; f < e.length; f++)
          e[f].renderGrid(),
            r && (e[f].createMask(), e[f].renderBreaksBackground());
      if (c && 0 < c.length)
        for (f = 0; f < c.length; f++)
          c[f].renderGrid(),
            r && (c[f].createMask(), c[f].renderBreaksBackground());
      if (b && 0 < b.length)
        for (f = 0; f < b.length; f++)
          b[f].renderGrid(),
            r && (b[f].createMask(), b[f].renderBreaksBackground());
      if (a && 0 < a.length)
        for (f = 0; f < a.length; f++) a[f].renderAxisLine();
      if (e && 0 < e.length)
        for (f = 0; f < e.length; f++) e[f].renderAxisLine();
      if (c && 0 < c.length)
        for (f = 0; f < c.length; f++) c[f].renderAxisLine();
      if (b && 0 < b.length)
        for (f = 0; f < b.length; f++) b[f].renderAxisLine();
      h = !1;
      if (a && 0 < a.length)
        for (f = 0; f < a.length; f++)
          a[f].renderStripLinesOfThicknessType("pixel"),
            a[f].crosshair &&
              a[f].crosshair.enabled &&
              ((h = !0), (d.clearedOverlayedCanvas = a[f].type));
      if (e && 0 < e.length)
        for (f = 0; f < e.length; f++)
          e[f].renderStripLinesOfThicknessType("pixel"),
            e[f].crosshair &&
              e[f].crosshair.enabled &&
              ((h = !0), (d.clearedOverlayedCanvas = e[f].type));
      if (c && 0 < c.length)
        for (f = 0; f < c.length; f++)
          c[f].renderStripLinesOfThicknessType("pixel"),
            c[f].crosshair &&
              c[f].crosshair.enabled &&
              ((h = !0), (d.clearedOverlayedCanvas = c[f].type));
      if (b && 0 < b.length)
        for (f = 0; f < b.length; f++)
          b[f].renderStripLinesOfThicknessType("pixel"),
            b[f].crosshair &&
              b[f].crosshair.enabled &&
              ((h = !0), (d.clearedOverlayedCanvas = b[f].type));
      if (
        h ||
        (!h &&
          d.clearedOverlayedCanvas &&
          0 <= d.clearedOverlayedCanvas.indexOf("axis"))
      )
        d.resetOverlayedCanvas(),
          d.renderCrosshairs(
            null,
            l(d.sessionVariables.crosshairShownByPixel) ||
              d.sessionVariables.crosshairShownByPixel
              ? !0
              : d.sessionVariables.crosshairShownByPixel
          );
    };
      ...
      for (var a = 0; a < this.stripLines.length; a++)
        if (
          ...
          this.stripLines[a].value = this.convertPixelToValue(
            (this.convertValueToPixel(e) + this.convertValueToPixel(c)) / 2
          );
    ...
    B.prototype.calculateBreaksSizeInValues = function () {
      for (
        ...
        (d = b || !l(e[h].options.spacing)),
          (e[h].spacing =
            Va(e[h].spacing, a, 8, d ? 0.1 * a : 8, d ? 0 : 3) << 0),
          (e[h].size = 0 > e[h].spacing ? 0 : Math.abs(e[h].spacing / c)),
          this.logarithmic &&
            (e[h].size = Math.pow(this.logarithmBase, e[h].size));
    };
    B.prototype.calculateBreaksInPixels = function () {
      if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
        ...
        for (
          var e = 0;
          e < a.length &&
          !(a[e].startValue > this.conversionParameters.maximum);
          e++
        )
          a[e].endValue < this.conversionParameters.minimum ||
            (l(this.scaleBreaks.firstBreakIndex) &&
              (this.scaleBreaks.firstBreakIndex = e),
            a[e].startValue >= this.conversionParameters.minimum &&
              ((a[e].startPixel = this.convertValueToPixel(a[e].startValue)),
              (this.scaleBreaks.lastBreakIndex = e)),
            a[e].endValue <= this.conversionParameters.maximum &&
              (a[e].endPixel = this.convertValueToPixel(a[e].endValue)));
      }
    };
      ...
      if ("undefined" === typeof this.options.interval) {
        if ("bottom" === this._position || "top" === this._position)
          if (
            ...
            for (
              var c = [],
                d = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2,
                f,
                l = this.viewportMaximum,
                r = this.lineCoordinates.width / Math.log(this.range),
                ...
                n.position < this.viewportMinimum ||
                  ((f =
                    ...
                    n.textBlock.height *
                      Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))),
                  (c += f));
            c > this.lineCoordinates.width * d && this.labelAutoFit && (e = !0);
          }
        if ("left" === this._position || "right" === this._position)
          if (
            this.logarithmic &&
            ...
            for (
              var c = [],
                m,
                l = this.viewportMaximum,
                r = this.lineCoordinates.height / Math.log(this.range),
                k = this._labels.length - 1;
              0 <= k;
              k--
            ) {
                ...
                n.position < this.viewportMinimum ||
                  ((m =
                    ...
                    n.textBlock.width *
                      Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))),
                  (b += m));
            b > this.lineCoordinates.height * d &&
              this.labelAutoFit &&
              (e = !0);
          }
      }
              ...
              for (k = 0; k < a._labels.length; k++)
                if (
                  ...
                  !(
                    ...
                    ((p = a.getPixelCoordinatesOnAxis(n.position)),
                    a.tickThickness))
                ) {
    ...
    B.prototype.renderInterlacedColors = function () {
      ...
      if (
        ...
        for (
          a.fillStyle = this.interlacedColor, d = 0;
          d < this._labels.length;
          d++
        )
          e
            ? ((e = this.getPixelCoordinatesOnAxis(this._labels[d].position)),
              (c =
                d + 1 > this._labels.length - 1
                  ? this.getPixelCoordinatesOnAxis(this.viewportMaximum)
                  : this.getPixelCoordinatesOnAxis(
                      this._labels[d + 1].position
                    )),
              a.fillRect(
                Math.min(c.x, e.x),
                b.y1,
        ...
        for (
          ...
          e
            ? ((c = this.getPixelCoordinatesOnAxis(this._labels[d].position)),
              (e =
                d + 1 > this._labels.length - 1
                  ? this.getPixelCoordinatesOnAxis(this.viewportMaximum)
                  : this.getPixelCoordinatesOnAxis(
            ...
            if (
              ...
              n._thicknessType === a &&
                ...
                "bottom" === this._position
                  ? ((c.textBlock.maxWidth = this.options.stripLines[d]
                      .labelMaxWidth
                      ? this.options.stripLines[d].labelMaxWidth
      ...
      if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
        ...
        for (var e = 0; e < a.length; e++)
          a[e].endValue < this.viewportMinimum ||
            a[e].startValue > this.viewportMaximum ||
            isNaN(this.range) ||
            a[e].render(this.maskCtx);
        ...
        if ("bottom" === this._position || "top" === this._position)
          for (b = 0; b < this._labels.length; b++)
            this._labels[b].position < this.viewportMinimum ||
              ...
              (a.beginPath(),
              (e = this.getPixelCoordinatesOnAxis(this._labels[b].position)),
              (e = 1 === a.lineWidth % 2 ? (e.x << 0) + 0.5 : e.x << 0),
              a.moveTo(e, c.y1 << 0),
              a.lineTo(e, c.y2 << 0),
              a.stroke());
        else if ("left" === this._position || "right" === this._position)
          for (var b = 0; b < this._labels.length; b++)
            this._labels[b].position < this.viewportMinimum ||
              ...
              (a.beginPath(),
              (e = this.getPixelCoordinatesOnAxis(this._labels[b].position)),
              (e = 1 === a.lineWidth % 2 ? (e.y << 0) + 0.5 : e.y << 0),
              a.moveTo(c.x1 << 0, e),
              a.lineTo(c.x2 << 0, e),
              a.stroke());
        a.restore();
    ...
    B.prototype.renderAxisLine = function () {
      var a = this.chart.ctx,
        e = r ? this.chart._preRenderCtx : a,
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          this.reversed
            ? ((d = this.lineCoordinates.x2), (h = this.lineCoordinates.x1))
            : ((d = this.lineCoordinates.x1), (h = this.lineCoordinates.x2));
          e.lineWidth = this.lineThickness;
          e.strokeStyle = this.lineColor ? this.lineColor : "black";
          e.setLineDash &&
            e.setLineDash(I(this.lineDashType, this.lineThickness));
          var f =
          ...
          if (this.scaleBreaks && !l(this.scaleBreaks.firstBreakIndex))
            if (l(this.scaleBreaks.lastBreakIndex))
              ...
              for (
                var u = this.scaleBreaks.firstBreakIndex;
                u <= this.scaleBreaks.lastBreakIndex;
                u++
              )
                e.moveTo(d, f),
                  e.lineTo(
                    this.scaleBreaks._appliedBreaks[u].startPixel + c,
                    f
                  ),
                  (d = this.scaleBreaks._appliedBreaks[u].endPixel + b);
          d && (e.moveTo(d, f), e.lineTo(h, f));
          e.stroke();
        }
      } else if (
        ("left" === this._position || "right" === this._position) &&
        ...
        this.reversed
          ? ((d = this.lineCoordinates.y1), (h = this.lineCoordinates.y2))
          : ((d = this.lineCoordinates.y2), (h = this.lineCoordinates.y1));
        e.lineWidth = this.lineThickness;
        ...
        if (this.scaleBreaks && !l(this.scaleBreaks.firstBreakIndex))
          if (l(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              ...
              e.moveTo(f, d),
                e.lineTo(f, this.scaleBreaks._appliedBreaks[u].startPixel + b),
                (d = this.scaleBreaks._appliedBreaks[u].endPixel + c);
        d && (e.moveTo(f, d), e.lineTo(f, h));
        e.stroke();
      }
      r &&
        (a.drawImage(
              ...
              if (e)
                if (d[c].startValue < this.conversionParameters.minimum) {
                  if (
                    ...
                    this.conversionParameters.minimum *
                      Math.pow(
                        d[c].endValue / d[c].startValue,
                        Math.log(b) / Math.log(d[c].size)
                      ) <
                      d[c].endValue
                  ) {
                    a = Math.pow(
                    ...
                    (a *=
                      ...
                      Math.pow(
                        d[c].size,
                        Math.log(
                          d[c].endValue / this.conversionParameters.minimum
                        ) / Math.log(d[c].endValue / d[c].startValue)
                      )),
                      (b /= Math.pow(
                        d[c].size,
                        Math.log(
                  ...
                  b >
                  d[c].startValue / this.conversionParameters.minimum
                ) {
                  ...
                  if (b < d[c].size) {
                    a *=
                      Math.pow(
                        d[c].endValue / d[c].startValue,
                        1 === d[c].size ? 1 : Math.log(b) / Math.log(d[c].size)
                      ) / b;
                    break;
                  ...
                  if (
                    ...
                    (a *=
                      ...
                      (b *= Math.pow(
                        d[c].size,
                        Math.log(
                          this.conversionParameters.minimum / d[c].startValue
                        ) / Math.log(d[c].endValue / d[c].startValue)
                      ));
                  e = !1;
                } else if (
              ...
              if (e)
                if (d[c].startValue < this.conversionParameters.minimum) {
                  if (
                    d[c].size &&
                    this.conversionParameters.minimum +
                      (b * (d[c].endValue - d[c].startValue)) / d[c].size <
                      d[c].endValue
                  ) {
                    a =
                      0 >= d[c].size
    ...
    B.prototype.getApparentDifference = function (a, e, c, b) {
      ...
      if (this.logarithmic) {
        c = l(c) ? e / a : c;
        for (var h = 0; h < d.length && !(e < d[h].startValue); h++)
          a > d[h].endValue ||
            (a <= d[h].startValue && e >= d[h].endValue
              ? (c = (c / d[h].endValue) * d[h].startValue * d[h].size)
              : a >= d[h].startValue && e >= d[h].endValue
              ? (c =
                  (c / d[h].endValue) *
                  a *
                  Math.pow(
                    d[h].size,
                    Math.log(d[h].endValue / a) /
                      Math.log(d[h].endValue / d[h].startValue)
                  ))
              : a <= d[h].startValue && e <= d[h].endValue
              ? (c =
                  (c / e) *
              ...
              : !b &&
                ...
                (c =
                  ...
                  Math.pow(
                    d[h].size,
                    Math.log(e / a) / Math.log(d[h].endValue / d[h].startValue)
                  )));
      } else
        for (
          c = l(c) ? Math.abs(e - a) : c, h = 0;
          h < d.length && !(e < d[h].startValue);
          h++
        )
          a > d[h].endValue ||
            (a <= d[h].startValue && e >= d[h].endValue
              ...
              ? (c =
                  ...
                  d[h].endValue +
                  a +
                  (d[h].size * (d[h].endValue - a)) /
                    (d[h].endValue - d[h].startValue))
              : a <= d[h].startValue && e < d[h].endValue
              ? (c =
                  c -
                  e +
                  d[h].startValue +
                  (d[h].size * (e - d[h].startValue)) /
                    (d[h].endValue - d[h].startValue))
              : !b &&
                a > d[h].startValue &&
                e < d[h].endValue &&
                (c =
                  a +
                  (d[h].size * (e - a)) / (d[h].endValue - d[h].startValue)));
      return c;
    };
    ...
    B.prototype.getXValueAt = function (a) {
      ...
      var e = null;
      "left" === this._position
        ? (e = this.convertPixelToValue(a.y))
        : "bottom" === this._position && (e = this.convertPixelToValue(a.x));
      return e;
    };
    B.prototype.calculateValueToPixelConversionParameters = function (a) {
      ...
      if (this.logarithmic)
        for (
          var d = 0;
          d < a.length && !(this.viewportMaximum < a[d].startValue);
          d++
        )
          this.viewportMinimum > a[d].endValue ||
            (this.viewportMinimum >= a[d].startValue &&
            this.viewportMaximum <= a[d].endValue
              ? (c = 0)
              : this.viewportMinimum <= a[d].startValue &&
                this.viewportMaximum >= a[d].endValue
              ? ((b = (b / a[d].endValue) * a[d].startValue),
                (c =
                  0 < a[d].spacing.toString().indexOf("%")
                    ? c * (1 - parseFloat(a[d].spacing) / 100)
                    : c - Math.min(a[d].spacing, 0.1 * c)))
              : this.viewportMinimum > a[d].startValue &&
                this.viewportMaximum >= a[d].endValue
              ? ((b = (b / a[d].endValue) * this.viewportMinimum),
                (c =
                  0 < a[d].spacing.toString().indexOf("%")
                    ? c *
                      (1 -
                        ((parseFloat(a[d].spacing) / 100) *
                          Math.log(a[d].endValue / this.viewportMinimum)) /
                          Math.log(a[d].endValue / a[d].startValue))
                    : c -
                      (Math.min(a[d].spacing, 0.1 * c) *
                        Math.log(a[d].endValue / this.viewportMinimum)) /
                        Math.log(a[d].endValue / a[d].startValue)))
              : this.viewportMinimum <= a[d].startValue &&
                this.viewportMaximum < a[d].endValue &&
                ((b = (b / this.viewportMaximum) * a[d].startValue),
                (c =
                  0 < a[d].spacing.toString().indexOf("%")
                    ? c *
                      (1 -
                        ((parseFloat(a[d].spacing) / 100) *
                          Math.log(this.viewportMaximum / a[d].startValue)) /
                          Math.log(a[d].endValue / a[d].startValue))
                    : c -
                      (Math.min(a[d].spacing, 0.1 * c) *
                        Math.log(this.viewportMaximum / a[d].startValue)) /
                ...
                (c =
                  0 < a[d].spacing.toString().indexOf("%")
                    ? c *
                      (1 -
                        ((parseFloat(a[d].spacing) / 100) *
                          (this.viewportMaximum - a[d].startValue)) /
                          (a[d].endValue - a[d].startValue))
                    : c -
                      (Math.min(a[d].spacing, 0.1 * c) *
                        (this.viewportMaximum - a[d].startValue)) /
      ...
      if ("bottom" === this._position || "top" === this._position)
        this.logarithmic
          ? ((e.lnLogarithmBase = Math.log(this.logarithmBase)),
            (e.pixelPerUnit =
              ((this.reversed ? -1 : 1) * c * e.lnLogarithmBase) /
              Math.log(Math.abs(b))))
          : (e.pixelPerUnit = ((this.reversed ? -1 : 1) * c) / Math.abs(b)),
    ...
    B.prototype.calculateAxisParameters = function () {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        if ("axisX" === this.type) {
          if (this.dataSeries && 0 < this.dataSeries.length)
            for (d = 0; d < this.dataSeries.length; d++)
              "dateTime" === this.dataSeries[d].xValueType && (c = !0);
          d =
            null !== this.viewportMinimum
              ? this.viewportMinimum
          ...
          "axisY" === this.type &&
            ...
            0 === d && 0 === h
              ...
              : d > h
              ? ((b = Math.min(
                  0.01 * Math.abs(this.getApparentDifference(h, d, null, !0)),
                  5
                )),
                0 <= h ? (d = h - b) : (h = isFinite(d) ? d + b : 0))
              : ((b = Math.min(
                  0.01 * Math.abs(this.getApparentDifference(d, h, null, !0)),
                  0.05
                )),
                0 !== h && (h += b),
                0 !== d && (d -= b)),
        ...
        if ("axisX" === this.type && c) {
          ...
          if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
            this.viewportMinimum =
              "axisX" === this.type
                ? d - f / 2
                : Math.floor(d / this.interval) * this.interval;
          if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
            this.viewportMaximum =
              "axisX" === this.type
                ? h + f / 2
        ...
        if (null === this.minimum || null === this.maximum)
          if (
            ("axisX" === this.type
              ? ((d = null !== this.minimum ? this.minimum : this.dataInfo.min),
              ...
              : "axisY" === this.type &&
                ...
                isFinite(d) || isFinite(h)
                  ? 0 === d && 0 === h
                    ...
                    ? ((b = Math.min(
                        0.01 *
                          Math.abs(this.getApparentDifference(h, d, null, !0)),
                        5
                      )),
                      0 <= h ? (d = h - b) : (h = isFinite(d) ? d + b : 0))
                    : ((b = Math.min(
                        0.01 *
                          Math.abs(this.getApparentDifference(d, h, null, !0)),
                        0.05
                      )),
                      0 !== h && (h += b),
                      0 !== d && (d -= b))
    ...
    B.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      if (this.scaleBreaks)
        for (f = 0; f < this.scaleBreaks._appliedBreaks.length; f++)
          if (
            ((!l(this.sessionVariables.newViewportMinimum) &&
              this.sessionVariables.newViewportMinimum >=
                this.scaleBreaks._appliedBreaks[f].startValue) ||
              (!l(this.options.minimum) &&
                this.options.minimum >=
                  this.scaleBreaks._appliedBreaks[f].startValue) ||
              (!l(this.options.viewportMinimum) &&
      ...
      f = Math.pow(
        this.logarithmBase,
        B.getNiceNumber(Math.abs(Math.log(f) / e), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = B.getNiceExponent(Math.log(f) / e / (a - 1), !0)),
          (c = B.getNiceNumber(r / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          "axisX" === this.type
            ? b / Math.sqrt(h)
            : Math.pow(
                this.logarithmBase,
                this.interval * Math.floor(Math.log(b) / e / this.interval)
              );
      if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
        this.viewportMaximum =
          "axisX" === this.type
            ...
            : Math.pow(
                this.logarithmBase,
                this.interval * Math.ceil(Math.log(d) / e / this.interval)
              );
          ...
          : "axisY" === this.type &&
            ...
            isFinite(b) || isFinite(d)
              ? 1 === b && 1 === d
                ...
                : 1 === d / b
                ? ((f = Math.pow(this.logarithmBase, this.interval)),
                  (d *= f),
                  (b /= f))
                : b > d
                ? ((f = Math.min(0.01 * (b / d), 5)),
                  1 <= d ? (b = d / f) : (d = b * f))
                : ((f = Math.min(
                    (d / b) * Math.pow(this.logarithmBase, 0.01),
                    Math.pow(this.logarithmBase, 0.04)
      ...
      b = Math.pow(
        this.logarithmBase,
        Math.floor(Math.log(this.viewportMinimum) / (e * this.interval) + 0.2) *
          this.interval
      );
      this.range = this.viewportMaximum / this.viewportMinimum;
      this.noTicks = a;
      if (
        ...
        for (
          e = Math.floor(this.viewportMinimum / c + 0.5) * c;
          e < this.viewportMinimum;
        ...
        this.options.interval ||
          ...
          this.range > this.interval &&
            ...
            (b = Math.pow(
              this.logarithmBase,
              Math.floor(
                Math.log(this.viewportMinimum) / (e * this.interval) + 0.2
              ) * this.interval
            )))),
      ...
      if (
        ...
        if (2 < e) for (f = 0; f < e - 2; f++) this.valueFormatString += "#";
      }
    };
    ...
    ga.prototype.createUserOptions = function (a) {
      if ("undefined" !== typeof a || this.options._isPlaceholder) {
        ...
        this.options._isPlaceholder ||
          ...
          (e = this.parent.options[this.optionsName].indexOf(this.options)));
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            (f = 1 === n % 2 ? (d.x << 0) + 0.5 : d.x << 0),
            "top" === this.scaleBreaks.parent._position
              ? ((d = this.chart.plotArea.y1),
                (l = (this.chart.plotArea.y2 + n / 2 + 0.5) << 0))
              : ((d = this.chart.plotArea.y2),
                (l = (this.chart.plotArea.y1 - n / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b - n / 2, y1: d, x2: f + n / 2, y2: l }),
            this.ctx.moveTo(b, d),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, l), this.ctx.lineTo(f, l), this.ctx.lineTo(f, d);
          ...
          if (
            ((d = 1 === n % 2 ? (d.y << 0) + 0.5 : d.y << 0),
            (l = 1 === n % 2 ? (b.y << 0) + 0.5 : b.y << 0),
            "left" === this.scaleBreaks.parent._position
              ? ((b = this.chart.plotArea.x1),
                (f = (this.chart.plotArea.x2 + n / 2 + 0.5) << 0))
              : ((b = this.chart.plotArea.x2),
                (f = (this.chart.plotArea.x1 - n / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b, y1: d - n / 2, x2: f, y2: l + n / 2 }),
            this.ctx.moveTo(b, d),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(f, d), this.ctx.lineTo(f, l), this.ctx.lineTo(b, l);
          else if ("wavy" === this.type) {
            r = b;
            k = d;
            h = 0.5;
            ...
            m = (f - r) / a / 2;
            for (p = 0; p < m; p++)
              this.ctx.lineTo(r, k), (k += 2 * h * a), (r += 2 * a), (h *= -1);
            this.ctx.lineTo(r, k);
            k += l - d;
            for (p = 0; p < m + 1; p++)
              this.ctx.lineTo(r, k), (k += 2 * h * a), (r -= 2 * a), (h *= -1);
    ...
    O.prototype.render = function () {
      ...
      if (0 < e) {
        ...
        if (
          ...
          (d = h = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            (f = this.chart.plotArea.y1),
            (l = this.chart.plotArea.y2),
            (this.bounds = { x1: d - e / 2, y1: f, x2: h + e / 2, y2: l });
        else if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        )
          (f = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            (d = this.chart.plotArea.x1),
            (h = this.chart.plotArea.x2),
            (this.bounds = { x1: d, y1: f - e / 2, x2: h, y2: l + e / 2 });
        this.ctx.moveTo(d, f);
        this.ctx.lineTo(h, l);
        this.ctx.stroke();
    ...
    $.prototype.showAt = function (a) {
      ...
      if ("xySwapped" === e.plotInfo.axisPlacement)
        if ("bottom" === this.parent._position)
          for (var b = 0; b < e.axisY.length; b++)
            this.parent === e.axisY[b] &&
              (e.axisY[b]._crosshairValue =
                a >= e.axisY[b].viewportMinimum &&
                a <= e.axisY[b].viewportMaximum
                  ? a
                  : null);
        else if ("top" === this.parent._position)
          for (b = 0; b < e.axisY2.length; b++)
            this.parent === e.axisY2[b] &&
              (e.axisY2[b]._crosshairValue =
                a >= e.axisY2[b].viewportMinimum &&
                a <= e.axisY2[b].viewportMaximum
                  ? a
                  : null);
        else if ("left" === this.parent._position)
          for (b = 0; b < e.axisX.length; b++)
            this.parent === e.axisX[b] &&
              (e.axisX[b]._crosshairValue =
                a >= e.axisX[b].viewportMinimum &&
                a <= e.axisX[b].viewportMaximum
                  ? a
                  : null);
        else {
          if ("right" === this.parent._position)
            for (b = 0; b < e.axisX2.length; b++)
              this.parent === e.axisX2[b] &&
                (e.axisX2[b]._crosshairValue =
                  a >= e.axisX2[b].viewportMinimum &&
                  a <= e.axisX2[b].viewportMaximum
                    ? a
                    : null);
        }
        ...
        for (b = 0; b < e.axisX.length; b++)
          this.parent === e.axisX[b] &&
            (e.axisX[b]._crosshairValue =
              a >= e.axisX[b].viewportMinimum && a <= e.axisX[b].viewportMaximum
                ? a
                : null);
      else if ("top" === this.parent._position)
        for (b = 0; b < e.axisX2.length; b++)
        ...
        for (b = 0; b < e.axisY.length; b++)
          this.parent === e.axisY[b] &&
            (e.axisY[b]._crosshairValue =
              a >= e.axisY[b].viewportMinimum && a <= e.axisY[b].viewportMaximum
                ? a
                : null);
          ...
          this.parent === e.axisY2[b] &&
            (e.axisY2[b]._crosshairValue =
              ...
              a <= e.axisY2[b].viewportMaximum
                ...
                : null);
      for (b = 0; b < e.axisX.length; b++)
        (a = e.axisX[b]._crosshairValue),
          e.axisX[b].crosshair &&
            e.axisX[b].crosshair.enabled &&
            (!l(a) &&
            a >= e.axisX[b].viewportMinimum &&
            a <= e.axisX[b].viewportMaximum
              ? (e.axisX[b].showCrosshair(a),
                (e.axisX[b].sessionVariables.crosshairValue = e.axisX[
                  b
                ].crosshair._updatedValue =
                  a),
                this === e.axisX[b].crosshair && (c = !0))
              : void 0 !== a &&
                (e.axisX[b].sessionVariables.crosshairValue = e.axisX[
                  b
                ].crosshair._updatedValue =
                  null));
      for (b = 0; b < e.axisX2.length; b++)
        (a = e.axisX2[b]._crosshairValue),
          e.axisX2[b].crosshair &&
            e.axisX2[b].crosshair.enabled &&
            (!l(a) &&
            a >= e.axisX2[b].viewportMinimum &&
            a <= e.axisX2[b].viewportMaximum
              ? (e.axisX2[b].showCrosshair(a),
                (e.axisX2[b].sessionVariables.crosshairValue = e.axisX2[
                  b
                ].crosshair._updatedValue =
                  a),
                this === e.axisX2[b].crosshair && (c = !0))
              : void 0 !== a &&
                (e.axisX2[b].sessionVariables.crosshairValue = e.axisX2[
                  b
                ].crosshair._updatedValue =
                  null));
      for (b = 0; b < e.axisY.length; b++)
        (a = e.axisY[b]._crosshairValue),
          e.axisY[b].crosshair &&
            e.axisY[b].crosshair.enabled &&
            (!l(a) &&
            a >= e.axisY[b].viewportMinimum &&
            a <= e.axisY[b].viewportMaximum
              ? (e.axisY[b].showCrosshair(a),
                (e.axisY[b].sessionVariables.crosshairValue = e.axisY[
                  b
                ].crosshair._updatedValue =
                  a),
                this === e.axisY[b].crosshair && (c = !0))
              : void 0 !== a &&
                (e.axisY[b].sessionVariables.crosshairValue = e.axisY[
                  b
                ].crosshair._updatedValue =
                  null));
      for (b = 0; b < e.axisY2.length; b++)
        (a = e.axisY2[b]._crosshairValue),
          e.axisY2[b].crosshair &&
            e.axisY2[b].crosshair.enabled &&
            (!l(a) &&
            a >= e.axisY2[b].viewportMinimum &&
            a <= e.axisY2[b].viewportMaximum
              ? (e.axisY2[b].showCrosshair(a),
                (e.axisY2[b].sessionVariables.crosshairValue = e.axisY2[
                  b
                ].crosshair._updatedValue =
                  a),
                this === e.axisY2[b].crosshair && (c = !0))
              : void 0 !== a &&
                (e.axisY2[b].sessionVariables.crosshairValue = e.axisY2[
                  b
                ].crosshair._updatedValue =
      ...
      e.sessionVariables.crosshairShownByPixel = !1;
      return c;
    };
    ...
    $.prototype.render = function (a, e, c) {
      var b,
        d,
        h,
        f,
      ...
      this.labelMaxWidth = l(this.options.labelMaxWidth)
        ? 0.3 * this.chart.width
        : this.labelMaxWidth;
      this.labelMaxHeight =
        l(this.options.labelWrap) || this.labelWrap
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var s = 0; s < this.parent.dataSeries.length; s++)
            (y = this.parent.dataSeries[s].getDataPointAtX(w, !0, !0)) &&
              0 <= y.index &&
              ((y.dataSeries = this.parent.dataSeries[s]),
          ...
          for (var w = Infinity, v, s = 0; s < m.length; s++) {
            if (
              ...
              if (m[s].dataPoint.y)
                for (var A = 0; A < m[s].dataPoint.y.length; A++)
                  (z = Math.abs(
                    a - this.parent.convertValueToPixel(m[s].dataPoint.y[A])
                  )),
                    z <= w && ((w = z), (y = s));
            } else
          ...
          if (
            ...
            this.bounds = { x1: b - p / 2, y1: h, x2: d + p / 2, y2: f };
            ...
            this.bounds = { x1: b, y1: h - p / 2, x2: d, y2: f + p / 2 };
            s = !1;
          ...
          if (s) {
            if ("axisX" === this.parent.type)
              for (
                w = this.parent.convertPixelToValue({ x: a }), y = null, s = 0;
                s < this.parent.dataSeries.length;
                s++
              )
                (y = this.parent.dataSeries[s].getDataPointAtX(w, !0, !0)) &&
          ...
          for (s = 0; s < m.length; s++) {
            if (
              ...
              if (m[s].dataPoint.y)
                for (A = 0; A < m[s].dataPoint.y.length; A++)
                  (z = Math.abs(
                    e - this.parent.convertValueToPixel(m[s].dataPoint.y[A])
                  )),
                    z <= w && ((w = z), (y = s));
            } else
              "stackedColumn" === m[s].dataSeries.type
                ? ((b = m[s].dataSeries.dataPointEOs[m[s].index].cumulativeY),
                  (z = Math.abs(e - this.parent.convertValueToPixel(b))),
                  z <= w && ((w = z), (y = s)))
                  ...
                  "stackedColumn100" === m[s].dataSeries.type
                    ? ((t =
                      ...
                      (z = m[s].dataPoint.x.getTime
                        ...
                        : m[s].dataPoint.x),
                      (b =
                        100 * (t / m[s].dataSeries.plotUnit.dataPointYSums[z])),
                      (z = Math.abs(e - this.parent.convertValueToPixel(b))),
                      z <= v && ((v = z), (y = s)))
                    : "stackedArea100" === m[s].dataSeries.type &&
                      ((t =
                ...
                ? ((z = Math.abs(
                  ...
                  z <= w && ((v = w = z), (y = s)))
                : ((z = Math.abs(
                    e - this.parent.convertValueToPixel(m[s].dataPoint.y)
                  )),
                  z <= w && ((w = z), (y = s)));
            l(v) || (w = Math.min(w, v));
          }
          ...
          if (
            ...
            for (m = 0; m < v.dataPoint.y.length; m++)
              (z = Math.abs(
                e - this.parent.convertValueToPixel(v.dataPoint.y[m])
              )),
                z < w && ((w = z), (s = m));
            t =
              1 === g.lineWidth % 2
        ...
        if (
          ...
          "top" === this.parent._position &&
            ...
            "bottom" === this.parent._position &&
              this.parent.lineCoordinates.y2 + k.measureText().height >
                this.chart.bounds.y2 &&
            ...
            this.value >=
              ...
              0 < p &&
              (g.moveTo(b, h), g.lineTo(d, f), g.stroke(), (this._hidden = !1));
        if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        )
        ...
        if (
          ...
          (b = d = r = 1 === g.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (h = this.chart.plotArea.y1),
            (f = this.chart.plotArea.y2),
            (this.bounds = { x1: b - p / 2, y1: h, x2: d + p / 2, y2: f });
        else if (
          ...
          (h = f = t = 1 === g.lineWidth % 2 ? (e << 0) + 0.5 : e << 0),
            (b = this.chart.plotArea.x1),
            (d = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: h - p / 2, x2: d, y2: f + p / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
          if (
            ...
            if (s) {
              if ("axisX" === this.parent.type)
                for (
                  ...
                  (y = this.parent.dataSeries[s].getDataPointAtX(w, !0)) &&
                    0 <= y.index &&
                    (k.text = this.labelFormatter
                      ? this.labelFormatter({
                          chart: this.chart,
              ...
              k.text =
                "dateTime" !== this.parent.valueType || this.parent.logarithmic
                  ? this.labelFormatter
                    ...
                    : l(this.options.label)
                    ? ia(
                        l(c) ? this.parent.convertPixelToValue(e) : c,
                        this.valueFormatString,
                        this.chart._cultureInfo
                      )
                    : this.label
            ...
            if (
              ...
              (k.text = this.labelFormatter
                ...
                : l(this.options.label)
                ? ia(
                    l(c) ? this.parent.convertPixelToValue(a) : c,
                    this.valueFormatString,
                    this.chart._cultureInfo
                  )
                : this.label),
      ...
      if ("bottom" === this.parent._position || "top" === this.parent._position)
        this.parent.sessionVariables.crosshairValue = this._updatedValue =
          this.parent.convertPixelToValue(r);
    ...
    $.prototype.renderLabel = function () {
      this.value >=
    ...
    qa(aa, Y);
    aa.prototype._updateOptions = function () {
    ...
    aa.prototype.mouseMoveHandler = function (a, e) {
      (this._lastUpdated && 4 > new Date().getTime() - this._lastUpdated) ||
        ((this._lastUpdated = new Date().getTime()),
        this.chart.resetOverlayedCanvas(),
        this._updateToolTip(a, e),
        this.enabled &&
    ...
    aa.prototype._updateToolTip = function (a, e, c) {
      c = "undefined" === typeof c ? !0 : c;
      this._updateOptions();
        ...
        if (
          ...
          if (this.chart.axisX)
            for (var t = 0; t < this.chart.axisX.length; t++) {
              for (
                var f =
                    "xySwapped" === this.chart.plotInfo.axisPlacement
                      ? this.chart.axisX[t].convertPixelToValue({ y: e })
                ...
                (k = this.chart.axisX[t].dataSeries[b].getDataPointAtX(
                  f,
                  c,
                  !0
                )) &&
          ...
          if (this.chart.axisX2)
            for (t = 0; t < this.chart.axisX2.length; t++) {
              f =
                "xySwapped" === this.chart.plotInfo.axisPlacement
                  ? this.chart.axisX2[t].convertPixelToValue({ y: e })
          ...
          if ((b = this.chart.getDataPointAtXY(a, e, c)))
            ...
            if (
              ((b = bb(a, e, this.chart._eventManager.ghostCtx)),
              0 < b &&
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (0 <= this.currentDataPointIndex)
              (b = d.dataPoints[this.currentDataPointIndex]),
                (k.dataSeries = d),
                (k.dataPoint = b),
                ...
                "waterfall" === d.type &&
                  ...
                  (k.cumulativeSum =
                    d.dataPointEOs[this.currentDataPointIndex].cumulativeSum));
            else if (
              this.enabled &&
              d &&
              ("line" === d.type ||
                ...
                "candlestick" === d.type ||
                "ohlc" === d.type ||
                "boxAndWhisker" === d.type)
            )
              (f = d.axisX.convertPixelToValue({ x: a })),
                (k = d.getDataPointAtX(f, c, !0)),
                l(k) ||
                  ((k.dataSeries = d),
          ...
          if ((this.highlightObjects(h), this.enabled)) {
            ...
            if (null !== c) {
              ...
              if (
                ...
                l(this.options.contentFormatter)
              )
                for (
                  f = this.contentDiv.getElementsByTagName("span"), b = 0;
                  b < f.length;
                  b++
                )
                  f[b] && (f[b].style.color = f[b].getAttribute("data-color"));
              f = !1;
              "none" === this.container.style.display &&
                ((f = !0), (this.container.style.display = "block"));
              try {
                          ...
                          this.contentDiv.style.borderColor =
                            this.options.borderColor
                              ...
                              : h[0].dataSeries._colorSet[
                                  d.index % h[0].dataSeries._colorSet.length
                                ])
                      : (this.contentDiv.style.borderRightColor =
                          this.contentDiv.style.borderLeftColor =
                          this.contentDiv.style.borderColor =
              ...
              e = -e + 10;
              0 < e + this.container.clientHeight + 5 &&
                (e -= e + this.container.clientHeight + 5 - 0);
              this.fixMozTransitionDelay(a, e);
              !this.animationEnabled || f
    ...
    aa.prototype.highlightObjects = function (a) {
      ...
      l(this.chart.clearedOverlayedCanvas) ||
      "toolTip" === this.chart.clearedOverlayedCanvas
        ? (this.chart.resetOverlayedCanvas(),
          e.clearRect(0, 0, this.chart.width, this.chart.height),
        ...
        if (
          ...
          !1 === h.highlightEnabled ||
            ...
            "rangeSplineArea" === b.type
              ...
              ? ra(e, d.funnelSection, 0.3, "white")
              : "candlestick" === b.type
              ? ((e.globalAlpha = 1),
                (e.strokeStyle = d.color),
                (e.lineWidth = 2 * d.borderThickness),
                (b = 0 === e.lineWidth % 2 ? 0 : 0.5),
                e.beginPath(),
                e.moveTo(d.x3 - b, Math.min(d.y2, d.y3)),
                e.lineTo(d.x3 - b, Math.min(d.y1, d.y4)),
                e.stroke(),
                e.beginPath(),
                e.moveTo(d.x3 - b, Math.max(d.y1, d.y4)),
                e.lineTo(d.x3 - b, Math.max(d.y2, d.y3)),
                e.stroke(),
                ea(
                  e,
                  d.x1,
              ...
              ? ((e.globalAlpha = 1),
                ...
                (b = 0 === e.lineWidth % 2 ? 0 : 0.5),
                e.beginPath(),
                e.moveTo(d.x3 - b, d.y2),
                e.lineTo(d.x3 - b, d.y3),
                e.stroke(),
                e.beginPath(),
                e.moveTo(d.x3, d.y1),
                e.lineTo(d.x1, d.y1),
              ...
              ? (e.save(),
                (e.globalAlpha = 1),
                (e.strokeStyle = d.stemColor),
                (e.lineWidth = 2 * d.stemThickness),
                0 < d.stemThickness &&
                  (e.beginPath(),
                  e.moveTo(d.x3, d.y2 + d.borderThickness / 2),
                  e.lineTo(d.x3, d.y1 + d.whiskerThickness / 2),
                  e.stroke(),
                  e.beginPath(),
                  e.moveTo(d.x3, d.y4 - d.whiskerThickness / 2),
                  e.lineTo(d.x3, d.y3 - d.borderThickness / 2),
                  e.stroke()),
                e.beginPath(),
                ea(
                  e,
                ...
                (e.globalAlpha = 1),
                (e.strokeStyle = d.whiskerColor),
                (e.lineWidth = 2 * d.whiskerThickness),
                0 < d.whiskerThickness &&
                  (e.beginPath(),
                  e.moveTo(Math.floor(d.x3 - d.whiskerLength / 2), d.y4),
                  e.lineTo(Math.ceil(d.x3 + d.whiskerLength / 2), d.y4),
                  e.stroke(),
                  e.beginPath(),
                  e.moveTo(Math.floor(d.x3 - d.whiskerLength / 2), d.y1),
                  e.lineTo(Math.ceil(d.x3 + d.whiskerLength / 2), d.y1),
                  e.stroke()),
                (e.globalAlpha = 1),
                (e.strokeStyle = d.lineColor),
                (e.lineWidth = 2 * d.lineThickness),
                0 < d.lineThickness &&
                  (e.beginPath(),
                  e.moveTo(d.x1, d.y5),
                  e.lineTo(d.x2, d.y5),
      ...
      if (
        ...
        for (var l = null, r = "", f = 0; f < a.length; f++) {
          ...
          null === b.toolTipContent ||
            ...
            c.visible &&
              (!0 === this.reversed
                ? ((e = this.chart.replaceKeywordsWithValue(h, b, c, d) + e),
                  f < a.length - 1 && (e = "</br>" + e))
    ...
    aa.prototype.show = function (a, e, c) {
      this._updateToolTip(a, e, "undefined" === typeof c ? !1 : c);
    };
    aa.prototype.showAtIndex = function (a, e) {};
    aa.prototype.showAtX = function (a, e) {
      if (!this.enabled) return !1;
      this.chart.clearedOverlayedCanvas = null;
      this._updateOptions();
      var c,
        ...
        for (var q = 0; q < this.chart.data.length; q++)
          (c = this.chart.data[q]),
            (b = c.getDataPointAtX(a, !1)) &&
              ...
              c.visible &&
              ((b.dataSeries = c),
              this.chart.data[e].axisX.convertValueToPixel(a) ===
                c.axisX.convertValueToPixel(b.dataPoint.x) && f.push(b));
      else
        (c = this.chart.data[e]),
          (b = c.getDataPointAtX(a, !1)) &&
            b.dataPoint &&
        ...
        if (null !== q) {
          ...
          if (
            ...
            for (
              ...
              b[q] && (b[q].style.color = b[q].getAttribute("data-color"));
          q = !1;
          "none" === this.container.style.display &&
          ...
          "pie" === f[0].dataSeries.type || "doughnut" === f[0].dataSeries.type
            ? (c =
                ...
                f[0].dataSeries.radius *
                  Math.cos(f[0].dataSeries.dataPointEOs[f[0].index].midAngle) +
                -("left" === f[0].dataSeries.dataPointEOs[f[0].index].hemisphere
                  ? 0
                  : this.container.clientWidth))
            : "funnel" === f[0].dataSeries.type ||
              "pyramid" === f[0].dataSeries.type
            ? ((b = f[0].dataSeries.dataPointEOs[f[0].index].sectionsofFunnel),
            ...
            : ((c =
                ...
                "stackedBar100" === f[0].dataSeries.type
                  ? (f[0].dataSeries.axisY.convertValueToPixel(
                      f[0].dataPoint.y.length
                        ? f[0].dataPoint.y[f[0].dataPoint.y.length - 1]
                        : f[0].dataPoint.y
                    ) -
                      this.container.clientWidth) <<
                    0
          ...
          ("line" !== f[0].dataSeries.type &&
            ...
            ? "pie" === f[0].dataSeries.type ||
              ...
              ? ((b =
                  f[0].dataSeries.dataPointEOs[f[0].index].center.y +
                  f[0].dataSeries.radius *
                    Math.sin(
                      f[0].dataSeries.dataPointEOs[f[0].index].midAngle
                    )),
                b < f[0].dataSeries.dataPointEOs[f[0].index].center.y &&
                  (b += this.container.clientHeight))
              : "funnel" === f[0].dataSeries.type ||
                "pyramid" === f[0].dataSeries.type
              ? ((b =
                  f[0].dataSeries.dataPointEOs[
                    f[0].dataSeries.reversed
                      ? f[0].dataSeries.dataPointEOs.length - 1 - f[0].index
                      : f[0].index
                  ].sectionsofFunnel),
                (b =
    ...
    aa.prototype.fixMozTransitionDelay = function (a, e) {
      if (20 < this.chart._eventManager.lastObjectId)
        ...
        var c = parseFloat(this.container.style.left),
          ...
          b = isNaN(b) ? 0 : b;
        10 < Math.sqrt(Math.pow(c - a, 2) + Math.pow(b - e, 2))
      ...
      if ("mousemove" === a.type || "click" === a.type) {
        ...
        if (
          ...
          if (((b = this.objectMap[b]), "dataPoint" === b.objectType)) {
            ...
            "legendItem" === b.objectType &&
              ((d = this.chart.data[b.dataSeriesIndex]),
              (f =
        ...
        for (c = 0; c < this.mouseoveredObjectMaps.length; c++) {
          ...
          f
            ...
            : d.push(this.mouseoveredObjectMaps[c]);
        }
        ...
        for (c = 0; c < e.length; c++) {
          ...
          d ||
            (this.fireEvent(e[c], "mouseover", a),
            this.mouseoveredObjectMaps.push(e[c]));
          "click" === a.type
            ? this.fireEvent(e[c], "click", a)
            : "mousemove" === a.type && this.fireEvent(e[c], "mousemove", a);
        }
      }
    };
    ha.prototype.fireEvent = function (a, e, c) {
      if (a && e) {
        ...
        "mouseout" !== e
          ...
          : ((c.target.style.cursor = this.chart.panEnabled
              ? "itemmouseout" !== d.mouseout || f.dockInsidePlotArea
                ? "move"
    ...
    X.prototype.animate = function (a, e, c, b, d) {
      var f = this;
      ...
      for (a = []; 0 < this.animations.length; )
        if (
          ...
          (b = 0),
          e.startTime <= c &&
            ((b = d(Math.min(c - e.startTime, e.duration), 0, 1, e.duration)),
            (b = Math.min(b, 1)),
            isNaN(b) || !isFinite(b)) &&
            (b = 1),
          1 > b && a.push(e),
          e.animationCallback(b),
          1 <= b && e.onComplete)
        )
          e.onComplete();
      this.animations = a;
    ...
    var R = {
      ...
      ba = {
        drawMarker: function (a, e, c, b, d, f, l, r) {
          if (c) {
            var t = 1;
            ...
            "circle" === b
              ...
              : "triangle" === b
              ? (c.beginPath(),
                c.moveTo(a - d / 2, e + d / 2),
                c.lineTo(a + d / 2, e + d / 2),
                c.lineTo(a, e - d / 2),
                c.closePath(),
                f && c.fill(),
                r &&
