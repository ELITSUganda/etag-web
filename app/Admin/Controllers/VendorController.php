...
class VendorController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('request_status', __('Status'))
            ->label(
                [
                    'Active' => 'success',
                    'Pending' => 'warning',
        ...
        $grid->quickSearch('first_name', 'last_name', 'email', 'phone_number', 'business_name', 'business_license_number', 'business_license_issue_authority', 'business_license_issue_date', 'business_license_validity', 'business_phone_number', 'business_whatsapp', 'business_email', 'business_logo', 'business_cover_photo', 'business_cover_details')
            ->placeholder('Search by name, email, phone number, business name, business license number, business license issue authority, business license issue date, business license validity, business phone number, business whatsapp, business email, business logo, business cover photo, business cover details');
    ...
    protected function form()
    {
        ...
        $form->text('nin', __('ID Number'))->default(1);
        ...
        $form->radioCard('user_type', __('User type'))->default('Farmer')
            ...
            ->rules('required');
        $form->radioCard('request_status', __('status'))->default('Farmer')
            ->options(
                [
                    'Active' => 'Active',
                    'Pending' => 'Pending',
